...
#ifndef __P2P_PEER_DEF_HPP__
#define __P2P_PEER_DEF_HPP__
...
#include <yggr/p2p/p2p_peer_handler.hpp>
...
typedef 
	yggr::p2p::p2p_peer_handler
	<
		yggr::client::client_config::client_udp_config_type,
		service_handler_type,
		session_mgr_type,
		custom_connect_options_setter/*,
		yggr::p2p::p2p_connect_handler*/
	> p2p_peer_handler_type;
...
typedef yggr::network::network_handler<p2p_peer_handler_type> network_handler_type;
...
typedef yggr::network::socket_info<std::string, std::string> socket_info_type;
typedef network_info_type owner_type;
typedef yggr::list<owner_type> owner_info_container_type;
