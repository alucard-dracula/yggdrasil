...
#ifndef __STATIC_DATA_CENTER_TCP_SVR_HANDLER_REG_HPP__
#define __STATIC_DATA_CENTER_TCP_SVR_HANDLER_REG_HPP__
...
#endif // __STATIC_DATA_CENTER_TCP_SVR_HANDLER_REG_HPP__
