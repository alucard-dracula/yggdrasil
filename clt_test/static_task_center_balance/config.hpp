...
#ifndef __CLT_TEST_STATIC_TASK_CENTER_BLANCE_CONFIG_HPP__
...
typedef 
	yggr::client::basic_clt_handler
	<
		yggr::client::client_config::client_tcp_config_type,
		service_handler_type,
		session_mgr_type,
...
#endif // __CLT_TEST_STATIC_TASK_CENTER_BLANCE_CONFIG_HPP__
