...
#ifndef __CLT_TEST_STATIC_TASK_CENTER_BLANCE2_CONFIG_HPP__
#define __CLT_TEST_STATIC_TASK_CENTER_BLANCE2_CONFIG_HPP__
...
typedef yggr::ids::inner_process_id module_id_type;
typedef yggr::ids::id_generator<module_id_type> module_id_gen_type;
typedef yggr::ptr_single<module_id_type> module_id_single_type;
...
typedef net_ipak_type task_type;

typedef yggr::network::support::network_data_info_parser<data_info_def_type> task_data_info_parser_type;
typedef task_data_info_parser_type::data_info_type data_info_type;
...
typedef yggr::thread::action_helper::action_id_parser<action_reg_id_parser_type,
														task_type::data_info_getter> action_id_parser_type;
...
typedef yggr::proxy::proxy_task_creator<task_type> task_creator_type;
...
typedef
	...
	<
		...
		YGGR_IDS_PARSER_CONST_MEM_FOO(task_type::base_type,
										const yggr
											::task_center
												::default_task_data_info_type
													::data_info_type&,
	...
	YGGR_IDS_PARSER_CONST_MEM_FOO(
		...
		const yggr
			::task_center
				::default_task_data_info_type
					::data_info_type&,
		data_info) adapter_task_recv_id_parser_type;

typedef
	YGGR_IDS_PARSER_CONST_MEM_FOO(
		net_opak_type::base_type,
		const yggr
				::task_center
					::default_task_data_info_type
						::data_info_type&,
		data_info) adapter_recv_id_parser_type;
} // namespace detail
...
typedef yggr::adapter::adapter_mgr<task_center_type,
									...
									net_opak_type,
									adapter_id_parser_def_type,
									yggr::proxy::adapter_helper::proxy_io_converter> adapter_mgr_type;
...
#endif // __CLT_TEST_STATIC_TASK_CENTER_BLANCE2_CONFIG_HPP__
