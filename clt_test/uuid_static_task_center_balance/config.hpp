...
#ifndef __CLT_TEST_UUID_STATIC_TASK_CENTER_BLANCE_CONFIG_HPP__
#define __CLT_TEST_UUID_STATIC_TASK_CENTER_BLANCE_CONFIG_HPP__
...
YGGR_PP_REGISTER_SESSION_ID_CREATOR_BEGIN(test_pak_type, test_pak, const yggr::ids::uuid& )
	test_pak.id()
...
#endif // __CLT_TEST_UUID_STATIC_TASK_CENTER_BLANCE_CONFIG_HPP__
