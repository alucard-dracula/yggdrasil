...
public:
	proxy_msg_calculator(const proxy_repeater_ptr_type& prepeater, const proxy_adapter_mgr_ptr_type& padp_mgr)
	...
	// warning owner is same address cdt.net_info() // boost::address_of(owner) == boost::addressof(cdt.net_info())
