 ...
 *
 * $Id: md5.cpp,v 1.2 2011/10/31 04:47:36 xuyang Exp $
 */
...
static const char *version_id = "$MD5Version: 1.0.0 November-19-1997 $";

static const char* __fix_rcs_id_unused_variable(void)
{
    return rcs_id;
}

static const char* __fix_version_id_unused_variable(void)
{
    return version_id;
}
...
void	md5_sig_from_string(void *signature, const char *str)
{
  ...
  hex = HEX_STRING;
  sig_p = reinterpret_cast<unsigned char*>(signature);
