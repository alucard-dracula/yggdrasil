...
class NonCaseSensitiveEq 
	//: public STD_::binary_function<tstring, tstring, bool>
{
public:
	typedef tstring first_argument_type;
	typedef tstring second_argument_type;
