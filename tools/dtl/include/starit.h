...
public:
	...
	explicit star_bidirectional_iterator(ItType X)
		: current(X) {};
	...
	// copy constructor
	star_bidirectional_iterator(const ThisType &other) 
		: current(other.base()) { }
...
public:
	...
	star_forward_iterator() {};

	explicit star_forward_iterator(ItType X)
		: current(X) {};
	...
	// copy constructor
	star_forward_iterator(const ThisType &other)
		: current(other.base()) { }
