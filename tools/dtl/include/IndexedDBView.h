...
public:
	inline bool operator()(BoundIOs & DTL_DUMMY_PARAM_1, DataObj & DTL_DUMMY_PARAM_2) const
	{
		return true;
	}
...
{
public:
	typedef ParamObj& argument_type;
	...
	public:
	  ...
	  // forward call
	 inline void operator()(ParamObj &params) {
			data->invoke(params);
		}
...
public:
  ...
  public:
	  inline void operator()(ParamObj & DTL_DUMMY_PARAM_1)
	  { }
};
...
public:
  ...
  public:
	  ...
	  inline void operator()(ParamObj &paramObj)
	  { paramObj = *param_;}
