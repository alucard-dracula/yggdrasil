...
cp -f ^
    %var_src_root_dir%/%var_proj_dir%/%var_build_result_dir%/libiconv.dll ^
    %var_dst_root_dir%/%var_dst_dir%/%var_dst_bin_dir%/libiconv-%var_cl_mark%%var_mt_mark%%var_debug_mark%.dll

call rebuild_impl_lib.bat ^
    "%var_dst_root_dir%/%var_dst_dir%/%var_dst_bin_dir%" ^
    "libiconv-%var_cl_mark%%var_mt_mark%%var_debug_mark%.dll" ^
    "%var_dst_root_dir%/%var_dst_dir%/%var_dst_lib_dir%" ^
    "libiconv-%var_cl_mark%%var_mt_mark%%var_debug_mark%%var_impl_lib_ext_name%" ^
    "libiconv-%var_cl_mark%%var_mt_mark%%var_debug_mark%" ^
