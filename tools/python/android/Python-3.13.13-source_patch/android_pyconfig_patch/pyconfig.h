...
#if (defined(_LP64) && (_LP64 == 1))
#  define ALIGNOF_LONG 8
#else
#  define ALIGNOF_LONG 4
#endif // #if (defined(_LP64) && (_LP64 == 1))
...
#	define ANDROID_API_LEVEL __ANDROID_MIN_SDK_VERSION__
#else
#	if defined(__riscv) && (__riscv)
#		define ANDROID_API_LEVEL 35
#	else 
#		define ANDROID_API_LEVEL 21
#   endif // defined(__riscv) && (__riscv)
#endif // __ANDROID_MIN_SDK_VERSION__
...
#if (defined(_LP64) && (_LP64 == 1)) \
			&& ((defined(__x86_64__) && (__x86_64__ == 1)) \
               || (defined(__x86_64) && (__x86_64 == 1)))
#   define HAVE_GCC_ASM_FOR_X64 1
//#else
/* #undef HAVE_GCC_ASM_FOR_X64 */
#endif // defined(__x86_64__) || defined(__x86_64)
...
/* Define if we can use gcc inline assembler to get and set x87 control word
   */
			...
			|| (defined(__i686) && (__i686 == 1)) \
			|| (defined(__i386__) && (__i386__ == 1)) \
			|| (defined(__i386) && (__i386 == 1)) \
			|| (defined(i386) && (i386 == 1))
...
#if (defined(_ILP32) && (_ILP32 == 1))
#define HAVE_LARGEFILE_SUPPORT 1
//#else
/* #undef HAVE_LARGEFILE_SUPPORT */
#endif //(defined(_LP32) && (_LP32 == 1))
...
#if defined(_LP64) && (_LP64 == 1) \
      && (defined(__x86_64) && (__x86_64 == 1) \
            || defined(__aarch64__) && (__aarch64__ == 1) )
