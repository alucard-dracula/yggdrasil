...
SVCXPRT *transp;
{
	...
	typedef bool_t(*local_t_now)(argument_t*, result_t*, struct svc_req *rqstp);
	...
	xdr_argument = (bool_t (*)())&xdr_cprinc_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) create_principal_2_svc;
	break;

	case DELETE_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_dprinc_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) delete_principal_2_svc;
	break;

	case MODIFY_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_mprinc_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) modify_principal_2_svc;
	break;

	case RENAME_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_rprinc_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) rename_principal_2_svc;
	break;

	case GET_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_gprinc_arg;
	xdr_result = (bool_t (*)())&xdr_gprinc_ret;
	local = (bool_t (*)()) get_principal_2_svc;
	break;

	case GET_PRINCS:
	xdr_argument = (bool_t (*)())&xdr_gprincs_arg;
	xdr_result = (bool_t (*)())&xdr_gprincs_ret;
	local = (bool_t (*)()) get_princs_2_svc;
	break;

	case CHPASS_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_chpass_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) chpass_principal_2_svc;
	break;

	case SETKEY_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_setkey_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) setkey_principal_2_svc;
	break;

	case CHRAND_PRINCIPAL:
	xdr_argument = (bool_t (*)())&xdr_chrand_arg;
	xdr_result = (bool_t (*)())&xdr_chrand_ret;
	local = (bool_t (*)()) chrand_principal_2_svc;
	break;

	case CREATE_POLICY:
	xdr_argument = (bool_t (*)())&xdr_cpol_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) create_policy_2_svc;
	break;

	case DELETE_POLICY:
	xdr_argument = (bool_t (*)())&xdr_dpol_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) delete_policy_2_svc;
	break;

	case MODIFY_POLICY:
	xdr_argument = (bool_t (*)())&xdr_mpol_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) modify_policy_2_svc;
	break;

	case GET_POLICY:
	xdr_argument = (bool_t (*)())&xdr_gpol_arg;
	xdr_result = (bool_t (*)())&xdr_gpol_ret;
	local = (bool_t (*)()) get_policy_2_svc;
	break;

	case GET_POLS:
	xdr_argument = (bool_t (*)())&xdr_gpols_arg;
	xdr_result = (bool_t (*)())&xdr_gpols_ret;
	local = (bool_t (*)()) get_pols_2_svc;
	break;

	case GET_PRIVS:
	xdr_argument = (bool_t (*)())&xdr_u_int32;
	xdr_result = (bool_t (*)())&xdr_getprivs_ret;
	...
	xdr_argument = (bool_t (*)())&xdr_cprinc3_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) create_principal3_2_svc;
	break;

	case CHPASS_PRINCIPAL3:
	xdr_argument = (bool_t (*)())&xdr_chpass3_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) chpass_principal3_2_svc;
	break;

	case CHRAND_PRINCIPAL3:
	xdr_argument = (bool_t (*)())&xdr_chrand3_arg;
	xdr_result = (bool_t (*)())&xdr_chrand_ret;
	local = (bool_t (*)()) chrand_principal3_2_svc;
	break;

	case SETKEY_PRINCIPAL3:
	xdr_argument = (bool_t (*)())&xdr_setkey3_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) setkey_principal3_2_svc;
	break;

	case PURGEKEYS:
	xdr_argument = (bool_t (*)())&xdr_purgekeys_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) purgekeys_2_svc;
	break;

	case GET_STRINGS:
	xdr_argument = (bool_t (*)())&xdr_gstrings_arg;
	xdr_result = (bool_t (*)())&xdr_gstrings_ret;
	local = (bool_t (*)()) get_strings_2_svc;
	break;

	case SET_STRING:
	xdr_argument = (bool_t (*)())&xdr_sstring_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) set_string_2_svc;
	break;

	case SETKEY_PRINCIPAL4:
	xdr_argument = (bool_t (*)())&xdr_setkey4_arg;
	xdr_result = (bool_t (*)())&xdr_generic_ret;
	local = (bool_t (*)()) setkey_principal4_2_svc;
	break;

	case EXTRACT_KEYS:
	xdr_argument = (bool_t (*)())&xdr_getpkeys_arg;
	xdr_result = (bool_t (*)())&xdr_getpkeys_ret;
	...
	retval = (*((local_t_now)local))(&argument, &result, rqstp);
