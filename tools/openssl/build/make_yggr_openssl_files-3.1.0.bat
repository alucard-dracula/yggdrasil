...
:rem set var_dst_vc100_dir=libopenssl-3.1.0-vc100
:rem set var_dst_vc143_dir=libopenssl-3.1.0-vc143
:rem set var_dst_mgw15_dir=libopenssl-3.1.0-mgw15
:rem set var_dst_mix_dir=libopenssl-3.1.0-mix

set var_lib_title=libopenssl
set var_lib_ver=3.1.0
