...
call vc_build_tpl.bat debug-VC-WIN32-HYBRIDCRT %var_dir%stage/%dir_debug_mt% %var_dir%stage/%dir_debug_mt%/ssl "shared"
call vc_build_tpl.bat debug-VC-WIN32-HYBRIDCRT %var_dir%stage/%dir_debug_static_mt% %var_dir%stage/%dir_debug_static_mt%/ssl "no-shared"

call vc_build_tpl.bat VC-WIN32-HYBRIDCRT %var_dir%stage/%dir_release_mt% %var_dir%stage/%dir_release_mt%/ssl "shared"
call vc_build_tpl.bat VC-WIN32-HYBRIDCRT %var_dir%stage/%dir_release_static_mt% %var_dir%stage/%dir_release_static_mt%/ssl "no-shared"
