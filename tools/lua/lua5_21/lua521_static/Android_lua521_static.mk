#
#	lua521_static definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua521_static

l_path := $(LOCAL_PATH)

# output module name
ifeq ($(NDK_DEBUG), 1)
	l_module := liblua502_static$(USRDEF_APP_COMPILER_VERSION_TAG)-d
else
	l_module := liblua502_static$(USRDEF_APP_COMPILER_VERSION_TAG)
endif
