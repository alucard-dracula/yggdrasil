...
lib /def:%src_dir32%bcrypt.def /machine:x86 /out:%dst_dir32%libbcrypt.a

lib /def:%src_dir64%crypt32.def /machine:x64 /out:%dst_dir64%libcrypt32.a
lib /def:%src_dir32%crypt32.def /machine:x86 /out:%dst_dir32%libcrypt32.a

lib /def:%src_dir64%dnsapi.def /machine:x64 /out:%dst_dir64%libdnsapi.a
lib /def:%src_dir32%dnsapi.def /machine:x86 /out:%dst_dir32%libdnsapi.a

lib /def:%src_dir64%secur32.def /machine:x64 /out:%dst_dir64%libsecur32.a
lib /def:%src_dir32%secur32.def /machine:x86 /out:%dst_dir32%libsecur32.a

lib /def:%src_dir64%kernel32.def /machine:x64 /out:%dst_dir64%libkernel32.a
lib /def:%src_dir32%kernel32.def /machine:x86 /out:%dst_dir32%libkernel32.a
