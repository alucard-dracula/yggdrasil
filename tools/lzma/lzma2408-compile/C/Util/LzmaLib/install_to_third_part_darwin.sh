...
#   include fix
    cp -f "${var_local_dir}/../../7zTypes.h" "${var_src_dir}/include/" 
    cp -f "${var_local_dir}/../../7zVersion.h" "${var_src_dir}/include/" 
    cp -f "${var_local_dir}/../../LzmaLib.h" "${var_src_dir}/include/" 
...
var_proj_name="LzmaLib"
var_third_part_root_dir="/Users/alucard"
var_prefix_name="LzmaLib"
