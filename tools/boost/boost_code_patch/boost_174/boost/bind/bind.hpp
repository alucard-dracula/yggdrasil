...
#if !defined(BOOST_CXX_VERSION_PATCH)
#	if defined(_MSC_VER)
#		if defined(_MSVC_LANG)
#			define BOOST_CXX_VERSION_PATCH _MSVC_LANG
#		else
#			define BOOST_CXX_VERSION_PATCH 200300L // vs2010 support 03 
#		endif // YGGR__CPLUSPLUS
#	else
#		define BOOST_CXX_VERSION_PATCH __cplusplus
#	endif // _MSC_VER
#endif // BOOST_CXX_VERSION_PATCH

#if BOOST_CXX_VERSION_PATCH >= 201700L
#include <functional>
#endif
...
#endif // #if defined(BOOST_LIBSTDCXX_VERSION) && BOOST_LIBSTDCXX_VERSION < 40900

#endif //#if BOOST_CXX_VERSION_PATCH >= 201700L
