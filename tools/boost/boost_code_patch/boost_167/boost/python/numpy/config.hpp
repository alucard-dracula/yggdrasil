...
#define _BOOST_PYTHON_NUMPY_CONCAT(N, M, m) N ## M ## m
#define BOOST_PYTHON_NUMPY_CONCAT(N, M, m) _BOOST_PYTHON_NUMPY_CONCAT(N, M, m)
#define BOOST_LIB_NAME BOOST_PYTHON_NUMPY_CONCAT(boost_numpy, PY_MAJOR_VERSION, PY_MINOR_VERSION)
...
#undef BOOST_PYTHON_NUMPY_CONCAT
#undef _BOOST_PYTHON_NUMPY_CONCAT
