   ...
   :  public slist_hook<VoidPointer>::type
{
   ...
   BOOST_CONTAINER_FORCEINLINE ~slist_node()
   {  (patch::aligned_storage_value_pointer<T>(this->m_storage))->~T();  }
...
struct has_trivial_destructor_after_move<boost::container::slist<T, Allocator> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::slist<T, Allocator>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::slist<T, Allocator>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value;
};
