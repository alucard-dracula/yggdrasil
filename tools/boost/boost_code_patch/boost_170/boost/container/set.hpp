...
struct has_trivial_destructor_after_move<boost::container::set<Key, Compare, Allocator, Options> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::set<Key, Compare, Allocator, Options>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::set<Key, Compare, Allocator, Options>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value &&
                             ::boost::has_trivial_destructor_after_move<Compare>::value;
};
...
struct has_trivial_destructor_after_move<boost::container::multiset<Key, Compare, Allocator, Options> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::multiset<Key, Compare, Allocator, Options>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::multiset<Key, Compare, Allocator, Options>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value &&
                             ::boost::has_trivial_destructor_after_move<Compare>::value;
};
