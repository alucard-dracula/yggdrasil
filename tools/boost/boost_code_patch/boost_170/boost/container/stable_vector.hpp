...
struct has_trivial_destructor_after_move<boost::container::stable_vector<T, Allocator> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::stable_vector<T, Allocator>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::stable_vector<T, Allocator>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value;
};
