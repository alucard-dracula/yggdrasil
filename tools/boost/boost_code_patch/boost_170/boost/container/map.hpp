...
#define YGGR_FIXBUG_BOOST_162_TO_170_MAP_INSERT_OR_ASSIGN_HINT
...
struct has_trivial_destructor_after_move<boost::container::map<Key, T, Compare, Allocator> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::map<Key, T, Compare, Allocator>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::map<Key, T, Compare, Allocator>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value &&
                             ::boost::has_trivial_destructor_after_move<Compare>::value;
};
...
struct has_trivial_destructor_after_move<boost::container::multimap<Key, T, Compare, Allocator> >
{
   typedef typename ::boost::container::allocator_traits<typename boost::container::multimap<Key, T, Compare, Allocator>::allocator_type>::pointer pointer;
   static const bool value = ::boost::has_trivial_destructor_after_move<typename boost::container::multimap<Key, T, Compare, Allocator>::allocator_type>::value &&
                             ::boost::has_trivial_destructor_after_move<pointer>::value &&
                             ::boost::has_trivial_destructor_after_move<Compare>::value;
};
