...
// #if !(defined(__MINGW32__) && (13 < __GNUC__))
...
// #endif // !(defined(__MINGW32__) && (13 < __GNUC__))
...
struct has_operator_pointer_member_access_class
	: public 
		detail::_has_op_ptr_mem_acc_class
		<
			typename 
...
template<class Archive, class U, template<class _U> class SPT >
typename boost::enable_if<patch::has_operator_pointer_member_access_class< SPT<U> >, void>::type
    load(
    Archive & ar,
    SPT< U > &t,
    const unsigned int file_version
...
// #endif // #if !(defined(__MINGW32__) && (13 < __GNUC__))
