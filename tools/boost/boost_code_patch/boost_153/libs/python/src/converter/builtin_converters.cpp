...
namespace
{
  ...
  void* convert_to_cstring(PyObject* obj)
  {
	  ...
	  return PyString_Check(obj) ? reinterpret_cast<void*>(const_cast<char*>(PyString_AsString(obj))) : 0;
  }
#else
  void* convert_to_cstring(PyObject* obj)
  {
      //return PyUnicode_Check(obj) ? _PyUnicode_AsString(obj) : 0;
	  return PyUnicode_Check(obj) ? reinterpret_cast<void*>(const_cast<char*>(_PyUnicode_AsString(obj))) : 0;
  }
#endif
