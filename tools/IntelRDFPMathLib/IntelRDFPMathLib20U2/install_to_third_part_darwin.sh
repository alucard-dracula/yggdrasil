...
#   include fix
    cp -fr "${var_local_dir}/LIBRARY/float128" "${var_src_dir}/include/"
    cp -fr "${var_local_dir}/LIBRARY/src" "${var_src_dir}/include/"
    find "${var_src_dir}/include/" -type f -name "*.c" -exec rm -fr {} \;
...
var_proj_name="intel_bid"
var_third_part_root_dir="/Users/alucard"
var_prefix_name="IntelRDFPMathLib20U2"
