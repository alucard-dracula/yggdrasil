...
_state_need_kms_credentials (_state_machine_t *sm, bson_error_t *error)
{
   ...
   bson_iter_t iter;
   bool callback_provided_aws = false;

   bool cb_provided_azure = false;
   bool orig_wants_auto_azure = false;
   bool wants_auto_azure = false;

   bool cb_provided_gcp = false;
   bool orig_wants_auto_gcp = false;
   bool wants_auto_gcp = false;
