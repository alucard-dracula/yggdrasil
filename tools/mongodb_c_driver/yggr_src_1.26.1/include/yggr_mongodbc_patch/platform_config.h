...
#ifndef __MONGODB_YGGR_MONGODBC_PATCH_PLATFORM_CONFIG_H__
#define __MONGODB_YGGR_MONGODBC_PATCH_PLATFORM_CONFIG_H__
...
#endif // __MONGODB_YGGR_MONGODBC_PATCH_PLATFORM_CONFIG_H__
