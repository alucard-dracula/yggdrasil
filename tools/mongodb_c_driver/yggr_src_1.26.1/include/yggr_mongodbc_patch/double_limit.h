...
#ifndef __MONGODB_YGGR_MONGODBC_PATCH_DOUBLE_LIMIT_H__
#define __MONGODB_YGGR_MONGODBC_PATCH_DOUBLE_LIMIT_H__
...
#endif // __MONGODB_YGGR_MONGODBC_PATCH_DOUBLE_LIMIT_H__