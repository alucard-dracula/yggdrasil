...
#ifndef __MONGODB_YGGR_MONGODBC_PATCH_MONGOC_CONFIG_PLATFORM_H__
#define __MONGODB_YGGR_MONGODBC_PATCH_MONGOC_CONFIG_PLATFORM_H__
...
#		define MONGOC_USER_SET_CFLAGS \
			-DWIN32 -DWIN64 -D_DEBUG -D_WINDOWS -D_LIB \
...
#		define MONGOC_USER_SET_CFLAGS \
			-DWIN32 -DWIN64 -DNDEBUG -D_WINDOWS -D_LIB \
			-DBSON_STATIC -DBUILD_MONGODB_DRIVER_YGGR_VER -DKMS_MSG_STATIC \
			-DMLIB_USER -DMONGOCRYPT_LITTLE_ENDIAN \
			-DMONGOCRYPT_STATIC_DEFINE -DMONGOC_COMPILATION -DMONGOC_STATIC -DUTF8PROC_STATIC \
...
#		define MONGOC_USER_SET_CFLAGS \
			-DWIN32 -D_DEBUG -D_WINDOWS -D_LIB \
			-DBSON_STATIC -DBUILD_MONGODB_DRIVER_YGGR_VER -DKMS_MSG_STATIC \
			-DMLIB_USER -DMONGOCRYPT_LITTLE_ENDIAN \
			-DMONGOCRYPT_STATIC_DEFINE -DMONGOC_COMPILATION -DMONGOC_STATIC -DUTF8PROC_STATIC \
...
#		define MONGOC_USER_SET_CFLAGS \
			-DWIN32 -DNDEBUG -D_WINDOWS -D_LIB \
			-DBSON_STATIC -DBUILD_MONGODB_DRIVER_YGGR_VER -DKMS_MSG_STATIC \
			-DMLIB_USER -DMONGOCRYPT_LITTLE_ENDIAN \
			-DMONGOCRYPT_STATIC_DEFINE -DMONGOC_COMPILATION -DMONGOC_STATIC -DUTF8PROC_STATIC \
 ...
 */
#if !defined(MONGOC_ENABLE_CRYPTO_PBKDF2)
#	if defined(MINGW_USING_WIN_API)
...
#	if (YGGR_EX_SYSTEM_64)
#		define MONGOC_CYRUS_PLUGIN_PATH_PREFIX "D:/msys64/mingw64/lib/sasl2"
#	else
#		define MONGOC_CYRUS_PLUGIN_PATH_PREFIX "D:/msys64/mingw32/lib/sasl2"
...
#endif //__MONGODB_YGGR_MONGODBC_PATCH_MONGOC_CONFIG_PLATFORM_H__
