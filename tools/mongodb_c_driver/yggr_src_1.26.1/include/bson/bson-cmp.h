...
BSON_IN_RANGE_SET_SIGNED (int8_t, SCHAR_MIN, SCHAR_MAX)
BSON_IN_RANGE_SET_SIGNED (int16_t, SHRT_MIN, SHRT_MAX)
BSON_IN_RANGE_SET_SIGNED (int32_t, INT_MIN, INT_MAX)
BSON_IN_RANGE_SET_SIGNED (int64_t, LLONG_MIN, LLONG_MAX)

BSON_IN_RANGE_SET_UNSIGNED (uint8_t, UCHAR_MAX)
BSON_IN_RANGE_SET_UNSIGNED (uint16_t, USHRT_MAX)
BSON_IN_RANGE_SET_UNSIGNED (uint32_t, UINT_MAX)
BSON_IN_RANGE_SET_UNSIGNED (uint64_t, ULLONG_MAX)
#else
