 ...
 * @MONGOC_DELETE_NONE: Specify no deletor flags.
 ...
 *
 * #mongoc_delete_flags_t are used when performing a deletor operation.
 */
typedef enum {
 ...
 * @MONGOC_REMOVE_NONE: Specify no deletor flags.
