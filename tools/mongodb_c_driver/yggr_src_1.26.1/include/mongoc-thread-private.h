...
#if defined(BSON_OS_UNIX) || defined(YGGR_EX_PLATFORM_MINGW32) || defined(YGGR_EX_PLATFORM_CYGWIN)
...
#if defined(MONGOC_ENABLE_DEBUG_ASSERTIONS) \
	&& (defined(BSON_OS_UNIX) || defined(YGGR_EX_PLATFORM_MINGW32) || defined(YGGR_EX_PLATFORM_CYGWIN))
