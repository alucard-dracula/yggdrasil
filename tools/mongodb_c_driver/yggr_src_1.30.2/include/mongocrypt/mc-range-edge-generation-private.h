...
static MONGOC_INLINE size_t mc_count_leading_zeros_u64(uint64_t in) {
#ifdef __has_builtin
...
static MONGOC_INLINE size_t mc_count_leading_zeros_u32(uint32_t in) {
#ifdef __has_builtin
...
static MONGOC_INLINE size_t mc_count_leading_zeros_u128(mlib_int128 in) {
