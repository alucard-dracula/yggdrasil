...
static MONGOC_INLINE uint16_t __mongocrypt_uint16_swap_slow(uint16_t v) /* IN */
{
...
static MONGOC_INLINE uint32_t __mongocrypt_uint32_swap_slow(uint32_t v) /* IN */
{
...
static MONGOC_INLINE uint64_t __mongocrypt_uint64_swap_slow(uint64_t v) /* IN */
{
