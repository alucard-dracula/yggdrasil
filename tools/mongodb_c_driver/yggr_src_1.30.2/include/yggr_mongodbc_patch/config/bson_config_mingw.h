...
#ifndef __MONGODB_YGGR_MONGODBC_PATCH_BSON_CONFIG_PLATFORM_H__
#define __MONGODB_YGGR_MONGODBC_PATCH_BSON_CONFIG_PLATFORM_H__
...
#	define BSON_HAVE_GMTIME_R 0 // mingw not supported
...
#endif // __MONGODB_YGGR_MONGODBC_PATCH_BSON_CONFIG_PLATFORM_H__ 
