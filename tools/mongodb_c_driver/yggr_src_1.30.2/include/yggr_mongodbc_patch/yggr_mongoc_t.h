...
#ifndef __MONGODB_YGGR_MONGODBC_PATCH_MONGOC_H__
#define __MONGODB_YGGR_MONGODBC_PATCH_MONGOC_H__
...
#if !defined(MONGODB_DRIVER_INCLUDED_YGGR_VER) // yggdrasil check version
#	define MONGODB_DRIVER_INCLUDED_YGGR_VER
#endif // MONGODB_DRIVER_INCLUDED_YGGR_VER


#endif // __MONGODB_YGGR_MONGODBC_PATCH_MONGOC_H__
