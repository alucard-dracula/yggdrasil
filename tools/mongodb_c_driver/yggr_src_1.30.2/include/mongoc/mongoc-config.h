...
#if defined(_MSC_VER)
#	include <yggr_mongodbc_patch/config/mongoc_config_msvc.h>
#elif defined(__MINGW32__)
#	include <yggr_mongodbc_patch/config/mongoc_config_mingw.h>
#elif defined(__APPLE__) || defined(__APPLE_CC__)
#	if (defined(TARGET_OS_IPHONE) && TARGET_OS_IPHONE) \
		|| (defined(TARGET_OS_IOS) && TARGET_OS_IOS)
#		include <yggr_mongodbc_patch/config/mongoc_config_ios.h>
#	else
#		include <yggr_mongodbc_patch/config/mongoc_config_darwin.h>
#	endif // TARGET_OS_IPHONE
#else
#	if defined(__ANDROID__) || defined(ANDROID)
#		include <yggr_mongodbc_patch/config/mongoc_config_android.h>
#	else
#		include <yggr_mongodbc_patch/config/mongoc_config_linux.h>
#	endif // __ANDROID__
#endif // _MSC_VER
...
#define MONGOC_CC "d:/Program Files/Microsoft Visual Studio/2022/Enterprise/VC/Tools/MSVC/14.43.34808/bin/Hostx64/x64/cl.exe"
