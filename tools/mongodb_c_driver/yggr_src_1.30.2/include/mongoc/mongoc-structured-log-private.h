...
#define _mongoc_structured_log_with_end_of_list(_structured_log_instance, _level, _component, _message, ...)		\
	do {																											\
		mongoc_structured_log_entry_t _entry = {{(_structured_log_instance),										\
													(_level),														\
													(_component),													\
													(_message) }};													\
		if (_mongoc_structured_log_should_log (&_entry.envelope)) {													\
...
#	define _mongoc_structured_log_item_end_of_list() {.func = NULL},
#else
#	define _mongoc_structured_log_item_end_of_list() {NULL},
#endif // #if defined(YGGR_EX_C99_SUPPORTED)
...
#	define _mongoc_structured_log_item_utf8(_key_or_null, _value_utf8) \
		{_mongoc_structured_log_append_utf8, {(int64_t)(_key_or_null)}, {(int64_t)(_value_utf8)} },
...
#	define _mongoc_structured_log_item_utf8_nn(_key_or_null, _key_len, _value_utf8, _value_len)							\
		{_mongoc_structured_log_append_utf8_n_stage0, {(int64_t)(_key_or_null)}, {(int64_t)(_key_len)} },								\
		{_mongoc_structured_log_append_utf8_n_stage1, {(int64_t)(_value_utf8)}, {(int64_t)(_value_len)}},
...
#	define _mongoc_structured_log_item_int32(_key_or_null, _value_int32) \
		{_mongoc_structured_log_append_int32, {(int64_t)(_key_or_null)}, {(int64_t)(_value_int32)}},
...
#	define _mongoc_structured_log_item_int64(_key_or_null, _value_int64) \
		{_mongoc_structured_log_append_int64, {(int64_t)(_key_or_null)}, {(_value_int64)}},
...
static MONGOC_INLINE int64_t patch_reinterpret_cast_int64_t(double val)
{
	
	int64_t tmp = 0;

	BSON_ASSERT(sizeof(int64_t) == sizeof(double));
	memcpy(&tmp, &val, sizeof(int64_t));
	return tmp;
}

#	define _mongoc_structured_log_item_double(_key_or_null, _value_double) \
		{_mongoc_structured_log_append_double, {(int64_t)(_key_or_null)}, {patch_reinterpret_cast_int64_t(_value_double)}},
...
#	define _mongoc_structured_log_item_boolean(_key_or_null, _value_boolean) \
		{_mongoc_structured_log_append_boolean, {(int64_t)(_key_or_null)}, {(int64_t)(!!_value_boolean)}},
...
#	define _mongoc_structured_log_item_error(_key_or_null, _error_or_null) \
		{_mongoc_structured_log_append_error, {(int64_t)(_key_or_null)}, {(int64_t)(_error_or_null)}},
...
#	define _mongoc_structured_log_item_read_prefs(_key_or_null, _value_read_prefs)		\
		{_mongoc_structured_log_append_read_prefs, {(int64_t)(_key_or_null)}, {(int64_t)(_value_read_prefs)}},
...
#	define _mongoc_structured_log_item_oid(_key_or_null, _value_oid) \
		{_mongoc_structured_log_append_oid, {(int64_t)(_key_or_null)}, {(int64_t)(_value_oid)}},
...
#	define _mongoc_structured_log_item_oid_as_hex(_key_or_null, _value_oid) \
		{_mongoc_structured_log_append_oid_as_hex, {(int64_t)(_key_or_null)}, {(int64_t)(_value_oid)}},
...
#	define _mongoc_structured_log_item_bson_as_json(_key_or_null, _value_bson) \
		{_mongoc_structured_log_append_bson_as_json, {(int64_t)(_key_or_null)}, {(int64_t)(_value_bson)}},
...
#	define _mongoc_structured_log_item_topology_description_as_json(_key_or_null, _value_topology_description)	\
		{_mongoc_structured_log_append_topology_description_as_json,											\
			{(int64_t)(_key_or_null)}, {(int64_t)(_value_topology_description)}},
...
#	define _mongoc_structured_log_item_topology_as_description_json(_key_or_null, _topology)		\
			{_mongoc_structured_log_append_topology_as_description_json,					\
			{(int64_t)(_key_or_null)}, {(int64_t)(_topology)}},
...
#	define _mongoc_structured_log_item_cmd(_cmd, ...)	\
		{_mongoc_structured_log_append_cmd,				\
			{(int64_t)(_cmd)},									\
			{(int64_t)(0 _bsonDSL_mapMacro (_mongoc_structured_log_flag_expr, MONGOC_STRUCTURED_LOG_CMD_CONTENT_FLAG, __VA_ARGS__))}},
...
#	define _mongoc_structured_log_item_cmd_reply(_cmd, _reply_bson)		\
		{_mongoc_structured_log_append_cmd_reply, {(int64_t)(_cmd)}, {(int64_t)(_reply_bson)}},
...
#	define _mongoc_structured_log_item_cmd_name_reply(_cmd_name, _reply_bson) \
		{_mongoc_structured_log_append_cmd_name_reply, {(int64_t)(_cmd_name)}, {(int64_t)(_reply_bson)}},
...
#	define _mongoc_structured_log_item_cmd_failure(_cmd, _reply_bson, _error)                                     \
		{_mongoc_structured_log_append_cmd_failure_stage0, {(int64_t)(_cmd)}, {(int64_t)(_reply_bson)}}, \
		{_mongoc_structured_log_append_cmd_failure_stage1, {(int64_t)(_error)}},
...
#	define _mongoc_structured_log_item_cmd_name_failure(_cmd_name, _reply_bson, _error)					\
		{_mongoc_structured_log_append_cmd_name_failure_stage0, {(int64_t)(_cmd_name)}, {(int64_t)(_reply_bson)}},	\
		{_mongoc_structured_log_append_cmd_name_failure_stage1, {(int64_t)(_error)} },
...
#	define _mongoc_structured_log_item_server_description(_server_description, ...)		\
		{_mongoc_structured_log_append_server_description,								\
		{(int64_t)(_server_description)},														\
		{(int64_t)(0 _bsonDSL_mapMacro (_mongoc_structured_log_flag_expr, MONGOC_SERVER_DESCRIPTION_CONTENT_FLAG, __VA_ARGS__))}},
