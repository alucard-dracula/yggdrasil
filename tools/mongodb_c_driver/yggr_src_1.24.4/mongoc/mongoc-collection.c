 ...
 *       limit to a single deletor, provided MONGOC_REMOVE_SINGLE_REMOVE
 *       for @flags.
 *
 ...
 * Parameters:
 *       @collection: A mongoc_collection_t.
 *       @flags: the deletor flags or 0.
 *       @selector: A selector of documents to deletor.
