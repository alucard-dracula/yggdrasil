 ...
 *
 * The basic write commands (i.e. insert, update, deletor) are intentionally
 * excluded here. While insert is always retryable, update and deletor are only
 ...
 * allow_txn_number for us. This means that insert, update, and deletor are not
 ...
 *      "deletes" if deleter) an the payload as a BSON array.
 *
 *--------------------------------------------------------------------------
 */
void
