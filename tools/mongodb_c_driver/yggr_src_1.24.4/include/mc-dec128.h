...
static MONGOC_INLINE char *mc_dec128_to_new_decimal_string(mc_dec128 d) {
    ...
    static const mc_dec128 TEN = MC_DEC128_C(10);
	char* s = 0;
	char* s1 = 0;
	const char* r = 0;
	char* c = 0;
	mc_dec128_modf_result modf = {{{0}}};
	mc_dec128 log10 = {{0}};
	int64_t ndigits = 0;
	char *strbuf = 0;
	char *optr = 0;
...
static MONGOC_INLINE mc_dec128 mc_dec128_from_bson_iter(bson_iter_t *it) {
    bson_decimal128_t b;
