...
static BSON_INLINE const mcd_azure_imds_request g_mcd_azure_imds_request_obj(void)
{
	static const mcd_azure_imds_request tmp = {{0}};
	return tmp;
}

#define MCD_AZURE_IMDS_REQUEST_INIT g_mcd_azure_imds_request_obj();
