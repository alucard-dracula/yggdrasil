...
mc_mincover_t *mc_getMincoverInt32(mc_getMincoverInt32_args_t args, mongocrypt_status_t *status) {
	...
	foo_args.value = args.lowerBound;
	if (!mc_getTypeInfo32(foo_args, &a, status)) {
		return NULL;
	}

	foo_args.value = args.upperBound;
	if (!mc_getTypeInfo32(foo_args, &b, status)) {
		return NULL;
	}
...
mc_mincover_t *mc_getMincoverInt64(mc_getMincoverInt64_args_t args, mongocrypt_status_t *status) {
   ...
   // mc_OSTType_Int64 a, b;
	...
	foo_args.value = args.lowerBound;
    if (!mc_getTypeInfo64(foo_args, &a, status)) {
        return NULL;
    }

	foo_args.value = args.upperBound;
    if (!mc_getTypeInfo64(foo_args, &b, status)) {
        return NULL;
    }
...
mc_mincover_t *mc_getMincoverDouble(mc_getMincoverDouble_args_t args, mongocrypt_status_t *status) {
	...
	foo_args.value = args.lowerBound;
    if (!mc_getTypeInfoDouble(foo_args, &a, status)) {
        return NULL;
    }

	foo_args.value = args.upperBound;
    if (!mc_getTypeInfoDouble(foo_args, &b, status)) {
        return NULL;
    }
...
mc_mincover_t *mc_getMincoverDecimal128(mc_getMincoverDecimal128_args_t args, mongocrypt_status_t *status) {
	mc_OSTType_Decimal128 a, b;
	mc_getTypeInfoDecimal128_args_t foo_args = {0};
...
#define ToString(Dec) (mc_dec128_to_string(Dec).str)
	...
	foo_args.value = args.lowerBound;
    if (!mc_getTypeInfoDecimal128(foo_args, &a, status)) {
        return NULL;
    }

	foo_args.value = args.upperBound;
    if (!mc_getTypeInfoDecimal128(foo_args, &b, status)) {
        return NULL;
    }
