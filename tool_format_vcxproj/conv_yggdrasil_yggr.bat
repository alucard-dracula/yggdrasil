...
:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir2%<\/root_dir_>/g" tool_format_vcxproj_cfg.xml
:rem tool_format_vcxproj.exe tool_format_vcxproj_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir3%<\/root_dir_>/g" tool_format_vcxproj_cfg.xml
:rem tool_format_vcxproj.exe tool_format_vcxproj_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir4%<\/root_dir_>/g" tool_format_vcxproj_cfg.xml
:rem tool_format_vcxproj.exe tool_format_vcxproj_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir5%<\/root_dir_>/g" tool_format_vcxproj_cfg.xml
:rem tool_format_vcxproj.exe tool_format_vcxproj_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir6%<\/root_dir_>/g" tool_format_vcxproj_cfg.xml
:rem tool_format_vcxproj.exe tool_format_vcxproj_cfg.xml
