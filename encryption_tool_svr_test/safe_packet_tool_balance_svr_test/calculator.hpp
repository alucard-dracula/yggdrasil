...
#ifndef __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CALCULATOR_HPP__
#define __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CALCULATOR_HPP__
...
#endif // __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CALCULATOR_HPP__