...
#ifndef __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CONFIG_HPP__
#define __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CONFIG_HPP__
...
typedef yggr::network::network_direct_def_type network_direct_def_type;
...
#endif // __SAFE_PACKET_TOOL_BALANCE_TCP_SVR_CONFIG_HPP__