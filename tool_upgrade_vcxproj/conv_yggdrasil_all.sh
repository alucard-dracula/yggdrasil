...
./tool_upgrade_vcxproj tool_upgrade_vcxproj_cfg.xml

sed -i "/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir2}<\/root_dir_>/g" tool_upgrade_vcxproj_cfg.xml
./tool_upgrade_vcxproj tool_upgrade_vcxproj_cfg.xml
...
sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir11_1}<\/root_dir_>/g" tool_upgrade_vcxproj_cfg.xml
./tool_upgrade_vcxproj tool_upgrade_vcxproj_cfg.xml

sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir11_2}<\/root_dir_>/g" tool_upgrade_vcxproj_cfg.xml
./tool_upgrade_vcxproj tool_upgrade_vcxproj_cfg.xml
