...
ln -s ../../lib/Debug-x64/liblua_calculator.dylib ${target_dir_exe}/lua_calculator.so
ln -s ../../lib/Debug-x64/liblua_cal_svr_procotol.dylib ${target_dir_exe}/lua_cal_svr_procotol.so
ln -s ../../lib/Debug-x64/liblua_hello_dll.dylib ${target_dir_exe}/lua_hello_dll.so
