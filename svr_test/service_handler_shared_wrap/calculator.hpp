...
#ifndef __SVR_TEST_SERVICE_HANDLER_SARED_WRAP_TEST_CALCULATOR_HPP__
#define __SVR_TEST_SERVICE_HANDLER_SARED_WRAP_TEST_CALCULATOR_HPP__
...
public:
	...
	void print_socket_info(session_mgr_type::smap_type::base_type& base, 
	...
	void cal_test_pak_type(const owner_info_type& owner, test_pak_type& cdt, // using test_pak_type& mens cdt can modify it(e.g. move), other using const test_pak_type&
...
#endif // __SVR_TEST_SERVICE_HANDLER_SARED_WRAP_TEST_CALCULATOR_HPP__