...
#ifndef __BALANCE_ASYNC_TCP_SVR_CONFIG_HPP__
#define __BALANCE_ASYNC_TCP_SVR_CONFIG_HPP__
...
typedef 
	yggr::network::session_helper::session_creator
	<
		test_pak_type, conn_type/*,
		yggr::network::session_helper::session_id_creator<test_pak_type>,
		yggr::network::session_helper::session_checker_creator<test_pak_type>,
		yggr::network::session_helper::session_crypher_creator<test_pak_type>,
		yggr::network::default_options_setter*/
	> session_creator_type;

typedef 
	yggr::server::start_mode::server_active_start_mode
	<
...
public:
	...
	{
		return conn.set_option(boost::asio::ip::tcp::socket::linger(1, 0));
	}
};
...
YGGR_PP_THREAD_ACTRION_HELPER_MAKE_REG_ID_PARSER(
	action_reg_string_parser,
	yggr::string,
...
typedef 
	yggr::thread::action_helper::action_id_parser
	<
		action_reg_id_parser_type,
		task_type::class_name_getter
	> action_id_parser_type;
...
#endif // __BALANCE_ASYNC_TCP_SVR_CONFIG_HPP__