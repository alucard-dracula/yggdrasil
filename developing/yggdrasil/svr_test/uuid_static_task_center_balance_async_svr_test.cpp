...
typedef yggr::network::start_data::pak_back_id<yggr::ids::uuid> test_pak_type; // 定义网络对接的第一个数据包类型（此例题并用这个包测试echo）

//typedef yggr::network::network_info<yggr::ids::id64_type> network_info_type; // 定义网络信息类型（网络信息用来标识数据包数据包属于哪个用户的）
typedef yggr::network::network_info<yggr::ids::uuid> network_info_type; // 定义网络信息类型（网络信息用来标识数据包数据包属于哪个用户的）
...
{
template<>
struct pointer_id_generator<yggr::ids::uuid>
{
	typedef yggr::ids::uuid id_type;
	typedef yggr::ids::id_generator<yggr::ids::uuid,
								yggr::ids::parse_uuid_genner::lagged_fibonacci607_type> id_gen_type;

	template<typename T>
	static id_type gen(const boost::shared_ptr<T>& ptr)
	{
		id_gen_type gen;
		return ptr? gen() : id_type();
	}
...
typedef yggr::ids::pointer_id_generator<yggr::ids::uuid> session_id_generator_type; // 定义会话ID生成器类型（该例题直接使用会话的对象地址作为会话ID）
...
public:
	...
	{
		//CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::connection_reset,//10054
  ...
  //      CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 2,
		//									yggr::yggr::system_controller::system_code::E_SESSION_SYSTEM,
		//									boost::bind(&Calculator::cal_2_dispath<yggr::u64>, this, _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::invalid_argument,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::message_size,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::name_too_long,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::network_down,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::no_buffer_space,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::no_memory,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::shut_down,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::timed_out,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::connection_reset,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::connection_aborted,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, boost::asio::error::operation_aborted,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));
        ...
        CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 2,
         ...
         CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 104,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		 CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 121,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		 CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 0x60009004,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		 CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, 0x60020001,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));

		 CTRL_HANDLER_PARAM_1(Tag, cc, yggr::ids::uuid, session_type::close_code_type::value,
								yggr::system_controller::system_code::E_SESSION_SYSTEM,
								boost::bind(&this_type::cal_network_dispath<yggr::ids::uuid>,
												shared_from_this(), _1));
	}
