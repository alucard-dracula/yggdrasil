//static_task_center_async_svr_test.cpp
...
{
public:
	ERROR_MAKER_BEGIN("Svr_Calculator")
...
//											yggr::system_controller::system_code::E_YGGR_SYSTEM,
//											boost::bind(&Calculator::cal_10054_dispath<yggr::u64>, this, _1));
	}
	...
	void cal_test_pak_type(const Owner& owner, const test_pak_type& cdt, Runner* prunner, Handler handler)
	{
	...
	void cal_10054_dispath(const Owner& owner)
	{
...
int main(int argc, char* argv[])
{
	...
	yggr::log::yggr_exception_log_accesser_type::init_type log_init; //memd to BOOST_PP_LOCAL_MAROC
	log_init.push_back("nt_log");

	log_accesser_single::init_ins(log_init);

	yggr::log::yggr_exception_log_accesser_type::data_creator_type dc1("nt_log");
	...
	svr_ptr_single_type::init_ins(4, tcp_svr_handler_type::init_type(port,
	...
	{
	    ctrl_center_single::obj_ptr_type tmp;
		pctrl.swap(tmp);
	}
	try
	{
