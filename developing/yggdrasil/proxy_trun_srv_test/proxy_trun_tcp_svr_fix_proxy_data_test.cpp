...
private:
	...
	void register_dispatchers(Ctrl_Center& cc)
	{
		...
		CTRL_HANDLER_PARAM_1(Tag, cc, yggr::u64, proxy_session_type::close_code_type::value,
...
public:
	...
	void register_cal_object(Action_Table& at, const Recv_Handler& handler)
	{
		...
		at.template register_calculator_of_container<
														...
														net_ipak_type,
														Recv_Handler>(
				handler, boost::bind(&this_type::cal_test_pak_type<
																	owner_info_type,
																	runner_type,
																	recv_handler_type>,
...
public:
										...
										const Handler& handler)
	{
		...
		base_type::route(owner, cdt, prunner,handler, test_pak_type::s_cal_type());
	}
};
