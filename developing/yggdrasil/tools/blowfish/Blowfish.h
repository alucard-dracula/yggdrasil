...
inline unsigned char ex_to_byte(unsigned int ui)
{
...
{
	return ((m_auiS[0][ex_to_byte(ui>>24)] + m_auiS[1][ex_to_byte(ui>>16)]) ^ m_auiS[2][ex_to_byte(ui>>8)]) + m_auiS[3][ex_to_byte(ui)];
}
