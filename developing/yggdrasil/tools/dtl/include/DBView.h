...
template<class DataObj> class DefaultBCA : public STD_::binary_function<BoundIOs &, DataObj &, void>
{
  public:
	  void operator()(BoundIOs & DTL_DUMMY_PARAM_1, DataObj & DTL_DUMMY_PARAM_2)
     {
...
template<class ParamObj> class DefaultBPA : public STD_::binary_function<BoundIOs &, ParamObj &, void>
{
  public:
	  void operator()(BoundIOs & DTL_DUMMY_PARAM_1, ParamObj & DTL_DUMMY_PARAM_2)
	  { }
};

template<class ParamObj> class EmptyBPA : public STD_::binary_function<BoundIOs &, ParamObj &, void>
{
  public:
	  void operator()(BoundIOs & DTL_DUMMY_PARAM_1, ParamObj & DTL_DUMMY_PARAM_2)
	  { }
