...
void save_test(mongodb_io_system_type& io_sys)
{
	...
	{
		type_test t;
		io_sys.save<base_database_container::save_back_data>(base_database_container::type_id(), base_database_container::save_data(t), boost::bind(&save_out, _1));
...
void load_test(mongodb_io_system_type& io_sys)
{
	...
	{
		yggr::nsql_database_system::c_bson b1, b2;
		io_sys.load<base_database_container::load_data>(base_database_container::type_id(), base_database_container::load_cdt(b1, b2), boost::bind(&out, _1));
	}
}
