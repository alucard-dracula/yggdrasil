...
void test_u64(script_mgr_type& mgr)
{
	...
	mgr.execute_rule("lua_base_type_test_u64", a, ra);
...
void test_u64_vector(script_mgr_type& mgr)
{
	...
	u64_vector_type rvt;
	mgr.execute_rule("lua_base_type_test_vector_u64", vt, rvt);
...
void test_u32_vector(script_mgr_type& mgr)
{
	...
	u32_vector_type rvt;
	mgr.execute_rule("lua_base_type_test_vector_u32", vt, rvt);
	std::cout << "C++ " << rvt << std::endl;
}
...
void test_u64_list(script_mgr_type& mgr)
{
	...
	u64_list_type rvt;
	mgr.execute_rule("lua_base_type_test_list_u64", vt, rvt);
	std::cout << "C++ " << rvt << std::endl;
}
...
void exec_test()
{
	...
	std::string code_test_u64("./lua/lua_base_type_test_u64.lua");
	std::string code_test_vector_u64("./lua/lua_base_type_test_vector_u64.lua");
	std::string code_test_vector_u32("./lua/lua_base_type_test_vector_u32.lua");
	std::string code_test_list_u64("./lua/lua_base_type_test_list_u64.lua");

    try
	{
		mgr.insert("lua_base_type_test_u64", "calculate", script_mgr_type::file_code_type(code_test_u64));
		mgr.insert("lua_base_type_test_vector_u64", "calculate", script_mgr_type::file_code_type(code_test_vector_u64));
		mgr.insert("lua_base_type_test_vector_u32", "calculate", script_mgr_type::file_code_type(code_test_vector_u32));
		mgr.insert("lua_base_type_test_list_u64", "calculate", script_mgr_type::file_code_type(code_test_list_u64));
    }
