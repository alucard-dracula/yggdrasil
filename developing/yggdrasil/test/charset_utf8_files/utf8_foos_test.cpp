...
{
	assert(yggr::string("utf-8") == yggr::charset::default_charset_config::get_default_string_charset_name<char>());
	assert(yggr::string("ucs-4le") == yggr::charset::default_charset_config::get_default_string_charset_name<wchar_t>());
	assert(yggr::charset::default_charset_config::get_str_default_string_charset_name<char>() == yggr::string("utf-8"));
	assert(yggr::charset::default_charset_config::get_str_default_string_charset_name<wchar_t>() == yggr::string("ucs-4le"));
