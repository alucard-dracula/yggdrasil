...
#if USE_STL_SET
#   include <set>
    typedef yggr::safe_container::safe_set<int, boost::mutex,
...
void test_thread_safe_of_mutex(void)
{
	...
	typedef yggr::safe_container::safe_set<val_type> container_type;
...
{
	typedef boost::shared_ptr<int> val_type;
	typedef yggr::safe_container::safe_set<val_type, boost::shared_mutex> container_type;
