...
void test_capacity(void)
{
	...
	int f = 0, b = 0;
	assert(cont1.front(f));
	assert(cont1.back(b));

	assert(f == base_cont1.front() && b == base_cont1.back());
...
void test_thread_safe_of_mutex(void)
{
	...
	typedef yggr::safe_container::safe_queue<val_type> container_type;
...
{
	typedef boost::shared_ptr<int> val_type;
	typedef yggr::safe_container::safe_queue<val_type, boost::shared_mutex> container_type;
