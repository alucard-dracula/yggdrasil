...
void test_constructor(void)
{
	...
	stack_type::container_type init_cont;
	stack_type cont3(init_cont);
	assert(cont2.empty());

	stack_type::base_type base_cont4;
	base_cont4.push(10);
	base_cont4.push(20);

	stack_type cont4(boost::move(base_cont4));
	assert(cont4.size() == 2 && base_cont4.size() == 0);

	stack_type::base_type base_cont5;
	base_cont5.push(10);
	base_cont5.push(20);
...
void test_capacity(void)
{
	...
	stack_type::container_type init_cont(arr, arr + 10);

	stack_type cont1(init_cont);
	stack_type::base_type base_cont1(init_cont);
...
{
	stack_type cont;
	stack_type::base_type base_cont;
...
void test_swap(void)
{
	...
	stack_type::container_type init_cont1(arr1, arr1 + 10);
	stack_type::container_type init_cont2(arr2, arr2 + 5);

	stack_type cont1(init_cont1);
	stack_type cont2(init_cont2);

	stack_type::base_type base_cont1(init_cont1);
	stack_type::base_type base_cont2(init_cont2);
	assert(cont1.size() == base_cont1.size());
	assert(cont1.size() != base_cont2.size());

	stack_type::base_type base_cont3(base_cont1);
	stack_type::base_type base_cont4(base_cont2);
...
void test_thread_safe_of_mutex(void)
{
	...
	typedef yggr::safe_container::safe_stack<val_type> container_type;
...
{
	typedef boost::shared_ptr<int> val_type;
	typedef yggr::safe_container::safe_stack<val_type, boost::shared_mutex> container_type;
