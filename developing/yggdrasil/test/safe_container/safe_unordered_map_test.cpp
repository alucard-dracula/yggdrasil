...
void test_thread_safe_of_mutex(void)
{
	...
	typedef yggr::safe_container::safe_unordered_map<int, val_type> container_type;
...
{
	typedef boost::shared_ptr<int> val_type;
	typedef yggr::safe_container::safe_unordered_map<int, val_type, boost::shared_mutex> container_type;
