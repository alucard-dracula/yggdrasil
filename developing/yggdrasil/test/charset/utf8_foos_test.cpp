...
void test_charset_base_foo(void)
{
	...
	boost::container::string boost_str("abc���");

#ifndef __MINGW32__
	std::wstring std_wstr(L"abc���");
	boost::container::wstring boost_wstr(L"abc���");
#else
    std::string std_wstr("abc���");
	boost::container::string boost_wstr("abc���");
#endif // __MINGW32__
...
#ifndef __MINGW32__
	std::wstring std_wstr3(L"abc_���_wchar_t");
#else
    std::string std_wstr3("abc_���_wchar_t");
#endif // __MINGW32__
	std::string std_str3;
...
void test_charset_foo(void)
{
	...
	{
#ifndef __MINGW32__
		std::wstring str(L"abcw1���");
#else
        std::string str("abcw1���");
#endif // __MINGW32__
	...
	{
#ifndef __MINGW32__
		std::wstring str(L"abcw2���");
#else
        std::string str("abcw2���");
#endif // __MINGW32__
	...
	{
#ifndef __MINGW32__
		std::wstring str(L"abcw4 ���");
#else
        std::string str("abcw4 ���");
#endif // __MINGW32__
