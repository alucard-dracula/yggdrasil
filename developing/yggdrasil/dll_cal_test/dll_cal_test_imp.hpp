//dll_cal_test_imp.hpp

#ifndef __DLL_CAL_TEST_IMP_HPP__
#define __DLL_CAL_TEST_IMP_HPP__
...
//YGGR_DLL_MAKE_API_TYPE_1(void, Enter_Handler, runner_shared_info_ptr_type);

#define ENTRY_NAME "reg_cal_enter"
#define LEAVE_NAME "unreg_cal_enter"

#endif //__DLL_CAL_TEST_IMP_HPP__
