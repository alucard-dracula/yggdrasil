//CltTest
#error "now, sync is not supported append after!!!!!!!!!!!!!!!!!1"
...
#include <yggr/client/tcp_sync_clt_handler.hpp>
...
typedef yggr::client::tcp_sync_clt_handler<test_pak_type, adapter_mgr_type, conn_type>  tcp_clt_handler_type;
