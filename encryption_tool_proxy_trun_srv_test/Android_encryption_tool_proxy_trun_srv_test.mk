#
#	encryption_tool_proxy_trun_srv_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := encryption_tool_proxy_trun_srv_test
...
# source files
l_src_file := \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/calculator.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/handler_reg.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/init_server_drei.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/init_server_eins.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/init_server_zwei.cpp \
	encryption_tool_proxy_trun_tcp_svr_fix_proxy_data_test/protocol_reg.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		...
		-lsha$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
		-lmd5$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
		-lblowfish$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
	...
	l_ldflags += \
		...
		-lsha$(USRDEF_APP_COMPILER_VERSION_TAG) \
		-lmd5$(USRDEF_APP_COMPILER_VERSION_TAG) \
		-lblowfish$(USRDEF_APP_COMPILER_VERSION_TAG) \
