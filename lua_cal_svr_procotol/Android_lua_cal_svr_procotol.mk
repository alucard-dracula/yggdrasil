#
#	lua_cal_svr_procotol definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua_cal_svr_procotol

l_path := $(LOCAL_PATH)

# output module name
ifeq ($(NDK_DEBUG), 1)
	l_module := lua_cal_svr_procotol
else
	l_module := lua_cal_svr_procotol
endif
