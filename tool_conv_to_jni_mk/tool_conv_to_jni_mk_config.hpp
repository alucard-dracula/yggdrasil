// tool_conv_to_jni_mk_config.hpp

#ifndef __TOOL_CONV_TO_JNI_MK_CONFIG_HPP__
#define __TOOL_CONV_TO_JNI_MK_CONFIG_HPP__
...
#endif // __TOOL_CONV_TO_JNI_MK_CONFIG_HPP__
