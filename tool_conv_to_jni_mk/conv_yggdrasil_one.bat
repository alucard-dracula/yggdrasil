...
:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir2%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir3%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir4%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir5%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir6%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml
...
:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir10%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir11_1%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml

:rem sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir11_2%<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
:rem tool_conv_to_jni_mk.exe tool_conv_to_jni_mk_cfg.xml
