...
./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

sed -i "/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir2}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir3}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

#sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir4}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
#./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml
...
#sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir8}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
#./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

#sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir9}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
#./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir10}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml

#sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>${dir11}<\/root_dir_>/g" tool_conv_to_jni_mk_cfg.xml
#./tool_conv_to_jni_mk tool_conv_to_cb_solution_cfg.xml
