...
tool_conv_to_jni_mk_cfg::tool_conv_to_jni_mk_cfg(void)
{
}
...
tool_conv_to_jni_mk_cfg::this_type& 
	tool_conv_to_jni_mk_cfg::operator=(const this_type& right)
{
	if(this == &right)
	{
		return *this;
...
void tool_conv_to_jni_mk_cfg::swap(this_type& right)
{
	if(this == &right)
	{
		return;
...
{
	YGGR_PP_SWAP_THIS_REF_DEF_IMPL(tool_conv_to_jni_mk_cfg)
} // namespace swap_support
