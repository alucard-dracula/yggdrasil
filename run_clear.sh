...
if [ -d "./tools/cyrus-sasl2/krb5-1.21.3-final/src/not-remove-lib" ]; then
	mv -f ./tools/cyrus-sasl2/krb5-1.21.3-final/src/not-remove-lib ./tools/cyrus-sasl2/krb5-1.21.3-final/src/lib
fi
...
if [ -d "./tools/cyrus-sasl2/krb5-1.21.3-final/src/lib" ]; then
	mv -f ./tools/cyrus-sasl2/krb5-1.21.3-final/src/lib ./tools/cyrus-sasl2/krb5-1.21.3-final/src/not-remove-lib
fi
...
find ./test -type l -name '*.so' -exec rm -f {} \;
find ./test -type f -name '*.dll' -exec rm -f {} \;
find ./test -type f -name '*.dylib' -exec rm -f {} \;
