// tool_conv_to_darwin_cmakelists_txt_cfg.hpp

#ifndef __TOOL_CONV_TO_DARWIN_CMAKELISTS_TXT_HPP__
#define __TOOL_CONV_TO_DARWIN_CMAKELISTS_TXT_HPP__
...
struct tool_conv_to_darwin_cmakelists_txt_cfg_sample {};

struct tool_conv_to_darwin_cmakelists_txt_cfg
{
public:
...
private:
	typedef tool_conv_to_darwin_cmakelists_txt_cfg this_type;
	BOOST_COPYABLE_AND_MOVABLE(this_type);

public:
	tool_conv_to_darwin_cmakelists_txt_cfg(void);
	tool_conv_to_darwin_cmakelists_txt_cfg(tool_conv_to_darwin_cmakelists_txt_cfg_sample);
	...
	tool_conv_to_darwin_cmakelists_txt_cfg(const this_type& right);
	~tool_conv_to_darwin_cmakelists_txt_cfg(void);
...
{
	YGGR_PP_SWAP_THIS_REF_DEF(tool_conv_to_darwin_cmakelists_txt_cfg)
} // namespace swap_support
...
#endif // __TOOL_CONV_TO_DARWIN_CMAKELISTS_TXT_HPP__
