...
#ifndef __PORXY_SVR_TEST_CALCULATOR_HPP__
#define __PORXY_SVR_TEST_CALCULATOR_HPP__
...
public:
	...
	void cal_test_pak_type(const owner_info_type& owner, const test_pak_type& cdt, Runner* prunner, const Handler& handler)
	{
		...
		if(owner.size() == 1)
		{
			...
			//proxy_mode_change_msg_type msg;
			//msg.add_chg_data(test_pak_type::data_info(), proxy_mode_def_type::E_proxy_mode_monopolize);
										...
										const Handler& handler)
	{
		...
		//chg_msg.add_chg_data(test_pak_type::data_info(), chg_state);
...
#endif // __PORXY_SVR_TEST_CALCULATOR_HPP__