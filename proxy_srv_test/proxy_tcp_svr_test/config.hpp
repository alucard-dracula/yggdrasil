...
#ifndef __PORXY_SVR_TEST_CONFIG_HPP__
#define __PORXY_SVR_TEST_CONFIG_HPP__
...
typedef yggr::ptr_single<yggr::u32, boost::shared_mutex, 0> send_count_single_type;
typedef yggr::ptr_single<yggr::u32, boost::shared_mutex, 1> now_state_single_type;
typedef yggr::ptr_single<yggr::u32, boost::shared_mutex, 2> chg_state_single_type;

#endif // __PORXY_SVR_TEST_CONFIG_HPP__