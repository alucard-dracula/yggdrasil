// isomeric_same_safe_unordered_multimap_test.cpp
...
void test_constructor(void)
{
	...
	yggr::unordered_multimap<key_type, mapped_type> map_sample;
...
void test_operator_cmp(void)
{
	...
	yggr::unordered_multimap<key_type, mapped_type> map_sample;
	yggr::unordered_multimap<key_type, mapped_type> map_sample_less;
	yggr::unordered_multimap<key_type, mapped_type> map_sample_greater;
...
void test_swap(void)
{
	...
	yggr::unordered_multimap<key_type, mapped_type> map_sample1;
	yggr::unordered_multimap<key_type, mapped_type> map_sample2;
