...
void test_constructor(void)
{
	...
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_map<base_map_type, isomeric_same_base_map_type>));
#elif (BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<base_map_type, isomeric_same_base_map_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_options_map<base_map_type, isomeric_same_base_map_type>));
