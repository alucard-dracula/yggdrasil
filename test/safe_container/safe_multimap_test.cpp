...
void test_modifiers(void)
{
	...
	//typedef map_type::base_type::iterator (map_type::base_type::* begin_end_foo_type)(void);
	//typedef map_type::base_type::const_iterator (map_type::base_type::* cbegin_end_foo_type)(void) const;
...

	{
		...
		cont.insert(typename map_type::value_type(2000, 2000), boost::bind(&check_last_element<map_type>, _1, _2,  2000));
	...
	{
		//typename map_type::base_type* pbase = 0;
...
bool push_handler(typename Container::base_type&,
					const std::pair<typename Container::iterator, bool>&, int& count)
{
	++count;
	return true;
}
...
void write_op(Container& cont, hvt_type& hvt)
{
	...
	case 4: // insert(val&&, handler)
		...
		break;
	case 5: // insert(const val&, handler)
		{
...
int main(int argc, char* argv[])
{
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_multimap<int, val_type> map_type;
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_multimap<int, val_type, boost::shared_mutex> map_type;
