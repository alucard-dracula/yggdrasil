...
#undef TEST_OPERATOR
	...
	{
		typedef yggr::safe_container::safe_options_deque<float> fdeque_type;
	...
	{
		typedef yggr::safe_container::safe_options_deque<yggr::shared_ptr<int> > ptr_deque_type;
...
{
	{
		typedef yggr::safe_container::safe_options_deque<int> deque_type;
		debug_test<deque_type>();
	}

	{
		typedef yggr::safe_container::safe_options_deque<int, boost::mutex, std::allocator<int> > deque_type;
		debug_test<deque_type>();
	}
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_options_deque<val_type> deque_type;
		test_thread_safe_of_mutex<deque_type>();
	}

	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_options_deque<val_type, boost::mutex, std::allocator<val_type> > deque_type;
		test_thread_safe_of_mutex<deque_type>();
	}
