...
void write_op(Container& cont, hvt_type& hvt)
{
	...
	typedef typename container_base_type::iterator (container_base_type::* begin_end_foo_type)(void);
	typedef typename container_base_type::const_iterator (container_base_type::* cbegin_end_foo_type)(void) const;
