...
//bool check_error(map_type& map, const map_type::value_type& val)
//{
//	return true;
//}
...
#undef TEST_OPERATOR
...

	{
		...
		typedef yggr::safe_container::safe_options_map<float, float> fmap_type;
	...
	{
		typedef yggr::safe_container::safe_options_map<int, yggr::shared_ptr<int> > ptr_vt_type;
...
{
	{
		typedef yggr::safe_container::safe_options_map<int, int> map_type;
		debug_test<map_type>();
	}
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_options_map<int, val_type> map_type;
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_options_map<int, val_type, boost::shared_mutex> map_type;
