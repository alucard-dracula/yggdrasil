//isomeric_same_safe_options_set_test_no_opt.cpp
...
void test_constructor(void)
{
	...
	typedef typename set_type::options_type options_type;
	...
	BOOST_MPL_ASSERT_NOT((boost::is_same<base_set_type, isomeric_same_base_set_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_set<base_set_type, isomeric_same_base_set_type>));
#elif (BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<base_set_type, isomeric_same_base_set_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_options_set<base_set_type, isomeric_same_base_set_type>));
...
void test_operator_cmp(void)
{
	...
	set_type cont_less(arr_less, arr_less + 10);
	isomeric_same_set_type isomeric_same_cont_less(cont_less);

	set_type cont_greater(arr_greater, arr_greater + 10);
	isomeric_same_set_type isomeric_same_cont_greater(cont_greater);
...
void test_safe_other(void)
{
	...
	// operator base
	{
		isomeric_same_base_set_type isomeric_same_base_cont;
	...
	{
		isomeric_same_base_set_type isomeric_same_base_cont;
		isomeric_same_base_cont = cont.template load<isomeric_same_base_set_type>();
		yggr_test_assert(isomeric_same_base_cont == cont);
	}

	// store
	{
		isomeric_same_base_set_type isomeric_same_base_cont = cont;
		set_type other_cont;
...
void test_operator_merge(void)
{
	...
	test_merge_ss<default_set_type, default_base_set_type>();
	test_merge_ss<default_set_type, regular_base_set_type>();
	test_merge_ss<default_set_type, default_set_type>();
	test_merge_ss<default_set_type, regular_set_type>();

	test_merge_ss<regular_set_type, default_set_type>();
	test_merge_ss<regular_set_type, regular_set_type>();
	test_merge_ss<regular_set_type, default_base_set_type>();
	test_merge_ss<regular_set_type, regular_base_set_type>();
