...
#undef TEST_OPERATOR
	...
	{
		typedef yggr::safe_container::safe_options_vector<float> fvt_type;
	...
	{
		typedef yggr::safe_container::safe_options_vector<yggr::shared_ptr<int> > ptr_vt_type;
...
typedef yggr::safe_container::safe_options_vector<int, boost::mutex, std::allocator<int>, void, yggr::options_vector> hvt_type;
...
int main(int argc, char* argv[])
{
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_options_vector<val_type> vt_type;
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_options_vector<val_type, boost::shared_mutex> vt_type;
