// boost_multi_index_hashed_index_ha_opt_test.cpp
...
typedef opt_type::nth_index<1>::type index1_type;
typedef index1_type::node_ptr_type node_ptr1_type;
//typedef opt_type::final_node_type* final_node_ptr_type;
...
{
	//opt_type::super* ps = 0;
	//opt_type::super::super* pss = 0;
	//opt_type::tag_list* ptag = 0;
	//org_type::tag_list* ptag1 = 0;

	//boost::multi_index::nth_index<org_type, 0>::type::tag_list* p0 = 0;
	//boost::multi_index::nth_index<org_type, 1>::type::tag_list* p1 = 0;
	//boost::multi_index::nth_index<org_type, 2>::type::tag_list* p2 = 0;
	//
	//typedef boost::multi_index::nth_index<org_type, 0>::type::tag_list tag_list_0_type;
	//typedef boost::multi_index::nth_index<org_type, 1>::type::tag_list tag_list_1_type;
	//typedef boost::multi_index::nth_index<org_type, 2>::type::tag_list tag_list_2_type;

	//BOOST_MPL_ASSERT((
	//	boost::is_same
	//	<
	//		yggr::safe_container::detail
	//			::boost_midx_get_tag<tag_list_0_type>::type,
	//		A::tag_1
	//	>
	//	));
	...
	//	<
	//		yggr::safe_container::detail
	//			::boost_midx_get_tag<tag_list_1_type>::type,
	//		A::tag_2
	//	>
	//	));
	...
	//	<
	//		yggr::safe_container::detail
	//			::boost_midx_get_tag<tag_list_2_type>::type,
	//		boost::mpl::na
	//	>
	//	));
