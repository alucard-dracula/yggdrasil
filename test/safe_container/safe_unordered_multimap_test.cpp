...
#   endif // __GNUC__
	...
	//mutex
	{
		...
		typedef yggr::safe_container::safe_unordered_multimap<int, val_type> map_type;
...
#   endif // __GNUC__
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_unordered_multimap<int, val_type, boost::shared_mutex> map_type;
