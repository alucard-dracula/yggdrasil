//isomeric_same_safe_map_test.cpp
...
void test_constructor(void)
{
	...
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_multimap<base_map_type, isomeric_same_base_map_type>));
#elif (BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<base_map_type, isomeric_same_base_map_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_options_multimap<base_map_type, isomeric_same_base_map_type>));
...
void test_swap(void)
{
	...
	{
		map_type multimap = map_chk;
		isomeric_same_base_map_type right_map = isomeric_same_base_map_chk;

		multimap.swap(boost::move(right_map));

		yggr_test_assert(multimap == isomeric_same_map_chk);
...
void test_operator_merge(void)
{
	...
	test_merge_mm<default_map_type, default_base_map_type>();
	test_merge_mm<default_map_type, regular_base_map_type>();
	...
	test_merge_mm<regular_map_type, default_base_map_type>();
	test_merge_mm<regular_map_type, regular_base_map_type>();
