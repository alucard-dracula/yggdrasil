//safe_unordered_set_opt_performance_test.cpp
...
int main(int argc, char* argv[])
{
	...
	{
		typedef yggr::safe_container::safe_unordered_set<std::string> set_type;
		test_safe_hash_set_insert_mthread<set_type>();
	}
