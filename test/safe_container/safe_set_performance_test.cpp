...
#endif // #if defined(__GNUC__) && (YGGR_CPP_VERSION < YGGR_CPP_VER_14)
...
void safe_range_pop(SafeCont& cont, int s, int e)
{
	...
	typedef typename begin_end_foo_getter<unsafe_cont_type>::begin_end_foo_type foo_type;
...
#	if THREAD_TEST_USING_MANUAL()
		...
		{
			typedef yggr::safe_container::safe_set<std::string> set_type;
