...
void test_operator_cmp(void)
{
	...
	// ==
	yggr_test_assert(cont == cont.template load<base_base_list_type>());
	yggr_test_assert(cont == cont.template load<isomeric_same_base_base_list_type>());
	yggr_test_assert(cont.template load<base_base_list_type>() == cont);
	yggr_test_assert(cont.template load<isomeric_same_base_base_list_type>() == cont);

	yggr_test_assert(!(cont == cont_less.template load<base_base_list_type>()));
	yggr_test_assert(!(cont == cont_less.template load<isomeric_same_base_base_list_type>()));
	yggr_test_assert(!(cont_less.template load<base_base_list_type>() == cont));
	yggr_test_assert(!(cont_less.template load<isomeric_same_base_base_list_type>() == cont));
	...
	yggr_test_assert(cont != cont_less.template load<base_base_list_type>());
	yggr_test_assert(cont != cont_less.template load<isomeric_same_base_base_list_type>());
	yggr_test_assert(cont.template load<base_base_list_type>() != cont_less);
	yggr_test_assert(cont.template load<isomeric_same_base_base_list_type>() != cont_less);
	...
	yggr_test_assert(cont < cont_greater.template load<base_base_list_type>());
	yggr_test_assert(cont < cont_greater.template load<isomeric_same_base_base_list_type>());
	yggr_test_assert(cont.template load<base_base_list_type>() < cont_greater);
	yggr_test_assert(cont.template load<isomeric_same_base_base_list_type>() < cont_greater);
...
void test_swap(void)
{
...
#if !(BOOST_VERSION < 107000) && !defined(YGGR_NOT_USE_SAFE_CONTAINER_OPTIMIZATION)
	{
		...
		base_base_list_type right_lst = isomeric_same_lst_chk.template load<base_base_list_type>();
	...
	{
		list_type lst = lst_chk;
		isomeric_same_base_base_list_type right_lst = isomeric_same_lst_chk.template load<isomeric_same_base_base_list_type>();
...
void test_stl_swap(void)
{
...
#if !(BOOST_VERSION < 107000) && !defined(YGGR_NOT_USE_SAFE_CONTAINER_OPTIMIZATION)
	{
		...
		base_base_list_type lst2 = isomeric_same_lst_chk.template load<base_base_list_type>();
	...
	{
		list_type lst1 = base_lst_chk;
		isomeric_same_base_base_list_type lst2 = isomeric_same_lst_chk.template load<isomeric_same_base_base_list_type>();
