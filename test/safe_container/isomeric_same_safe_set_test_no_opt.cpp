//isomeric_same_safe_set_test_no_opt.cpp
...
void test_constructor(void)
{
	...
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_set<base_set_type, isomeric_same_base_set_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<base_set_type, isomeric_same_base_set_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_set<base_set_type, isomeric_same_base_set_type>));
