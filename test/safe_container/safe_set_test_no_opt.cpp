...
struct is_std_set< std::set<T, C, A> >
    : boost::mpl::true_
{
};

template<typename Cont, bool is_std = is_std_set<Cont>::value>
struct begin_end_foo_getter;


template<typename Cont>
struct begin_end_foo_getter<Cont, false>
{
    typedef Cont base_set_type;
    typedef typename base_set_type::iterator set_iter_type;
	typedef typename base_set_type::const_iterator set_citer_type;

    typedef set_iter_type (base_set_type::* begin_end_foo_type)(void);
	typedef set_citer_type (base_set_type::* cbegin_end_foo_type)(void) const;
};

#if defined(__GNUC__)

template<typename Cont>
struct begin_end_foo_getter<Cont, true>
{
    typedef Cont base_set_type;
    typedef typename base_set_type::iterator set_iter_type;

    typedef set_iter_type (base_set_type::* begin_end_foo_type)(void) const;
...
template<typename Cont>
struct begin_end_foo_getter<Cont, true>
    : public begin_end_foo_getter<Cont, false>
{
};
...
void test_modifiers(void)
{
	typedef Cont set_type;
	typedef typename set_type::base_type base_set_type;
	typedef typename set_type::iterator set_iter_type;
	typedef typename set_type::const_iterator set_citer_type;
	typedef typename set_type::value_type val_type;

	//typedef set_iter_type (base_set_type::* begin_end_foo_type)(void);
	//typedef set_citer_type (base_set_type::* cbegin_end_foo_type)(void) const;

	typedef typename begin_end_foo_getter<base_set_type>::begin_end_foo_type begin_end_foo_type;
    typedef typename begin_end_foo_getter<base_set_type>::cbegin_end_foo_type cbegin_end_foo_type;
...
//	typedef const_iterator_type (container_base_type::* cbegin_end_foo_type)(void) const;
	...
	typedef typename begin_end_foo_getter<container_base_type>::begin_end_foo_type begin_end_foo_type;
    typedef typename begin_end_foo_getter<container_base_type>::cbegin_end_foo_type cbegin_end_foo_type;
...
{
	{
		typedef yggr::safe_container::safe_set<int> set_type;
		debug_test<set_type>();
	}
...
// !!!std::set not support boost::container::new_allocator!!!
...
//#endif // !(BOOST_VERSION < 105800)
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_set<val_type> set_type;
...
//#endif // !(BOOST_VERSION < 105800)
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_set<val_type, boost::shared_mutex> set_type;
