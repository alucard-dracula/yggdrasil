// boost_multi_index_ordered_index_a_opt_test.cpp
...
void test(void)
{
...

	{
...

		{
			...
			yggr_test_assert(org_cont.find(6) != org_cont.end());
			yggr_test_assert(((*org_cont.find(6)).a == 6));

			yggr_test_assert(org_cont.find(7) != org_cont.end());
			yggr_test_assert(((*org_cont.find(7)).a == 7));
		}

		{
			...
			yggr_test_assert(org_cont.find(8) != org_cont.end());
			yggr_test_assert((*org_cont.find(8)).a == 8);

			yggr_test_assert(org_cont.find(9) != org_cont.end());
			yggr_test_assert((*org_cont.find(9)).a == 9);
		}

		{
			...
			yggr_test_assert(org_cont.find(4) == org_cont.end());
		}
...

		{
			...
			yggr_test_assert(org_cont.find(200) != org_cont.end());
		}

		{
...

			{
				...
				yggr_test_assert(org_cont.find(201) != org_cont.end());

				yggr_test_assert((*org_cont.find(201)).a == 201);
				yggr_test_assert((*org_cont.find(201)).b == 301);
				yggr_test_assert((*org_cont.find(201)).c == 401);
			}
...

		{
...

			{
				...
				yggr_test_assert(org_cont.find(202) != org_cont.end());

				yggr_test_assert((*org_cont.find(202)).a == 202);
				yggr_test_assert((*org_cont.find(202)).b == 302);
				yggr_test_assert((*org_cont.find(202)).c == 402);
			}
...

		{
...

			{
				...
				yggr_test_assert(org_cont.find(203) != org_cont.end());

				yggr_test_assert((*org_cont.find(203)).a == 203);
				yggr_test_assert((*org_cont.find(203)).b == 105);
				yggr_test_assert((*org_cont.find(203)).c == 105);
			}
...

		{
...

			{
				...
				yggr_test_assert(org_cont.find(205) != org_cont.end());

				yggr_test_assert((*org_cont.find(205)).a == 205);
				yggr_test_assert((*org_cont.find(205)).b == 107);
				yggr_test_assert((*org_cont.find(205)).c == 107);
			}
		...
		yggr_test_assert(org_cont.find(1) == org_cont.end());
		yggr_test_assert( 0 == org_cont.erase(1));

		{
			destroy_holder_type holder;
			opt_cont.erase(holder, 205);
			yggr_test_assert(org_cont.find(205) == org_cont.end());
		}
