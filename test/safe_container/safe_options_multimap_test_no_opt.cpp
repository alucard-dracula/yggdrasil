//safe_options_multimap_test_no_opt.cpp
...
void test_modifiers(void)
{
	...
	//typedef base_map_type::iterator (base_map_type::* begin_end_foo_type)(void);
	//typedef base_map_type::const_iterator (base_map_type::* cbegin_end_foo_type)(void) const;
...

	{
		...
		yggr_test_assert(ins_cont.emplace_hint(
						boost::bind(static_cast<begin_end_foo_type>(&base_map_type::begin), _1), yggr::non_handler, std::make_pair(10, 10)));
		yggr_test_assert(ins_cont.size() == 1);
		yggr_test_assert(ins_cont.find(10));
	}
...
{
	{
		typedef yggr::safe_container::safe_options_multimap<int, int> map_type;
		debug_test<map_type>();
	}
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_options_multimap<int, val_type> map_type;
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_options_multimap<int, val_type, boost::shared_mutex> map_type;
