// boost_container_set_opt_impl_test.cpp
...
void test1(void)
{
	typedef boost::container::set<int> org_type;
	typedef yggr::safe_container::detail::cast_to_set_opt<org_type>::type opt_type;
