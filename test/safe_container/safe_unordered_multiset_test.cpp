//safe_unordered_multiset_test.cpp
...
void test_constructor(void)
{
	...
	yggr_test_assert(cont8_2.size() == 10);
...
#   endif // __GNUC__
	...
	// mutex
	{
		...
		typedef yggr::safe_container::safe_unordered_multiset<val_type> set_type;
...
#   endif // __GNUC__
	...
	{
		typedef yggr::shared_ptr<int> val_type;
		typedef yggr::safe_container::safe_unordered_multiset<val_type, boost::shared_mutex> set_type;
