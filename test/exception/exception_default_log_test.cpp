//exception_default_log_test.cpp
...
void test(void)
{
	typedef yggr::log::default_log_accesser log_acc_type;
	typedef log_acc_type::op_caller_type caller_type;

	typedef yggr::log::default_log_access_ptr log_acc_ptr_type;
	...
	log_acc_ptr_type pacc(new log_acc_type("../test_out/exception/exception_default_log_test"));
	yggr_test_assert(pacc);

	caller_type caller("../test_out/exception/exception_default_log_test");
