...
void is_parallel_line_2d_test(void)
{
	...
	yggr_test_assert(line1.is_parallel_line(line2) == 1);
	yggr_test_assert(line1.is_parallel_line(line3) == 0);
...
void is_parallel_line_3d_test(void)
{
	...
	yggr_test_assert(line1.is_parallel_line(line2) == 1);
	yggr_test_assert(line1.is_parallel_line(line3) == 0);
	yggr_test_assert(line1.is_parallel_line(line4) == 0);
...
void is_in_it_of_point_2d_test(void)
{
	...
	yggr_test_assert(line1.is_in_it(vec1) == 1);
	yggr_test_assert(line1.is_in_it(vec2) == 0);
	yggr_test_assert(line_type::is_line(line1.src_pos, line1.dst_pos, vec1) == 1);
	yggr_test_assert(line_type::is_line(line1.src_pos, line1.dst_pos, vec2) == 0);
...
void is_in_it_of_point_3d_test(void)
{
	...
	yggr_test_assert(line1.is_in_it(vec1) == 1);
	yggr_test_assert(line1.is_in_it(vec2) == 0);
	yggr_test_assert(line1.is_in_it(vec3) == 0);
	yggr_test_assert(line_type::is_line(line1.src_pos, line1.dst_pos, vec1) == 1);
	yggr_test_assert(line_type::is_line(line1.src_pos, line1.dst_pos, vec2) == 0);
...
void is_perpendicular_line_2d_test(void)
{
	...
	yggr_test_assert(line1.is_perpendicular_line(line2) == 1);
	yggr_test_assert(line1.is_perpendicular_line(line3) == 0);
...
void is_perpendicular_line_3d_test(void)
{
	...
	yggr_test_assert(line1.is_perpendicular_line(line2) == 1);
	yggr_test_assert(line1.is_perpendicular_line(line3) == 0);
	yggr_test_assert(line1.is_perpendicular_line(line4) == 1);
...
void equal_to_line_2d_test(void)
{
	...
	yggr_test_assert(line1 != line2);
	yggr_test_assert(line1 == line3);
...
void is_pt_at_same_area_line_2d_test(void)
{
	...
	yggr_test_assert(line1.is_point_at_same_area(pos1, pos2) == 1);
	yggr_test_assert(line1.is_point_at_same_area(pos3, pos4) == 1);
	yggr_test_assert(line1.is_point_at_same_area(pos1, pos3) == 0);
	yggr_test_assert(line1.is_point_at_same_area(pos2, pos4) == 0);
...
void is_pt_at_same_area_line_3d_test(void)
{
	...
	yggr_test_assert(line1.is_point_at_same_area(pos1, pos2) == 0);
	yggr_test_assert(line1.is_point_at_same_area(pos3, pos4) == 0);
	yggr_test_assert(line1.is_point_at_same_area(pos1, pos3) == 1);
	yggr_test_assert(line1.is_point_at_same_area(pos2, pos4) == 0);
#endif // 1
...
void cross_point_line_3d_test(void)
{
	...
	vec_type v1(1, 1, 1, 0), v2(-2, -2, -2, 0);
	std::abs(v2);
...
void test_line_2d_mul_matrix(void)
{
	...
	yggr_test_assert(rst_line == line2);
}
