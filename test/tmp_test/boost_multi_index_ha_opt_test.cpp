...
void test(void)
{
...

	{
...

		{
			...
			auto tmp = hash_params[0];

			std::cout << hash_params[0].get<A::tag_1>() << std::endl;
			std::cout << hash_params[0].get<A::tag_2>() << std::endl;

			std::cout << hash_params[1].get<A::tag_1>() << std::endl;
			std::cout << hash_params[1].get<A::tag_2>() << std::endl;
