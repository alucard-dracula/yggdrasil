...
void test_positive_negative_bitnot_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch(L'你');

		yggr_test_assert(+utf8_ch == L'你');
		yggr_test_assert(-utf8_ch == yggr::charset::utf8_foo::E_char_max_range - L'你');
		yggr_test_assert(~utf8_ch == yggr::charset::utf8_foo::E_char_max_range - L'你' - 1);
		yggr_test_assert(-(-utf8_ch) == utf8_ch);
	}
...
void test_positive_negative_bitnot_of_utf8_char_reference(void)
{
...

	{
		...
		yggr_test_assert(-static_cast<ref_type>(utf8_ch_minus) == utf8_ch);
	}
...

	{
		yggr::utf8_char utf8_ch(L'你');
		ref_type utf8_ch_ref = utf8_ch;
		yggr::utf8_char utf8_ch_minus = -utf8_ch_ref;

		yggr_test_assert(+utf8_ch_ref == L'你');
		yggr_test_assert(-utf8_ch_ref == yggr::charset::utf8_foo::E_char_max_range - L'你');
		yggr_test_assert(~utf8_ch_ref == yggr::charset::utf8_foo::E_char_max_range - L'你' - 1);
...
void test_mul_set_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch(2);
		yggr_test_assert((utf8_ch *= (L'你' / 2)) == L'你');
		yggr_test_assert((utf8_ch *= 0) == 0);
		yggr_test_assert((utf8_ch *= yggr::utf8_char(49)) == 0);
	}

	{
		...
		yggr::utf8_char utf8_ch(2);
		yggr_test_assert((utf8_ch *= yggr::utf8_char((L'你' / 2))) == L'你');
	}

	{
		...
		yggr_test_assert(t % 2 == 0);
		yggr::utf8_char utf8_ch(2);
		yggr_test_assert((utf8_ch *= yggr::utf8_char((L'你' / 2)).view()) == L'你');
	}

	{
		...
		yggr_test_assert(t % 2 == 0);
		yggr::utf8_char utf8_ch(2);
		yggr::utf8_char utf8_ch2(L'你' / 2);
		yggr_test_assert((utf8_ch *= static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2)) == L'你');
	}

	{
		...
		yggr_test_assert(t % 2 == 0);
		yggr::utf8_char utf8_ch(2);
		yggr_test_assert((utf8_ch *= static_cast<yggr::utf8_char::char_const_reference_type>(yggr::utf8_char((L'你' / 2)))) == L'你');
	}
#endif // YGGR_NO_CWCHAR
...
void test_mul_set_of_utf8_char_reference(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((utf8_ch_ref *= (L'你' / 2)) == L'你');
		yggr_test_assert((utf8_ch_ref *= 0) == 0);
		yggr_test_assert((utf8_ch_ref *= yggr::utf8_char(49)) == 0);
	}

	{
		...
		yggr_test_assert((utf8_ch_ref *= yggr::utf8_char((L'你' / 2))) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref *= yggr::utf8_char((L'你' / 2)).view()) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref *= static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2)) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref *= static_cast<yggr::utf8_char::char_const_reference_type>(yggr::utf8_char((L'你' / 2)))) == L'你');
	}
#endif // YGGR_NO_CWCHAR
...
void test_div_set_of_utf8_char(void)
{
...

	{
		yggr::utf8_char utf8_ch('a' * 2);
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert((utf8_ch /= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == 'a');
	}
	...
	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch /= 2) == L'你');
	}

	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch /= yggr::utf8_char(2)) == L'你');
	}

	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch /= yggr::utf8_char(2).view()) == L'你');
	}
...
void test_div_set_of_utf8_char_reference(void)
{
...

	{
		...
		yggr_test_assert((utf8_ch_ref /= 2) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref /= yggr::utf8_char(2)) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref /= yggr::utf8_char(2).view()) == L'你');
	}
...

	{
		...
		yggr_test_assert((utf8_ch_ref /= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == L'a');
	}
#endif // YGGR_NO_CWCHAR
...
void test_mod_set_of_utf8_char(void)
{
...

	{
		yggr::utf8_char utf8_ch('a');
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert((utf8_ch %= static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2)) == 1);
	}
	...
	{
		yggr::utf8_char utf8_ch(L'你');
		yggr_test_assert((utf8_ch %= L'你' + 1) == L'你');
...

	{
		yggr::utf8_char utf8_ch(L'你');
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert((utf8_ch %= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == 0);
	}
#endif // YGGR_NO_CWCHAR
...
void test_mod_set_of_utf8_char_reference(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((utf8_ch_ref %= L'你' + 1) == L'你');
...

	{
		...
		yggr_test_assert((utf8_ch_ref %= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == 0);
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_left_shift_set_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch(L'你');
		yggr_test_assert((utf8_ch <<= 1) == L'你' * 2);
	}

	{
		yggr::utf8_char utf8_ch(L'你');
		yggr_test_assert((utf8_ch <<= yggr::utf8_char(1)) == L'你' * 2);
	}

	{
		yggr::utf8_char utf8_ch(L'你');
		yggr_test_assert((utf8_ch <<= yggr::utf8_char(1).view()) == L'你' * 2);
	}

	{
		yggr::utf8_char utf8_ch(L'你');
		yggr::utf8_char utf8_ch2(1);
		yggr_test_assert((utf8_ch <<= static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2)) == L'你' * 2);
	}

	{
		yggr::utf8_char utf8_ch(L'你');
		yggr_test_assert((utf8_ch <<= static_cast<yggr::utf8_char::char_const_reference_type>(yggr::utf8_char(1))) == L'你' * 2);
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_left_shift_set_of_utf8_char_reference(void)
{
...

	{
		...
		yggr_test_assert((utf8_ch_ref <<= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == 'b');
	}
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((utf8_ch_ref <<= 1) == L'你' * 2);
	}

	{
		...
		yggr_test_assert((utf8_ch_ref <<= yggr::utf8_char(1)) == L'你' * 2);
	}

	{
		...
		yggr_test_assert((utf8_ch_ref <<= yggr::utf8_char(1).view()) == L'你' * 2);
	}

	{
		...
		yggr_test_assert((utf8_ch_ref <<= static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2)) == L'你' * 2);
	}

	{
		...
		yggr_test_assert((utf8_ch_ref <<= static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch2)) == L'你' * 2);
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_right_shift_set_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch >>= 1) == L'你');
	}

	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch >>= yggr::utf8_char(1)) == L'你');
	}

	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch >>= yggr::utf8_char(1).view()) == L'你');
	}
	...
	{
		yggr::utf8_char utf8_ch(L'你' * 2);
		yggr_test_assert((utf8_ch >>= static_cast<yggr::utf8_char::char_const_reference_type>(yggr::utf8_char(1))) == L'你');
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_right_shift_set_of_utf8_char_reference(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((utf8_ch_ref >>= 1) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref >>= yggr::utf8_char(1)) == L'你');
	}

	{
		...
		yggr_test_assert((utf8_ch_ref >>= yggr::utf8_char(1).view()) == L'你');
	}
...

	{
		...
		yggr_test_assert((utf8_ch_ref >>= static_cast<yggr::utf8_char::char_const_reference_type>(yggr::utf8_char(1))) == L'你');
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_and_set_of_utf8_char(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((ch &= utf8_ch) == utf8_ch);
		yggr_test_assert((ch &= yggr::utf8_char(L'好')) == (L'你' & L'好'));
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_and_set_of_utf8_char_reference(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		wchar_t ch = L'你';
		yggr::utf8_char utf8_ch(L'你');
		yggr::utf8_char utf8_ch2(L'好');
		ref_type utf8_ch_ref = utf8_ch;

		yggr_test_assert((ch &= utf8_ch_ref) == utf8_ch);
		yggr_test_assert((ch &= ref_type(utf8_ch2)) == (L'你' & L'好'));
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_xor_set_of_utf8_char(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((ch ^= utf8_ch) == 0);
		yggr_test_assert((ch ^= yggr::utf8_char(L'好')) == (0 ^ L'好'));
	}
#endif // YGGR_NO_CWCHAR
...
void test_bitwise_xor_set_of_utf8_char_reference(void)
{
...
#ifndef YGGR_NO_CWCHAR
	{
		...
		yggr_test_assert((ch ^= utf8_ch_ref) == 0);
		yggr_test_assert((ch ^= ref_type(utf8_ch2)) == (0 ^ L'好'));
	}
#endif // YGGR_NO_CWCHAR
...
void test_plus_of_utf8_char(void)
{
	...
	{
		yggr_test_assert(yggr::utf8_char(L'你') + yggr::charset::utf8_foo::E_char_max_range == L'你');
	}
	...
	// n + utf8_char
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(yggr::charset::utf8_foo::E_char_max_range + utf8_ch
				== yggr::charset::utf8_foo::E_char_max_range + L'你');
	}

	{
		yggr_test_assert(yggr::charset::utf8_foo::E_char_max_range + yggr::utf8_char(L'你')
				== yggr::charset::utf8_foo::E_char_max_range + L'你');
	}
	...
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(yggr::utf8_char(2) + utf8_ch == L'你' + 2);
		yggr_test_assert(yggr::utf8_char(2) + yggr::utf8_char(L'你') == static_cast<wchar_t>(L'你' + 2));
	}

	// utf8_char + utf8_char_view
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(yggr::utf8_char(2).view() + utf8_ch == L'你' + 2);
		yggr_test_assert(yggr::utf8_char(2) + yggr::utf8_char(L'你').view() == static_cast<wchar_t>(L'你' + 2));
	}

	// utf8_char + utf8_char_reference
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) + yggr::utf8_char(2) == L'你' + 2);
		yggr_test_assert(yggr::utf8_char(2) + yggr::utf8_char::char_reference_type(utf8_ch) == L'你' + 2);
	}

	// utf8_char + utf8_char_const_reference
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch) + yggr::utf8_char(2) == L'你' + 2);
		yggr_test_assert(yggr::utf8_char(2) + yggr::utf8_char::char_const_reference_type(utf8_ch) == L'你' + 2);
	}
...
void test_plus_of_utf8_char_reference(void)
{
...

	{
		...
		yggr_test_assert(ref_type(utf8_ch_ref) + yggr::charset::utf8_foo::E_char_max_range == L'你');
	}
	...
	// utf8_char_ref + utf8_char_ref
	{
		yggr::utf8_char utf8_ch_l = L'你';
		yggr::utf8_char utf8_ch_r = 2;

		ref_type utf8_ch_ref_l = utf8_ch_l;
		ref_type utf8_ch_ref_r = utf8_ch_r;

		yggr_test_assert(utf8_ch_ref_l + utf8_ch_ref_r == L'你' + 2);
		yggr_test_assert(ref_type(utf8_ch_ref_r) + utf8_ch_ref_l == L'你' + 2);
		yggr_test_assert(utf8_ch_ref_l + ref_type(utf8_ch_ref_r) == L'你' + 2);
		yggr_test_assert(ref_type(utf8_ch_ref_r) + ref_type(utf8_ch_ref_l) == (L'你' + 2));
	}
	...
	// utf8_char_ref + utf8_char_view
	{
		...
		yggr_test_assert(yggr::utf8_char(2).view() + utf8_ch_ref_l == L'你' + 2);
		yggr_test_assert(ref_type(utf8_ch_ref_r) + yggr::utf8_char(L'你').view() == (L'你' + 2));
	}
	...
	// utf8_char_ref + utf8_char_const_reference
	{
		...
		yggr_test_assert(utf8_ch_ref_l.const_cast_() + utf8_ch_ref_r == L'你' + 2);
		yggr_test_assert(utf8_ch_ref_l + utf8_ch_ref_r.const_cast_() == L'你' + 2);
	}
...
void test_minus_of_utf8_char(void)
{
	...
	// utf8_char - utf8_char_reference
	{
		yggr::utf8_char utf8_ch = 'e';
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) - utf8_ch2 == 'c');
	...
	// utf8_char - n
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(utf8_ch - yggr::charset::utf8_foo::E_char_max_range == L'你');
		yggr_test_assert(utf8_ch - yggr::charset::utf8_foo::E_char_max_range * 2 == L'你');
		yggr_test_assert(utf8_ch - 2 == L'你' - 2);
		yggr_test_assert(utf8_ch - 2.9 == L'你' - 2.1);
		yggr_test_assert(utf8_ch - 2.9 == L'你' - 2.9);
		yggr_test_assert(utf8_ch - 2.9 == L'你' - 3);
	}

	{
		yggr_test_assert(yggr::utf8_char(L'你') - yggr::charset::utf8_foo::E_char_max_range == L'你');
		yggr_test_assert(yggr::utf8_char(L'你') - 2 == L'你' - 2);
	}
	...
	// n - utf8_char
	{
		...
		yggr_test_assert(2 - utf8_ch == 2 - L'你');
		yggr_test_assert(2.5 - utf8_ch == 2.5 - L'你');
	}
	...
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(utf8_ch - yggr::utf8_char(2)  == L'你' - 2);
		yggr_test_assert(yggr::utf8_char(L'你') - yggr::utf8_char(2) == L'你' - 2);
	}

	// utf8_char - utf8_char_view
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(utf8_ch - yggr::utf8_char(2).view() == L'你' - 2);
		yggr_test_assert(yggr::utf8_char(L'你').view() - yggr::utf8_char(2) == L'你' - 2);
	}
	...
	// utf8_char - utf8_char_reference
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) - utf8_ch2 == L'你' - 2);
		yggr_test_assert(utf8_ch - static_cast<yggr::utf8_char::char_reference_type>(utf8_ch2) == L'你' - 2);
	}
	...
	// utf8_char - utf8_char_const_reference
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch) - yggr::utf8_char(2) == L'你' - 2);
		yggr_test_assert(utf8_ch - yggr::utf8_char::char_const_reference_type(yggr::utf8_char(2)) == L'你' - 2);
	}
...
void test_minus_of_utf8_char_reference(void)
{
	...
	// utf8_char_ref - n
	{
		...
		yggr_test_assert(utf8_ch_ref - yggr::charset::utf8_foo::E_char_max_range == L'你');
		yggr_test_assert(utf8_ch_ref - yggr::charset::utf8_foo::E_char_max_range * 2 == L'你');
		yggr_test_assert(utf8_ch_ref - 2 == L'你' - 2);
		yggr_test_assert(utf8_ch_ref - 2.9 == L'你' - 2.1);
		yggr_test_assert(utf8_ch_ref - 2.9 == L'你' - 2.9);
		yggr_test_assert(utf8_ch_ref - 2.9 == L'你' - 3);
	}

	{
		...
		yggr_test_assert(ref_type(utf8_ch_ref) - yggr::charset::utf8_foo::E_char_max_range == L'你');
		yggr_test_assert(ref_type(utf8_ch_ref) - 2 == L'你' - 2);
	}
	...
	// n - utf8_char_ref
	{
		...
		yggr_test_assert(2 - utf8_ch_ref == 2 - L'你');
		yggr_test_assert(2.5 - utf8_ch_ref == 2.5 - L'你');
	}
	...
	// utf8_char_ref - utf8_char_ref
	{
		...
		yggr_test_assert(utf8_ch_ref_l - utf8_ch_ref_r == L'你' - 2);
		yggr_test_assert(ref_type(utf8_ch_ref_l) - ref_type(utf8_ch_ref_r) == L'你' - 2);
		yggr_test_assert(ref_type(utf8_ch_ref_l) - utf8_ch_ref_r == L'你' - 2);
		yggr_test_assert(utf8_ch_ref_l - ref_type(utf8_ch_ref_r) == L'你' - 2);
	}
	...
	// utf8_char_ref - utf8_char_view
	{
		...
		yggr_test_assert(utf8_ch_ref_l - yggr::utf8_char(2).view() == L'你' - 2);
		yggr_test_assert(yggr::utf8_char(L'你').view() - utf8_ch_ref_r == L'你' - 2);
	}
...
#	pragma warning (disable : 4307)
	...
	// utf8_char * n
	{
		...
		yggr_test_assert((utf8_ch * yggr::charset::utf8_foo::E_char_max_range).is_validate());
		yggr_test_assert(utf8_ch * 2 == L'你');
		yggr_test_assert(utf8_ch * 2.9 == (L'你' / 2) * 2.9);
	...
	{
		yggr_test_assert((yggr::utf8_char( L'你' / 2) * yggr::charset::utf8_foo::E_char_max_range).is_validate());
		yggr_test_assert(yggr::utf8_char( L'你' / 2) * 2 == L'你');
	}
	...
	// n * utf8_char
	{
		yggr::utf8_char utf8_ch = (L'你' / 2);
		yggr_test_assert(
                static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * utf8_ch
                    == static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * (L'你' / 2));

		yggr_test_assert(2 * utf8_ch == L'你');
		yggr_test_assert(2.5 * utf8_ch == 2.5 * (L'你' / 2));
	}

	{
		yggr_test_assert(
            static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * yggr::utf8_char(L'你')
            == static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * L'你');
	}

	// utf8_char * utf8_char
	{
		yggr::utf8_char utf8_ch = (L'你' / 2);
		yggr_test_assert(yggr::utf8_char(2) * utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(2) * yggr::utf8_char((L'你' / 2)) == L'你');
	}

	// utf8_char * utf8_char_view
	{
		yggr::utf8_char utf8_ch = (L'你' / 2);
		yggr_test_assert(yggr::utf8_char(2).view() * utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(2) * yggr::utf8_char((L'你' / 2)).view() == L'你');
	}

	// utf8_char * utf8_char_reference
	{
		yggr::utf8_char utf8_ch = (L'你' / 2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) * yggr::utf8_char(2) == L'你');
		yggr_test_assert(yggr::utf8_char(2) * yggr::utf8_char::char_reference_type(utf8_ch) == L'你');
	}

	// utf8_char * utf8_char_const_reference
	{
		yggr::utf8_char utf8_ch = (L'你' / 2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch) * yggr::utf8_char(2) == L'你');
		yggr_test_assert(yggr::utf8_char(2) * yggr::utf8_char::char_const_reference_type(utf8_ch) == L'你');
	}
...
#	pragma warning (disable : 4307)
	...
	// utf8_char_ref * n
	{
		...
		yggr_test_assert((utf8_ch_ref * yggr::charset::utf8_foo::E_char_max_range).is_validate());
		yggr_test_assert(utf8_ch_ref * 2 == L'你');
		yggr_test_assert(utf8_ch_ref * 2.9 == (L'你' / 2) * 2.9);
...

	{
		...
		yggr_test_assert((utf8_ch_ref * yggr::charset::utf8_foo::E_char_max_range).is_validate());
		yggr_test_assert(ref_type(utf8_ch_ref) * 2 == L'你');
	}
	...
	// n * utf8_char_ref
	{
		...
		yggr_test_assert(
            static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * utf8_ch_ref
            == static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * (L'你' / 2));

		yggr_test_assert(2 * utf8_ch_ref == L'你');
		yggr_test_assert(2.5 * utf8_ch_ref == 2.5 * (L'你' / 2));
	}

	{
		...
		yggr_test_assert(
            static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * ref_type(utf8_ch_ref)
            == static_cast<yggr::s64>(yggr::charset::utf8_foo::E_char_max_range) * L'你');
	}

	// utf8_char_ref * utf8_char_ref
	{
		yggr::utf8_char utf8_ch_l = (L'你' / 2);
		yggr::utf8_char utf8_ch_r = 2;
		ref_type utf8_ch_ref_l = utf8_ch_l;
		ref_type utf8_ch_ref_r = utf8_ch_r;

		yggr_test_assert(ref_type(utf8_ch_ref_l) * ref_type(utf8_ch_ref_r) == L'你');
		yggr_test_assert(ref_type(utf8_ch_ref_l) * utf8_ch_ref_r == L'你');
		yggr_test_assert(utf8_ch_ref_l * ref_type(utf8_ch_ref_r) == L'你');
		yggr_test_assert(utf8_ch_ref_l * utf8_ch_ref_r == L'你');
	}
	...
	// utf8_char_ref * utf8_char_view
	{
		...
		yggr_test_assert(yggr::utf8_char(2).view() * utf8_ch_ref_l == L'你');
		yggr_test_assert(utf8_ch_ref_r * yggr::utf8_char((L'你' / 2)).view() == L'你');
	}
	...
	// utf8_char_ref * utf8_char_const_reference
	{
		...
		yggr_test_assert(utf8_ch_ref_l.const_cast_() * utf8_ch_ref_r == L'你');
		yggr_test_assert(utf8_ch_ref_r * utf8_ch_ref_l.const_cast_() == L'你');
	}
...
#	pragma warning (disable : 4804)
	...
	// utf8_char / utf8_char_reference
	{
		yggr::utf8_char utf8_ch = 'a' * 2;
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) / utf8_ch2 == 'a');
		yggr_test_assert(utf8_ch / yggr::utf8_char::char_reference_type(utf8_ch2) == 'a');
	}
	...
	{
		yggr_test_assert((yggr::utf8_char(L'你' * 2) / yggr::charset::utf8_foo::E_char_max_range).is_validate());
		yggr_test_assert(0 == (yggr::utf8_char(L'你' * 2) / yggr::charset::utf8_foo::E_char_max_range));
		yggr_test_assert(yggr::utf8_char(L'你' * 2) / 2 == L'你');
	}
	...
	// n / utf8_char
	{
		...
		yggr_test_assert(L'你' * 2 / utf8_ch == L'你');
		yggr_test_assert(L'你' * 2.5 / utf8_ch == L'你' * 2.5 / 2);
	}
	...
	{
		yggr::utf8_char utf8_ch = 2;
		yggr_test_assert(yggr::utf8_char(L'你' * 2) / utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(L'你' * 2) / yggr::utf8_char(2) == L'你');
	}

	// utf8_char / utf8_char_view
	{
		yggr::utf8_char utf8_ch = 2;
		yggr_test_assert(yggr::utf8_char(L'你' * 2).view() / utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(L'你' * 2) / yggr::utf8_char(2).view() == L'你');
	}
	...
	// utf8_char / utf8_char_reference
	{
		yggr::utf8_char utf8_ch = L'你' * 2;
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) / utf8_ch2 == L'你');
		yggr_test_assert(utf8_ch / yggr::utf8_char::char_reference_type(utf8_ch2) == L'你');
	}
	...
	// utf8_char / utf8_char_const_reference
	{
		yggr::utf8_char utf8_ch = L'你' * 2;
		yggr::utf8_char utf8_ch2(2);
		yggr_test_assert(static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch) / utf8_ch2 == L'你');
		yggr_test_assert(utf8_ch / yggr::utf8_char::char_const_reference_type(utf8_ch2) == L'你');
	}
...
#	pragma warning (disable : 4804)
	...
	// n / utf8_char_ref
	{
		...
		yggr_test_assert(L'你' * 2 / utf8_ch_ref == L'你');
		yggr_test_assert(L'你' * 2.5 / utf8_ch_ref == L'你' * 2.5 / 2);
	}
	...
	// utf8_char_ref / utf8_char_view
	{
		...
		yggr_test_assert(yggr::utf8_char(L'你' * 2).view() / utf8_ch_ref_r == L'你');
		yggr_test_assert(utf8_ch_ref_l / yggr::utf8_char(2).view() == L'你');
	}
	...
	// utf8_char_ref / utf8_char_const_reference
	{
		...
		yggr_test_assert(utf8_ch_ref_l.const_cast_() / utf8_ch_ref_r == L'你');
		yggr_test_assert(utf8_ch_ref_l / utf8_ch_ref_r.const_cast_() == L'你');
	}
...
void test_mod_of_utf8_char(void)
{
	...
	// utf8_char + utf8_char
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(yggr::utf8_char(2) % utf8_ch == 2);
		yggr_test_assert(yggr::utf8_char(2) % yggr::utf8_char(L'你') == 2);
	}
	...
	// utf8_char + utf8_char_view
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert(yggr::utf8_char(2).view() % utf8_ch == 2);
		yggr_test_assert(yggr::utf8_char(2) % yggr::utf8_char(L'你').view() == 2);
	}
...
void test_mod_of_utf8_char_reference(void)
{
	...
	// utf8_char_ref + utf8_char_view
	{
		...
		yggr_test_assert(yggr::utf8_char(2).view() % utf8_ch_ref_l == 2);
		yggr_test_assert(utf8_ch_ref_r % yggr::utf8_char(L'你').view() == 2);
	}
...
void test_bitwise_left_shfit_of_utf8_char(void)
{
	...
	// utf8_char << utf8_char_reference
	{
		...
		yggr_test_assert(utf8_ch << yggr::utf8_char::char_reference_type(utf8_ch2) == 'b');
	}
	...
	{
		yggr_test_assert(yggr::utf8_char(L'你' / 2) << 1 == L'你');
	}
	...
	// utf8_char << utf8_char
	{
		yggr::utf8_char utf8_ch = 1;
		yggr_test_assert(yggr::utf8_char(L'你' / 2) << utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(L'你' / 2) << yggr::utf8_char(1) == L'你');
	}
	...
	// utf8_char << utf8_char_view
	{
		yggr::utf8_char utf8_ch = 1;
		yggr_test_assert(yggr::utf8_char(L'你' / 2).view() << utf8_ch == L'你');
		yggr_test_assert(yggr::utf8_char(L'你' / 2) << yggr::utf8_char(1).view() == L'你');
	}
	...
	// utf8_char << utf8_char_reference
	{
		yggr::utf8_char utf8_ch = L'你' / 2;
		yggr::utf8_char utf8_ch2 = 1;
		yggr_test_assert(static_cast<yggr::utf8_char::char_reference_type>(utf8_ch) << yggr::utf8_char(1) == L'你');
		yggr_test_assert(utf8_ch << yggr::utf8_char::char_reference_type(utf8_ch2) == L'你');
	}
	...
	{
		yggr::utf8_char utf8_ch = L'你' / 2;
		yggr_test_assert(static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch) << yggr::utf8_char(1) == L'你');
		yggr_test_assert(utf8_ch << yggr::utf8_char::char_const_reference_type(yggr::utf8_char(1)) == L'你');
	}
...
void test_bitwise_left_shfit_of_utf8_char_reference(void)
{
...

	{
		...
		yggr_test_assert(ref_type(utf8_ch_ref) << 1 == L'你');
	}
	...
	// utf8_char_ref << utf8_char_view
	{
		...
		yggr_test_assert(yggr::utf8_char(L'你' / 2).view() << utf8_ch_ref_r == L'你');
		yggr_test_assert(utf8_ch_ref_l << yggr::utf8_char(1).view() == L'你');
	}
...
void test_bitwise_and_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert((utf8_ch & L'你') == L'你');
		yggr_test_assert((utf8_ch & L'好') == (L'你' & L'好'));
		yggr_test_assert((yggr::utf8_char(L'你') & L'你') == L'你');
		yggr_test_assert((yggr::utf8_char(L'你') & L'好') == (L'你' & L'好'));
	}

	// n & utf8_char
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert((L'你' & utf8_ch ) == L'你');
		yggr_test_assert((L'好' & utf8_ch) == (L'好' & L'你'));
		yggr_test_assert((L'你' & yggr::utf8_char(L'你')) == L'你');
		yggr_test_assert((L'好' & yggr::utf8_char(L'你')) == (L'好' & L'你'));
	}

	// utf8_char & utf8_char
	{
		yggr::utf8_char utf8_ch_l = L'你';
		yggr::utf8_char utf8_ch_r = L'好';

		yggr_test_assert((utf8_ch_l & utf8_ch_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_l & utf8_ch_r) == (L'你' & L'好'));

		yggr_test_assert((yggr::utf8_char(L'你') & utf8_ch_l) == L'你');
		yggr_test_assert((utf8_ch_l & yggr::utf8_char(L'好')) == (L'你' & L'好'));

		yggr_test_assert((yggr::utf8_char(L'你') & yggr::utf8_char(L'好')) == (L'你' & L'好'));
	}
	...
	// utf8_char & utf8_char_view
	{
		...
		yggr_test_assert((utf8_ch_l.view() & utf8_ch_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_l & utf8_ch_r.view()) == (L'你' & L'好'));

		yggr_test_assert((yggr::utf8_char(L'你') & utf8_ch_l.view()) == L'你');
		yggr_test_assert((utf8_ch_l.view() & yggr::utf8_char(L'好')) == (L'你' & L'好'));
	}
	...
	// utf8_char & utf8_char_reference
	{
		...
		yggr_test_assert((static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_l) & utf8_ch_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_l & static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_r)) == (L'你' & L'好'));

		yggr_test_assert((yggr::utf8_char(L'你') & static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_l)) == L'你');
		yggr_test_assert((static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_l) & yggr::utf8_char(L'好')) == (L'你' & L'好'));
	}
	...
	// utf8_char & utf8_char_const_reference
	{
		...
		yggr_test_assert((static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_l) & utf8_ch_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_l & static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_r)) == (L'你' & L'好'));

		yggr_test_assert((yggr::utf8_char(L'你') & static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_l)) == L'你');
		yggr_test_assert((static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_l) & yggr::utf8_char(L'好')) == (L'你' & L'好'));
	}
...
void test_bitwise_and_of_utf8_char_reference(void)
{
	...
	// n & utf8_char_ref
	{
		...
		yggr_test_assert((L'你' & utf8_ch_ref ) == L'你');
		yggr_test_assert((L'好' & utf8_ch_ref) == (L'好' & L'你'));
		yggr_test_assert((L'你' & ref_type(utf8_ch_ref)) == L'你');
		yggr_test_assert((L'好' & ref_type(utf8_ch_ref)) == (L'好' & L'你'));
	}
	...
	// utf8_char_ref & utf8_char_ref
	{
		...
		yggr_test_assert((ref_type(utf8_ch_ref_l) & ref_type(utf8_ch_ref_r)) == (L'你' & L'好'));
		yggr_test_assert((ref_type(utf8_ch_ref_l) & utf8_ch_ref_r) == (L'你' & L'好'));
		yggr_test_assert((utf8_ch_ref_l & ref_type(utf8_ch_ref_r)) == (L'你' & L'好'));
		yggr_test_assert((utf8_ch_ref_l & utf8_ch_ref_r) == (L'你' & L'好'));
	}
	...
	// utf8_char_ref & utf8_char_view
	{
		...
		yggr_test_assert((utf8_ch_ref_l.view() & utf8_ch_ref_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_ref_l & utf8_ch_ref_r.view()) == (L'你' & L'好'));

		yggr_test_assert((ref_type(utf8_ch_ref_l) & utf8_ch_ref_l.view()) == L'你');
		yggr_test_assert((utf8_ch_ref_l.view() & ref_type(utf8_ch_ref_r)) == (L'你' & L'好'));
	}
	...
	// utf8_char_ref & utf8_char_const_reference
	{
		...
		yggr_test_assert((utf8_ch_ref_l.const_cast_() & utf8_ch_ref_l) == utf8_ch_l);
		yggr_test_assert((utf8_ch_ref_l & utf8_ch_ref_r.const_cast_()) == (L'你' & L'好'));

		yggr_test_assert((ref_type(utf8_ch_ref_l) & utf8_ch_ref_l.const_cast_()) == L'你');
		yggr_test_assert((utf8_ch_ref_l.const_cast_() & ref_type(utf8_ch_ref_r)) == (L'你' & L'好'));
	}
...
void test_bitwise_or_utf8_char_reference(void)
{
	...
	// utf8_char_ref | n
	{
		...
		yggr_test_assert((utf8_ch_ref | L'你') == L'你');
		yggr_test_assert((utf8_ch_ref | L'好') == (L'你' | L'好'));
		yggr_test_assert((ref_type(utf8_ch_ref) | L'你') == L'你');
		yggr_test_assert((ref_type(utf8_ch_ref) | L'好') == (L'你' | L'好'));
	}
	...
	// utf8_char_ref | utf8_char_const_reference
	{
		...
		yggr_test_assert((ref_type(utf8_ch_ref_l) | utf8_ch_ref_l) == L'你');
		yggr_test_assert((utf8_ch_ref_l.const_cast_() | ref_type(utf8_ch_ref_r)) == (L'你' | L'好'));
	}
...
void test_bitwise_xor_of_utf8_char(void)
{
	...
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert((utf8_ch ^ L'你') == 0);
		yggr_test_assert((utf8_ch ^ L'好') == (L'你' ^ L'好'));
		yggr_test_assert((yggr::utf8_char(L'你') ^ L'你') == 0);
		yggr_test_assert((yggr::utf8_char(L'你') ^ L'好') == (L'你' ^ L'好'));
	}
	...
	{
		yggr::utf8_char utf8_ch = L'你';
		yggr_test_assert((L'你' ^ utf8_ch ) == 0);
		yggr_test_assert((L'好' ^ utf8_ch) == (L'好' ^ L'你'));
		yggr_test_assert((L'你' ^ yggr::utf8_char(L'你')) == 0);
		yggr_test_assert((L'好' ^ yggr::utf8_char(L'你')) == (L'好' ^ L'你'));
	}
	...
	// utf8_char ^ utf8_char
	{
		...
		yggr_test_assert((yggr::utf8_char(L'你') ^ utf8_ch_l) == 0);
		yggr_test_assert((utf8_ch_l ^ yggr::utf8_char(L'好')) == (L'你' ^ L'好'));
	...
	// utf8_char ^ utf8_char_view
	{
		...
		yggr_test_assert((yggr::utf8_char(L'你') ^ utf8_ch_l.view()) == 0);
		yggr_test_assert((utf8_ch_l.view() ^ yggr::utf8_char(L'好')) == (L'你' ^ L'好'));
	}
	...
	// utf8_char ^ utf8_char_reference
	{
		...
		yggr_test_assert((yggr::utf8_char(L'你') ^ static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_l)) == 0);
		yggr_test_assert((static_cast<yggr::utf8_char::char_reference_type>(utf8_ch_l) ^ yggr::utf8_char(L'好')) == (L'你' ^ L'好'));
	}
	...
	// utf8_char ^ utf8_char_const_reference
	{
		...
		yggr_test_assert((yggr::utf8_char(L'你') ^ static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_l)) == 0);
		yggr_test_assert((static_cast<yggr::utf8_char::char_const_reference_type>(utf8_ch_l) ^ yggr::utf8_char(L'好')) == (L'你' ^ L'好'));
	}
...
void test_bitwise_xor_of_utf8_char_reference(void)
{
	...
	// utf8_char_ref ^ n
	{
		...
		yggr_test_assert((utf8_ch_ref ^ L'你') == 0);
		yggr_test_assert((utf8_ch_ref ^ L'好') == (L'你' ^ L'好'));
		yggr_test_assert((ref_type(utf8_ch_ref) ^ L'你') == 0);
		yggr_test_assert((ref_type(utf8_ch_ref) ^ L'好') == (L'你' ^ L'好'));
	}
	...
	// n ^ utf8_char_ref
	{
		...
		yggr_test_assert((L'你' ^ utf8_ch_ref ) == 0);
		yggr_test_assert((L'好' ^ utf8_ch_ref) == (L'好' ^ L'你'));
		yggr_test_assert((L'你' ^ ref_type(utf8_ch_ref)) == 0);
		yggr_test_assert((L'好' ^ ref_type(utf8_ch_ref)) == (L'好' ^ L'你'));
	}
