...
void test_constructor(void)
{
	...
	yggr::utf8_char c3("你", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	yggr::utf8_char c3_3(std::string("你").c_str(), std::string("你").size(), YGGR_STR_UTF8_STRING_CHARSET_NAME());
	std::cout << c3 << std::endl;
	yggr_test_assert(c3 == c3_3);
	yggr_test_assert(c3 == yggr::utf8_char("你", YGGR_STR_UTF8_STRING_CHARSET_NAME()));

	yggr::utf8_char c4(std::string("好"), YGGR_STR_UTF8_STRING_CHARSET_NAME());

#if 0
	yggr::utf8_char cf4(yggr::string("好a"), YGGR_STR_UTF8_STRING_CHARSET_NAME()); // assert fail
#endif // 0, 1
...
#else
    yggr::utf8_char c5("宽", YGGR_STR_UTF8_STRING_CHARSET_NAME());
...
#else
    yggr::utf8_char c6(yggr::string("字").c_str(), yggr::string("字").size(), YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif // YGGR_NO_CWCHAR

#if 0
	yggr::utf8_char cf6(yggr::string("好a"), YGGR_STR_UTF8_STRING_CHARSET_NAME()); // assert fail
#endif // 0, 1
...
#if 0
	yggr::utf8_char cf7(yggr::string("好a"), YGGR_STR_UTF8_STRING_CHARSET_NAME()); // assert fail
#endif // 0, 1
...
#else
    std::string c6_2("字", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif //YGGR_NO_CWCHAR
	...
	{
		yggr::utf8_char c11(yggr::string_view("字"), YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(c11 == yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
	}
...
{
	yggr::utf8_char c1("你", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	std::cout << c1 << std::endl;
	...
	c1 = L"好";
#else
    c1 = yggr::utf8_char("好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif //YGGR_NO_CWCHAR
	std::cout << c1 << std::endl;
	...
	{
		yggr::utf8_char c11;
		c11 = yggr::charset::make_string_charset_helper(yggr::string_view("字"), YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(c11 == yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
	}
...
{
	{
		yggr::utf8_char uchar = yggr::utf8_char("好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		std::string str = uchar.str<std::string>();
...
#else
        yggr::utf8_char str = yggr::utf8_char("不", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif // YGGR_NO_CWCHAR
		yggr_test_assert(uchar != str);
		yggr_test_assert(!(uchar == str));
#if 0
	...
	{
		yggr::utf8_char uchar = yggr::utf8_char("好", YGGR_STR_UTF8_STRING_CHARSET_NAME()); // 22909
		yggr::utf8_char tmp_uchar = yggr::utf8_char("不", YGGR_STR_UTF8_STRING_CHARSET_NAME()); // 19981
		yggr::string tmp_str = tmp_uchar.str<yggr::string>();
		yggr::string_view str = tmp_str; // 19981
		yggr_test_assert(uchar != str);
...
void swap_test(void)
{
	...
	yggr::utf8_char c1 = yggr::utf8_char("你", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	yggr::utf8_char c2 = yggr::utf8_char("好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
