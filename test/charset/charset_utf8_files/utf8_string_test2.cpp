...
void test_operations_starts_ends_with(void)
{
	...
	{
		yggr::utf8_string org("你abcde好", YGGR_STR_INNER_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv(org);
		std::cout << org << std::endl;
...
void test_operations_contains(void)
{
	...
	{
		yggr::utf8_string org_t("你abcde好", YGGR_STR_INNER_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv_t(org_t);

		yggr::utf8_string org_f("字fgh符", YGGR_STR_INNER_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv_f(org_f);
