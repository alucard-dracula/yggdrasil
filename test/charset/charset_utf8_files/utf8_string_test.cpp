...
#		endif // 0, 1
	...
	// (string)
	{
...

		{
			...
			try
			{
				yggr::utf8_string str8(std::string("abc你好"), 4);
...

		{
			...
			// right usage
			yggr::utf8_string str8(yggr::utf8_string("abc你好", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 4);
			yggr_test_assert(str8 == yggr::utf8_string("好", YGGR_STR_UTF8_STRING_CHARSET_NAME())); // because utf8_string can correctly recognize utf8_char
		}
...

		{
			...
			yggr::utf8_string str8(yggr::utf8_string("abc你好", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 4, 1);
			yggr_test_assert(str8 == yggr::utf8_string("好", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		}
	}
	...
	// (n, char)
	{
		...
		{
			// char
			yggr::utf8_string str1(3, L'你');
			yggr_test_assert(str1 == L"你你你");

			yggr::utf8_string str2(3, L'你', yggr::utf8_string::allocator_type());
			yggr_test_assert(str2 == L"你你你");

			yggr::utf8_string str3(3, L'你', yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str3 == L"你你你");

			yggr::utf8_string str4(3, L'你', yggr::utf8_string::allocator_type(), yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"你你你");

			yggr::utf8_string str5(3, yggr::charset::make_string_charset_helper(L'你'));
			yggr_test_assert(str5 == L"你你你");

			yggr::utf8_string str6(3, yggr::charset::make_string_charset_helper(L'你'),  yggr::utf8_string::allocator_type());
			yggr_test_assert(str6 == L"你你你");
		}

		{
			// utf8 char
			yggr::utf8_string str1(3, yggr::utf8_string::char_type(L'你'));
			yggr_test_assert(str1 == L"你你你");

			yggr::utf8_string str2(3, yggr::utf8_string::char_type(L'你'), yggr::utf8_string::allocator_type());
			yggr_test_assert(str2 == L"你你你");

			yggr::utf8_string str3(3, yggr::utf8_string::char_type(L'你'),
									yggr::charset::charset_name_t<yggr::utf8_string::char_type>());
			yggr_test_assert(str3 == L"你你你");

			yggr::utf8_string str4(3, yggr::utf8_string::char_type(L'你'),
										yggr::utf8_string::allocator_type(),
										yggr::charset::charset_name_t<yggr::utf8_string::char_type>());
			yggr_test_assert(str4 == L"你你你");

			yggr::utf8_string str5(3, yggr::charset::make_string_charset_helper(yggr::utf8_string::char_type(L'你')));
			yggr_test_assert(str5 == L"你你你");

			yggr::utf8_string str6(3, yggr::charset::make_string_charset_helper(yggr::utf8_string::char_type(L'你')),
										yggr::utf8_string::allocator_type());
			yggr_test_assert(str6 == L"你你你");
		}
		...
		{
			// const wchat_t*
			yggr::utf8_string str1(3, std::wstring(L"你"));
			yggr_test_assert(str1 == L"你你你");

			yggr::utf8_string str2(3, std::wstring(L"你"), yggr::utf8_string::allocator_type());
			yggr_test_assert(str2 == L"你你你");

			yggr::utf8_string str3(3, yggr::wstring(L"你"), yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str3 == L"你你你");

			yggr::utf8_string str4(3, yggr::wstring(L"你"),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"你你你");

			yggr::utf8_string str5(3, yggr::charset::make_string_charset_helper(std::wstring(L"你")));
			yggr_test_assert(str5 == L"你你你");

			yggr::utf8_string str6(3, yggr::charset::make_string_charset_helper(yggr::wstring(L"你")),
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str6 == L"你你你");
		}
	}
	...
	// (string)
	{
		{
			//const wchar_t*
			yggr::utf8_string str1 = L"你好吗";
			yggr_test_assert(str1 == L"你好吗");

			yggr::utf8_string str2(L"你好吗");
			yggr_test_assert(str2 == L"你好吗");

			yggr::utf8_string str3(L"你好吗", yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"你好吗");

      if(sizeof(wchar_t) == 2)
      {
        yggr::utf8_string str4(L"你好吗", yggr::charset::charset_name_t<yggr::s16>());
        yggr_test_assert(str4 == L"你好吗");
      }
      else
      {
        yggr_test_assert(sizeof(wchar_t) == 4);
        yggr::utf8_string str4(L"你好吗", yggr::charset::charset_name_t<yggr::s32>());
        yggr_test_assert(str4 == L"你好吗");
      }

			yggr::utf8_string str5(L"你好吗",
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str5 == L"你好吗");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(L"你好吗"));
			yggr_test_assert(str6 == L"你好吗");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(L"你好吗"),
									yggr::utf8_string::allocator_type());
		...
		{
			//const wstring&
			yggr::utf8_string str1 = std::wstring(L"你好吗");
			yggr_test_assert(str1 == L"你好吗");

			yggr::utf8_string str2(yggr::wstring(L"你好吗"));
			yggr_test_assert(str2 == L"你好吗");

			yggr::utf8_string str3(std::wstring(L"你好吗"), yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"你好吗");

			yggr::utf8_string str4(yggr::wstring(L"你好吗"), yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"你好吗");

			yggr::utf8_string str5(std::wstring(L"你好吗"),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str5 == L"你好吗");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(yggr::wstring(L"你好吗")));
			yggr_test_assert(str6 == L"你好吗");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(std::wstring(L"你好吗")),
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"你好吗");
		}
		...
		{
			//const utf8_string&
			yggr::utf8_string str1 = yggr::utf8_string(L"你好吗");
			yggr_test_assert(str1 == L"你好吗");

			yggr::utf8_string str2(yggr::utf8_string(L"你好吗"));
			yggr_test_assert(str2 == L"你好吗");

			yggr::utf8_string str3(yggr::utf8_string(L"你好吗"), yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"你好吗");

			yggr::utf8_string str4(yggr::utf8_string(L"你好吗"), yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"你好吗");

			yggr::utf8_string str5(yggr::utf8_string(L"你好吗"),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"你好吗");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"你好吗")));
			yggr_test_assert(str6 == L"你好吗");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"你好吗")),
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"你好吗");
		}
		...
		{
			// const char*, n
			yggr::utf8_string str1(L"你好吗阿呆", 3);
			yggr_test_assert(str1 == L"你好吗");

			yggr::utf8_string str3(L"你好吗阿呆", 3, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"你好吗");

			yggr::utf8_string str4(L"你好吗阿呆", 3, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"你好吗");

			yggr::utf8_string str5(L"你好吗阿呆", 3,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str5 == L"你好吗");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(L"你好吗阿呆"), 3);
			yggr_test_assert(str6 == L"你好吗");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(L"你好吗阿呆"), 3,
										yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"你好吗");
		}
		...
		{
			// const string pos
			yggr::utf8_string str1(std::wstring(L"你好吗阿呆"), 3);
			yggr_test_assert(str1 == L"阿呆");

			yggr::utf8_string str3(yggr::wstring(L"你好吗阿呆"), 3, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"阿呆");

			yggr::utf8_string str4(std::wstring(L"你好吗阿呆"), 3, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"阿呆");

			yggr::utf8_string str5(yggr::wstring(L"你好吗阿呆"), 3,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str5 == L"阿呆");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(std::wstring(L"你好吗阿呆")), 3);
			yggr_test_assert(str6 == L"阿呆");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(yggr::wstring(L"你好吗阿呆")), 3,
										yggr::utf8_string::allocator_type());
		...
		{
			// const string pos
			yggr::utf8_string str1(yggr::utf8_string(L"你好吗阿呆"), 3);
			yggr_test_assert(str1 == L"阿呆");

			yggr::utf8_string str3(yggr::utf8_string(L"你好吗阿呆"), 3, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"阿呆");

			yggr::utf8_string str4(yggr::utf8_string(L"你好吗阿呆"), 3, yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"阿呆");

			yggr::utf8_string str5(yggr::utf8_string(L"你好吗阿呆"), 3,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"阿呆");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"你好吗阿呆")), 3);
			yggr_test_assert(str6 == L"阿呆");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"你好吗阿呆")), 3,
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"阿呆");
		...
		{
			// const string pos, len
			yggr::utf8_string str1(std::wstring(L"你好吗阿呆"), 3, 1);
			yggr_test_assert(str1 == L"阿");

			yggr::utf8_string str3(yggr::wstring(L"你好吗阿呆"), 3, 1, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"阿");

			yggr::utf8_string str4(std::wstring(L"你好吗阿呆"), 3, 1, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str4 == L"阿");

			yggr::utf8_string str5(yggr::wstring(L"你好吗阿呆"), 3, 1,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(str5 == L"阿");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(std::wstring(L"你好吗阿呆")), 3, 1);
			yggr_test_assert(str6 == L"阿");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(yggr::wstring(L"你好吗阿呆")), 3, 1,
									yggr::utf8_string::allocator_type());
		...
		{
			// const utf8_string pos, len
			yggr::utf8_string str1(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 3, 1);
			yggr_test_assert(str1 == L"阿");

			yggr::utf8_string str3(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 3, 1, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"阿");

			yggr::utf8_string str4(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 3, 1, yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"阿");

			yggr::utf8_string str5(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 3, 1,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"阿");

			yggr::utf8_string str6(yggr::charset::make_string_charset_helper(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 3, 1);
			yggr_test_assert(str6 == L"阿");

			yggr::utf8_string str7(yggr::charset::make_string_charset_helper(yggr::utf8_string("你好吗阿呆", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 3, 1,
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"阿");
		}
	}
	...
	// iterator
	{
		...
		{
			// utf8_string
			yggr::utf8_string str_arr = L"你好吗";
		...
		{
			// utf8_string riter
			yggr::utf8_string str_arr = L"你hao吗";
			...
			yggr::utf8_string str3(str_arr.rbegin(), str_arr.rend(),
										yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str3 == L"吗oah你");

			yggr::utf8_string str4(str_arr.rbegin(), str_arr.rend(),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"吗oah你");
		}
	}

	// string_view
	{
		yggr::utf8_string str1(yggr::wstring_view(L"你好吗"));
		yggr_test_assert(str1 == L"你好吗");

		yggr::utf8_string str2(yggr::wstring_view(L"你好吗"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str2 == L"你好吗");

		yggr::utf8_string str3(yggr::wstring_view(L"你好吗"), yggr::utf8_string::allocator_type());
		yggr_test_assert(str3 == L"你好吗");

		yggr::utf8_string str4(yggr::wstring_view(L"你好吗"),
								yggr::utf8_string::allocator_type(),
								YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str3 == L"你好吗");

		yggr::utf8_string str5(yggr::wstring_view(L"你好吗"), 1, 3);
		yggr_test_assert(str5 == L"好吗");

		yggr::utf8_string str6(yggr::wstring_view(L"你好吗"), 1, 3, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str6 == L"好吗");

		yggr::utf8_string str7(yggr::wstring_view(L"你好吗"), 1, 3,
									yggr::utf8_string::allocator_type(),
									YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str7 == L"好吗");

		yggr::utf8_string str8(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")));
		yggr_test_assert(str8 == L"你好吗");

		yggr::utf8_string str9(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")),
								yggr::utf8_string::allocator_type());
		yggr_test_assert(str9 == L"你好吗");

		yggr::utf8_string str10(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")),
								1, 3);
		yggr_test_assert(str10 == L"好吗");

		yggr::utf8_string str11(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")),
								1, 3, yggr::utf8_string::allocator_type());
		yggr_test_assert(str11 == L"好吗");
	}

	// utf8_string_view
	{
		yggr::utf8_string org_str = L"你好吗";
...
void test_append(void)
{
	// n, char
	{
		// n char
		{
			yggr::utf8_string str = yggr::utf8_string("a你b好c", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	...
	// string
	{
		...
		// string_view
		{
...

			{
				...
				yggr_test_assert(str == yggr::utf8_string("a你b好corld", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
			}
...

			{
				...
				yggr_test_assert(str == yggr::utf8_string("a你b好cor", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
			}
...
#		endif // 0, 1
		...
		// n utf8_string
		{
			...
			str.append(3, yggr::utf8_char(L"ワ"));
		...
		// string_charset_name
		{
			...
			str.append(3, yggr::charset::make_string_charset_helper(L'ワ'));
...

		{
			...
			str.append(3, yggr::charset::make_string_charset_helper(std::wstring(L"ワ")));
...

		{
			...
			str.append(3, yggr::charset::make_string_charset_helper(yggr::utf8_string::char_type(L"ワ")));
	...
	// string
	{
		 ...
		 // const char*, n
		{
			...
			str.append(L"ワルードm", 3);

			yggr_test_assert(str.length() == 8);
			yggr_test_assert(str == L"a你b好cワルー");
		}
		...
		// string
		{
			...
			str.append(std::wstring(L"ワルードm"));
		...
		// string, pos
		{
			...
			str.append(yggr::wstring(L"ワルードm"), 3);
		...
		// string, pos, len
		{
			...
			str.append(std::wstring(L"ワルードm"), 3, 1);
		...
		// utf8_string
		{
			...
			str.append( yggr::utf8_string(L"ワルードm"));
...

		{
			...
			str.append( yggr::utf8_string(L"ワルードm"), 3);
...

		{
			...
			str.append( yggr::utf8_string(L"ワルードm"), 3, 1);
		...
		// string_charset_helper
		{
			...
			str.append(yggr::charset::make_string_charset_helper(L"ワルードm"));
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(L"ワルードm"), 3);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(std::wstring(L"ワルードm")));
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(yggr::wstring(L"ワルードm")), 3);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(std::wstring(L"ワルードm")), 3, 1);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"ワルードm")));
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"ワルードm")), 3);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"ワルードm")), 3, 1);
	...
	// append(iters, itere)
	{
		...
		{
			yggr::utf8_string ins_str = L" ワルード";
			yggr::utf8_string str = L"你好";
	...
	{
		{
			...
			yggr_test_assert(str == L"a你b好cworld");
		}
...

		{
			...
			yggr_test_assert(str == L"a你b好corld");
		}
...
void test_push_back(void)
{
	...
	{
		// hello world ja
		yggr::utf8_string str(L"ハローワルー");
		str.push_back(L'ド');
		yggr_test_assert(str.length() == 7);
		yggr_test_assert(str == L"ハローワルード");
	}
	...
	{
		yggr::utf8_string str(L"ハローワルー");
		str.push_back(yggr::utf8_char(L"ド"));
		yggr_test_assert(str.length() == 7);
		yggr_test_assert(str == L"ハローワルード");
	}
	...
	{
		yggr::utf8_string str(L"ハローワルー");
		str.push_back(yggr::charset::make_string_charset_helper(L'ド'));
		yggr_test_assert(str.length() == 7);
		yggr_test_assert(str == L"ハローワルード");
	}
	...
	{
		yggr::utf8_string str(L"ハローワルー");
		str.push_back(yggr::charset::make_string_charset_helper(std::wstring(L"ド")));
		yggr_test_assert(str.length() == 7);
		yggr_test_assert(str == L"ハローワルード");
	}

	{
		yggr::utf8_string str("ハローワルー", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		str.push_back(yggr::charset::make_string_charset_helper(yggr::utf8_char("ド", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(str.length() == 7);
		yggr_test_assert(str == L"ハローワルード");
	}
#endif // YGGR_NO_CWCHAR
...
void test_pop_back(void)
{
	...
	{
		yggr::utf8_string str(L"你好吗");
		str.pop_back();
		yggr_test_assert(str.length() == 2);
		yggr_test_assert(str == L"你好");
...
#		endif // 0, 1
	...
	{
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(0, 2, L'今');
			yggr_test_assert(str == L"今今你好吗");
			str.insert(1, 2, L't');
			yggr_test_assert(str == L"今tt今你好吗");
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(0, 2, std::wstring(L"今"));
			yggr_test_assert(str == L"今今你好吗");
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(0, 2, yggr::utf8_char(L"今"));
			yggr_test_assert(str == L"今今你好吗");
...

	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(str.begin(), 2, std::wstring(L"今"));
			yggr_test_assert(str == L"今今你好吗");
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(str.begin(), 2, yggr::utf8_char(L"今"));
			yggr_test_assert(str == L"今今你好吗");
	...
	// insert(pos, const char*)
	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(0, yggr::utf8_string(L"今今"));
			yggr_test_assert(str == L"今今你好吗");
	...
	// insert(pos, const char*, n)
	{

		{
			...
			str.insert(0, str);
			yggr_test_assert(str == L"今tt今你好吗???今tt今你好吗???");
			yggr_test_assert(str.length() == 20);
		}
	}
	...
	// insert(pos, string, subpos, sublen)
	{
		{
			yggr::utf8_string str = L"你好吗";
			str.insert(0, L"今今tt???", 0, 2);
			yggr_test_assert(str == L"今今你好吗");
			str.insert(1,  L"今今tt???", 2, 2);
			yggr_test_assert(str == L"今tt今你好吗");
			str.insert(str.length(), yggr::charset::make_string_charset_helper(L"今今tt???"), 4);
			yggr_test_assert(str == L"今tt今你好吗今今tt");
			yggr_test_assert(str.length() == 11);
		}

		{
			std::wstring stl_ins_str = L"今今tt???";
			yggr::wstring yggr_ins_str = L"今今tt???";
			yggr::utf8_string str = L"你好吗";
			str.insert(0, stl_ins_str, 0, 2);
			yggr_test_assert(str == L"今今你好吗");
			str.insert(1,  yggr_ins_str, 2, 2);
		...
		{
			yggr::utf8_string ins_str = L"今今tt???";
			yggr::utf8_string str = L"你好吗";
			str.insert(0, ins_str, 0, 2);
			yggr_test_assert(str == L"今今你好吗");
			str.insert(1,  ins_str, 2, 2);
	...
	// insert(iter_p, iters, itere)
	{
		...
		{
			yggr::utf8_string ins_str = L"???tt今今";
			yggr::utf8_string str = L"你好吗";
			str.insert(str.begin(), ins_str.rbegin(), ins_str.rbegin() + 2);
			yggr_test_assert(str == L"今今你好吗");
			str.insert(str.begin() + 1,  ins_str.rbegin() + 2, ins_str.rbegin() + 2 + 2);
	...
	{
		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"));
			yggr_test_assert(str == L"阿仙源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
			yggr_test_assert(str == L"阿仙源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::charset::make_string_charset_helper(yggr::wstring_view(L"仙源阻")));
			yggr_test_assert(str == L"阿仙源阻扒村");
		}
		...
		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"), 1);
			yggr_test_assert(str == L"阿源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"), 1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
			yggr_test_assert(str == L"阿源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::charset::make_string_charset_helper(yggr::wstring_view(L"仙源阻")), 1);
			yggr_test_assert(str == L"阿源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"), 1, yggr::wstring_view::npos);
			yggr_test_assert(str == L"阿源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::wstring_view(L"仙源阻"), 1, yggr::wstring_view::npos, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
			yggr_test_assert(str == L"阿源阻扒村");
		}

		{
			yggr::utf8_string str = L"阿扒村";
			str.insert(1, yggr::charset::make_string_charset_helper(yggr::wstring_view(L"仙源阻")), 1, yggr::wstring_view::npos);
			yggr_test_assert(str == L"阿源阻扒村");
		}
	}
...
void test_replace(void)
{
	...
	// replace(pos, len, n, char)
	{
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, L'坏');
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, std::wstring(L"坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, yggr::utf8_char(L"坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, yggr::charset::make_string_charset_helper(L'坏'));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, yggr::charset::make_string_charset_helper(yggr::wstring(L"坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, 3, yggr::charset::make_string_charset_helper(yggr::utf8_char(L"坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 0, 0, L'坏');
			yggr_test_assert(str.length() == 3);
			yggr_test_assert(str == L"你好吗");
		}

		{
			yggr::utf8_string str = L"你好吗";
			str.replace(0, 100, 0, L'坏');
			yggr_test_assert(str.length() == 0);
			yggr_test_assert(str == L"");
		}
	}
	...
	// replace(iters, itere, n, char)
	{
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, L'坏');
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, std::wstring(L"坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, yggr::utf8_char(L"坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, yggr::charset::make_string_charset_helper(L'坏'));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, yggr::charset::make_string_charset_helper(yggr::wstring(L"坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, 3, yggr::charset::make_string_charset_helper(yggr::utf8_char(L"坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 1, 0, L'坏');
			yggr_test_assert(str.length() == 3);
			yggr_test_assert(str == L"你好吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin(), 0, L'坏');
			yggr_test_assert(str.length() == 1);
			yggr_test_assert(str == L"你");
		}
#endif // 0, 1
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin(), str.end(), 0, L'坏');
			yggr_test_assert(str.length() == 0);
			yggr_test_assert(str == L"");
		}
	}
	...
	// replace(pos, len, const char*)
	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, std::wstring(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, yggr::utf8_string(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, yggr::charset::make_string_charset_helper(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, yggr::charset::make_string_charset_helper(yggr::wstring(L"坏坏坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, yggr::charset::make_string_charset_helper(yggr::utf8_string(L"坏坏坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 0, L"坏坏坏");
			yggr_test_assert(str.length() == 6);
			yggr_test_assert(str == L"你坏坏坏好吗");
		}

		{
			yggr::utf8_string str = L"你好吗";
			str.replace(0, 100, L"坏坏坏");
			yggr_test_assert(str.length() == 3);
			yggr_test_assert(str == L"坏坏坏");
		}
	}
	...
	// replace(pos, len, const char*, n)
	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, yggr::charset::make_string_charset_helper(L"坏坏坏"), 3);
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
	...
	// replace(iters, itere, const char*)
	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, L"坏坏坏");
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, std::wstring(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, yggr::utf8_string(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, yggr::charset::make_string_charset_helper(L"坏坏坏"));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, yggr::charset::make_string_charset_helper(yggr::wstring(L"坏坏坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, yggr::charset::make_string_charset_helper(yggr::utf8_string(L"坏坏坏")));
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin(), L"坏坏坏");
			yggr_test_assert(str.length() == 4);
			yggr_test_assert(str == L"你坏坏坏");
		}
#endif // 0, 1

		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin(), str.end(), L"坏坏坏");
			yggr_test_assert(str.length() == 3);
			yggr_test_assert(str == L"坏坏坏");
		}
	}
	...
	// replace(iters, itere, const char*, n)
	{
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, L"坏坏坏", 3);
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, yggr::charset::make_string_charset_helper(L"坏坏坏"), 3);
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin(), L"坏坏坏", 3);
			yggr_test_assert(str.length() == 4);
			yggr_test_assert(str == L"你坏坏坏");
		}
#endif // 0, 1
		...
		{
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin(), str.end(), L"坏坏坏", 3);
			yggr_test_assert(str.length() == 3);
			yggr_test_assert(str == L"坏坏坏");
		}
	}
	...
	// replace(pos, len, string, subpos, sublen)
	{
		std::wstring stl_rep_str = L"tag坏坏坏tag";
		yggr::wstring yggr_rep_str = L"tag坏坏坏tag";
		yggr::utf8_string utf8_rep_str = L"tag坏坏坏tag";

		{
			yggr::utf8_string str = L"你好吗";
			str.replace(1, 1, L"tag坏坏坏tag", 3, 3);
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
		}
	...
	//replace(i1, i2, s, e)
	{
		...
		{
			yggr::utf8_string rep_str = L"坏坏坏";
			yggr::utf8_string str = L"你好吗";
			str.replace(str.begin() + 1, str.begin() + 2, rep_str.begin(), rep_str.end());
			yggr_test_assert(str.length() == 5);
			yggr_test_assert(str == L"你坏坏坏吗");
...
void test_find(void)
{
	...
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(L'好') == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::utf8_char(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(L'好')) == 2);
		}
	...
	// find(const char*, pos, n)
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(L"好", 0, 1) == 2);
		}
	}
	...
	// find(const string&, pos)
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(std::wstring(L"好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::wstring(L"好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::wstring(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"好"))) == 2);
		}
	}
	...
	// find(const string_view, pos)
	{
		...
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::wstring_view(L"好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::wstring_view(L"好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::wstring_view(L"好"), 1) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::wstring_view(L"好"), 1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"好")), 1) == 2);
		}

		// utf8_string_view
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::utf8_string_view(yggr::utf8_string(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::utf8_string_view(yggr::utf8_string(L"好")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"好")))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::utf8_string_view(yggr::utf8_string(L"好")), 1) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::utf8_string_view(yggr::utf8_string(L"好")), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.find(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"好"))), 1) == 2);
		}
	}
...
void test_rfind(void)
{
	...
	// rfind(char, pos)
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(L'好') == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::utf8_char(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗好你";
		...
		{
			yggr::utf8_string str = L"你a好b吗好你";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(L'好')) == 5);
		}
	}
	...
	// rfind(const char*, pos, n)
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(L"好", yggr::utf8_string::npos, 1) == 2);
		}
	}
	...
	// rfind(const string&, pos)
	{
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(std::wstring(L"好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::utf8_string(L"好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(yggr::wstring(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"好"))) == 2);
		}
	...
	// rfind(const StringView*, pos)
	{
		...
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::wstring_view(L"好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::wstring_view(L"好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::wstring_view(L"好"), yggr::utf8_string::npos) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::wstring_view(L"好"), yggr::utf8_string::npos, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"好")), yggr::utf8_string::npos) == 2);
		}

		//utf8_string_view
		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::utf8_string_view(yggr::utf8_string(L"好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::utf8_string_view(yggr::utf8_string(L"好")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			...
			yggr_test_assert(str.rfind(
					yggr::charset::make_string_charset_helper(
						yggr::utf8_string_view(yggr::utf8_string(L"好")))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗";
			yggr_test_assert(str.rfind(yggr::utf8_string_view(yggr::utf8_string(L"好")), yggr::utf8_string::npos) == 2);
		}

		{
			...
			yggr_test_assert(
				str.rfind(
					yggr::utf8_string_view(yggr::utf8_string(L"好")),
...
void test_find_first_of(void)
{
	...
	{
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(L'好') == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string::char_type(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(L'好')) == 2);
		}
	...
	{
		{
			...
			yggr_test_assert(str.find_first_of(L"吗b好") == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(L"吗b好") == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(L"吗b好")) == 2);
		}
	}
	...
	// find_first_of(const char*, pos, n)
	{
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(L"吗b好", 1, 1) == 4);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(L"吗b好"), 1, 1) == 4);
		}
	}
	...
	// find_first_of(const string&, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_first_of(std::wstring(L"吗b好")) == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(std::wstring(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(boost::container::wstring(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(std::wstring(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(boost::container::wstring(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"吗b好"))) == 2);
		}
	}
	...
	// find_first_of(const string_view&, pos)
	{
		...
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::wstring_view(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::wstring_view(L"吗b好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::wstring_view(L"吗b好"), 1) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::wstring_view(L"吗b好"), 1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好")), 1) == 2);
		}
		...
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")))) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), 1) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_first_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))), 1) == 2);
		}
	}
#endif //YGGR_NO_CWCHAR
...
void test_find_first_not_of(void)
{
	...
	{
		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(L'好') == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string::char_type(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(L'好')) == 2);
		}
	...
	// find_first_not_of(const char*, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_first_not_of(L"吗b好") == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(L"吗b好") == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(L"吗b好")) == 2);
		}
	}
	...
	{
		{
			yggr::utf8_string str = L"吗吗吗吗你a好b吗c";
			yggr_test_assert(str.find_first_not_of(L"吗b好", 1, 1) == 4);
		}

		{
			yggr::utf8_string str = L"吗吗吗吗你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(L"吗b好"), 1, 1) == 4);
		}
	}
	...
	// find_first_not_of(const string&, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_first_not_of(std::wstring(L"吗b好")) == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(std::wstring(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(boost::container::wstring(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(std::wstring(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(boost::container::wstring(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"吗b好"))) == 2);
		}
	}
	...
	// find_first_not_of(const string_view&, pos)
	{
		...
		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::wstring_view(L"吗b好")) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::wstring_view(L"吗b好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::wstring_view(L"吗b好"), 1) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::wstring_view(L"吗b好"), 1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好")), 1) == 2);
		}

		// utf8_string_view
		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")))) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), 1) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 2);
		}

		{
			yggr::utf8_string str = L"好好你a好b吗c";
			yggr_test_assert(str.find_first_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))), 1) == 2);
		}
	}
...
void test_find_last_of(void)
{
...

	{
		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_last_of(L'好') == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_last_of(yggr::utf8_string::char_type(L'好')) == 2);
		}

		{
			yggr::utf8_string str = L"你a好b吗c";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(L'好')) == 2);
		}
	...
	// find_last_of(const char*, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_last_of(L"吗b好") == yggr::utf8_string::npos);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of("") == yggr::utf8_string::npos);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(L"吗b好") == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(L"吗b好")) == 4);
		}
	}
	...
	// find_last_of(const char*, pos, n)
	{
		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(L"吗b好", str.length(), 1) == 3);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(L"吗b好"), str.length(), 1) == 3);
		}
	}
	...
	// find_last_of(const string&, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_last_of(std::wstring(L"吗b好")) == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(std::wstring(L"吗b好")) == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(boost::container::wstring(L"吗b好")) == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::utf8_string(L"吗b好")) == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(std::wstring(L"吗b好"))) == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(boost::container::wstring(L"吗b好"))) == 4);
		}

		{
			yggr::utf8_string str = L"你a好吗好a你";
			yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"吗b好"))) == 4);
		}
	}
#endif //YGGR_NO_CWCHAR
...
void test_find_last_not_of(void)
{
	...
	{
		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(L'好') == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string::char_type(L'好')) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(L'好')) == 5);
		}
	...
	// find_last_not_of(const char*, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_last_not_of(L"吗b好") == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(L"吗b好") == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(L"吗b好")) == 5);
		}
	}
	...
	{
		{
			yggr::utf8_string str = L"你a好b吗c吗吗吗吗";
			yggr_test_assert(str.find_last_not_of(L"吗b好", 1, 1) == 1);
		}

		{
			yggr::utf8_string str = L"吗吗吗吗你a好b吗";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(L"吗b好"), -1, 1) == 7);
		}
	}
	...
	// find_first_not_of(const string&, pos)
	{
		{
			yggr::utf8_string str = L"";
			yggr_test_assert(str.find_last_not_of(std::wstring(L"吗b好")) == yggr::utf8_string::npos);
		}
		...
		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(std::wstring(L"吗b好")) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(boost::container::wstring(L"吗b好")) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"吗b好")) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(std::wstring(L"吗b好"))) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(boost::container::wstring(L"吗b好"))) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string(L"吗b好"))) == 5);
		}
	}
	...
	// find_last_not_of(const string_view, pos)
	{
		...
		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::wstring_view(L"吗b好")) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::wstring_view(L"吗b好"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好"))) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::wstring_view(L"吗b好"), -1) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::wstring_view(L"吗b好"), -1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"吗b好")), -1) == 5);
		}

		// utf8_string_view
		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")))) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), -1) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::utf8_string_view(yggr::utf8_string(L"吗b好")), -1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 5);
		}

		{
			yggr::utf8_string str = L"你a好b吗c好好";
			yggr_test_assert(str.find_last_not_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"吗b好"))), -1) == 5);
		}
	}
...
void test_resize_relength(void)
{
	...
	// resize_and_overwrite
	{
		...
		str.resize_and_overwrite(str.size(),
									boost::bind(
										&op_resize, str.size(), _1, _2, yggr::utf8_char(L'吗').size()));
		yggr_test_assert(str == L"你好吗");
		...
		str.resize_and_overwrite(str.size() - yggr::utf8_char(L'吗').size(),
									boost::bind(
										&op_resize, str.size(), _1, _2, yggr::utf8_char(L'吗').size()));
		yggr_test_assert(str == L"你");
		yggr_test_assert(str.size() == yggr::utf8_char(L'你').size());
		yggr_test_assert(str.length() == 1);

		old_size = str.size();
		old_len = str.length();

		str.resize_and_overwrite(str.size() + yggr::utf8_char(L'吗').size() * 5,
									boost::bind(
										&op_resize, str.size(), _1, _2, yggr::utf8_char(L'吗').size()));
		yggr_test_assert(str == L"你z");
		yggr_test_assert(str.size() == yggr::utf8_char(L'你').size() + 1);
		yggr_test_assert(str.length() == 2);
	}
	...
	// relength
	{
		...
		yggr_test_assert(str == L"你好吗ddddddd");
...
void test_copy(void)
{
...

	{
		...
		yggr_test_assert(size == 2);
		out_str[size] = 0;
		yggr_test_assert(0 == memcmp(out_str, L"你好", size * sizeof(wchar_t)));
	}
...
void test_iterator(void)
{
	...
	// iterator
	{
		...
		yggr_test_assert(str == L"吃饭了");
	}

	// iterator
	{
		yggr::utf8_string str = L"你a吗";

		yggr::utf8_string rep = L"吃饭了";
...
void test_modify(void)
{
	...
	str.append(5, L'多');
#else
    str.append(5, yggr::utf8_char("多", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
#endif // YGGR_NO_CWCHAR
...
#else
    str.append(5, yggr::utf8_char("人", GGR_STR_UTF8_STRING_CHARSET_NAME()));
#endif // YGGR_NO_CWCHAR
	...
	yggr::utf8_string utf8_str("这是UTF8汉字", YGGR_STR_UTF8_STRING_CHARSET_NAME());
...
#else
    boost::container::string boost_wstr2("iter_boost_assign_w汉字", YGGR_STR_UTF8_STRING_CHARSET_NAME());
    str.assign(boost_wstr2.begin(), boost_wstr2.end());
#endif // YGGR_NO_CWCHAR
...
#ifndef YGGR_NO_CWCHAR
	{
		str.assign(yggr::wstring_view(L"你好吗"));
		yggr_test_assert(str == L"你好吗");

		str.assign(yggr::wstring_view(L"你好吗"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str == L"你好吗");

		str.assign(yggr::wstring_view(L"你好吗"), 1, 3);
		yggr_test_assert(str == L"好吗");

		str.assign(yggr::wstring_view(L"你好吗"), 1, 3, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME());
		yggr_test_assert(str == L"好吗");

		str.assign(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")));
		yggr_test_assert(str == L"你好吗");

		str.assign(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"你好吗")), 1, 3);
		yggr_test_assert(str == L"好吗");
	}
#endif // YGGR_NO_CWCHAR
...
#	else
		yggr::utf8_string::iterator iter = str.insert(str.begin() + 3, 2, "大", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#	endif // YGGR_NO_CWCHAR
		yggr_test_assert(iter - str.begin() == 3);
		std::cout << yggr::utf8_char(iter, iter + 1) << std::endl;
	}
	...
	{
		str = yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::utf8_string ustr("这是个", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	...
	// replace test
	{
		str = yggr::utf8_string("string 字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(str.length() == 10);
		str.replace(1, 5, 7, 'a');
...

	{
		str = yggr::utf8_string("string 字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(str.length() == 10);
		str.replace(7, 3, "string", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(str.length() == 13);
		std::cout << str << std::endl;
	}
...

	{
		...
		yggr::string sstr("abc");
		yggr_test_assert(str.length() == 10);
		str.replace(str.begin(), str.begin() + 6, sstr.rbegin(), sstr.rend(), YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr_test_assert(str.length() == 7);
		std::cout << str << std::endl;
	}
...
#else
        yggr::utf8_string sstr("你好吗", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif // YGGR_NO_CWCHAR
		yggr_test_assert(str.length() == 10);
		str.replace(str.begin(), str.begin() + 6, sstr.begin(), sstr.end());
		yggr_test_assert(str.length() == 7);
...
void test_string_operations(void)
{
	...
	// find
	{
		...
		yggr_test_assert(str.find(L'字', 5) == yggr::utf8_string::npos);
		yggr_test_assert(str.find(yggr::utf8_char(L'字')) == 4);
		yggr_test_assert(str.find(yggr::utf8_char(L'字'), 5) == yggr::utf8_string::npos);
#else
        yggr_test_assert(str.find("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.find("字", 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find(yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 4);
		yggr_test_assert(str.find(yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 5) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.find(L"字符串", 5) == yggr::utf8_string::npos);
#else
		...
		yggr_test_assert(str.find(sstr, 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find("字符串", 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}
...
#else
        yggr::utf8_string sstr("tf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
#endif // YGGR_NO_CWCHAR
	...
	// rfind
	{
		...
		yggr_test_assert(str.rfind(L'字', 3) == yggr::utf8_string::npos);
		yggr_test_assert(str.rfind(yggr::utf8_char(L'字')) == 4);
		yggr_test_assert(str.rfind(yggr::utf8_char(L'字'), 3) == yggr::utf8_string::npos);
#else
        yggr_test_assert(str.rfind("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.rfind("字", 3, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.rfind(yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 4);
		yggr_test_assert(str.rfind(yggr::utf8_char("字", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 3) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.rfind(L"字符串", 3) == yggr::utf8_string::npos);
#else
        yggr::string sstr("字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		...
		yggr_test_assert(str.rfind(sstr, 3, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.rfind("字符串", 3, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}
	...
	// find_first_of
	{
		...
		yggr_test_assert(str.find_first_of(L'字', 5) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_first_of(L"字abc",5) == yggr::utf8_string::npos);
#else
		...
		yggr_test_assert(str.find_first_of("字", 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of('a') == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.find_first_of("abc") == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		...
		yggr_test_assert(str.find_first_of("字abc",5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}

	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_first_of(yggr::utf8_string(L"字abc")) == 4);
		yggr_test_assert(str.find_first_of(yggr::utf8_string(L"abc")) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of(yggr::utf8_string(L"字abc"), 1) == 4);
		yggr_test_assert(str.find_first_of(yggr::utf8_string(L"字abc"),5) == yggr::utf8_string::npos);
#else
        yggr_test_assert(str.find_first_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 4);
		yggr_test_assert(str.find_first_of(yggr::utf8_string("abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == 4);
		yggr_test_assert(str.find_first_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()),5) == yggr::utf8_string::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.find_first_not_of("字abc") == 0);
		...
		yggr_test_assert(str.find_first_not_of(L"utf8字符串", 1) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_first_not_of("utf8字符串", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
...
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"字abc")) == 0);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"abc")) == 0);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"字abc"), 1) == 1);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"字abc"),5) == 5);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string(L"utf8字符串"), 1) == yggr::utf8_string::npos);
...
#else
        yggr_test_assert(str.find_first_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string("abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == 1);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()),5) == 5);
		yggr_test_assert(str.find_first_not_of(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == yggr::utf8_string::npos);
	...
	// find_last_of
	{
		...
		yggr_test_assert(str.find_last_of(L'字', 1) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_last_of(L"字abc", 1) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_last_of("字", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_last_of("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.find_last_of("abc") == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of("字abc", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
	...
	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_last_of(yggr::utf8_string(L"字abc")) == 4);
		yggr_test_assert(str.find_last_of(yggr::utf8_string(L"abc")) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string(L"字abc"), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string(L"字abc"),5) == 4);
#else
        yggr_test_assert(str.find_last_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 4);
		yggr_test_assert(str.find_last_of(yggr::utf8_string("abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()),5) == 4);
#endif // YGGR_NO_CWCHAR
...
//#ifndef YGGR_NO_CWCHAR
#ifndef _MSC_VER
		//string_view
		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc")) == 4);
		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"abc")) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"abc"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"字abc"))) == 4);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"abc"))) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc"), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc"), 5) == 4);

		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc"), 1, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::wstring_view(L"字abc"), 5, YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 4);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"字abc")), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"字abc")), 5) == 4);

		// utf8_string_view
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc"))) == 4);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"abc"))) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		...
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"字abc")))) == 4);
		...
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc")), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc")), 5) == 4);

		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc")), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string(L"字abc")), 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"字abc"))), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"字abc"))), 5) == 4);

#else
		// string_view
		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		yggr_test_assert(str.find_last_of(yggr::string_view("abc"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), YGGR_STR_UTF8_STRING_CHARSET_NAME()()) == 4);
		yggr_test_assert(str.find_last_of(yggr::string_view("abc"), YGGR_STR_UTF8_STRING_CHARSET_NAME()()) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::string_view("字abc"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 4);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::string_view("abc"))) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);

		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::string_view("字abc"), 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::string_view("字abc")), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::string_view("字abc")), 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);

		// utf8_string_view
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == 4);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("abc"))) == yggr::utf8_string::npos);

		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);
		...
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())))) == 4);
		...
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 5) == 4);

		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())), 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 4);

		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()))), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()))), 5) == 4);
	...
	// find_last_not_of
	{
		...
		yggr_test_assert(str.find_last_not_of(L"utf8字符串", 1) == yggr::utf8_string::npos);
		...
		yggr_test_assert(str.find_last_not_of("utf8字符串", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()) == yggr::utf8_string::npos);
	...
	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"字abc")) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"abc")) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"字abc"), 1) == 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"字abc"),5) == 5);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string(L"utf8字符串"), 1) == yggr::utf8_string::npos);
...
#else
        yggr_test_assert(str.find_last_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string("abc", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == 1);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string("字abc", YGGR_STR_UTF8_STRING_CHARSET_NAME()),5) == 5);
		yggr_test_assert(str.find_last_not_of(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1) == yggr::utf8_string::npos);
	...
	// compare_eq
	{
		...
		yggr_test_assert(str.compare_eq(std::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(str.compare_eq(std::string("")) == false);
		yggr_test_assert(str.compare_eq(std::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		...
		yggr_test_assert(str.compare_eq(boost::container::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(str.compare_eq(boost::container::string("")) == false);
		yggr_test_assert(str.compare_eq(boost::container::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);

		// yggr::string
		yggr_test_assert(str.compare_eq(yggr::string("utf8")) == false);
		yggr_test_assert(str.compare_eq(yggr::string("utf8_string")) == false);
		yggr_test_assert(str.compare_eq(yggr::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(str.compare_eq(yggr::string("")) == false);
		yggr_test_assert(str.compare_eq(yggr::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string("")) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(str.compare_eq(yggr::string_view("")) == false);
		yggr_test_assert(str.compare_eq(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string(""))) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == true);
		...
		yggr_test_assert(str.compare_eq(std::wstring(L"utf8字符串长")) == false);
		yggr_test_assert(str.compare_eq(std::wstring(L"")) == false);
		yggr_test_assert(str.compare_eq(std::wstring(L"utf8字符串")) == true);
		...
		yggr_test_assert(str.compare_eq(boost::container::wstring(L"utf8字符串长")) == false);
		yggr_test_assert(str.compare_eq(boost::container::wstring(L"")) == false);
		yggr_test_assert(str.compare_eq(boost::container::wstring(L"utf8字符串")) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::wstring(L"utf8字符串长")) == false);
		yggr_test_assert(str.compare_eq(yggr::wstring(L"")) == false);
		yggr_test_assert(str.compare_eq(yggr::wstring(L"utf8字符串")) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::wstring_view(L"utf8字符串长")) == false);
		yggr_test_assert(str.compare_eq(yggr::wstring_view(L"")) == false);
		yggr_test_assert(str.compare_eq(yggr::wstring_view(L"utf8字符串")) == true);
		...
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长"))) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string(L""))) == false);
		yggr_test_assert(str.compare_eq(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串"))) == true);
		...
		yggr_test_assert(str.compare_eq(4, 2, yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == true);
		yggr_test_assert(str.compare_eq(4, 2, yggr::utf8_string(L"字符")) == true);

		yggr_test_assert(str.compare_eq(4, 2, yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == false);
		yggr_test_assert(str.compare_eq(4, 2, yggr::wstring(L"字符长")) == false);

		yggr_test_assert(str.compare_eq(4, 3, yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == false);
		yggr_test_assert(str.compare_eq(4, 3, yggr::utf8_string(L"字符")) == false);
#else
        yggr_test_assert(str.compare_eq(4, 2, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		yggr_test_assert(str.compare_eq(4, 2, yggr::string("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
	...
	// compare
	{
		...
		yggr_test_assert(str.compare(4, 2, yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		yggr_test_assert(str.compare(4, 2, yggr::utf8_string(L"字符")) == 0);

		yggr_test_assert(str.compare(4, 2, yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		yggr_test_assert(str.compare(4, 2, yggr::wstring(L"字符长")) < 0);

		yggr_test_assert(str.compare(4, 3, yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) > 0);
		yggr_test_assert(str.compare(4, 3, yggr::utf8_string(L"字符")) > 0);
#else
        yggr_test_assert(str.compare(4, 2, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		yggr_test_assert(str.compare(4, 2, yggr::string("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		//string_view
		{
			...
			yggr_test_assert(str.compare(yggr::wstring_view(L"utf8字符串长")) < 0);
			yggr_test_assert(str.compare(yggr::wstring_view(L"")) > 0);
			yggr_test_assert(str.compare(yggr::wstring_view(L"utf8字符串")) == 0);
			...
			yggr_test_assert(str.compare(yggr::wstring_view(L"utf8字符串长"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(yggr::wstring_view(L""), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) > 0);
			yggr_test_assert(str.compare(yggr::wstring_view(L"utf8字符串"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 0);

			yggr_test_assert(str.compare(4, 2, yggr::wstring_view(L"字符")) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::wstring_view(L"字符长")) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::wstring_view(L"字符")) > 0);

			yggr_test_assert(str.compare(4, 2, yggr::wstring_view(L"字符"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::wstring_view(L"字符长"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::wstring_view(L"字符"), YGGR_SYS_DEFAULT_WSTRING_CHARSET_NAME()) > 0);
			...
			yggr_test_assert(str.compare(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(yggr::string_view("")) > 0);
			yggr_test_assert(str.compare(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
			...
			yggr_test_assert(str.compare(4, 2, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::string_view("字符长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
		...
		//utf8_string
		{
			...
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长"))) < 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L""))) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串"))) == 0);
			...
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L"")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);

			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符长"))) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) > 0);

			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符长")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string(L"字符")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
			...
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) < 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string(""))) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == 0);

			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8_string", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("")), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
			yggr_test_assert(str.compare(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);

			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) > 0);

			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
			yggr_test_assert(str.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
			yggr_test_assert(str.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
...
void non_member_foo_test(void)
{
	// operator +
	{
		...
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + str << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + cref_str << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + str + yggr::string("aaa") << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::string_view("aaa") << std::endl;

		std::cout << yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::utf8_string("aaa") << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::charset::make_string_charset_helper(yggr::string_view("aaa")) << std::endl;
		std::cout << yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::utf8_string("aaa") << std::endl;
		...
		std::cout << yggr::wstring_view(L"utf8字符") + yggr::utf8_string("aaa") << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::wstring_view(L"aaa") << std::endl;
		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::charset::make_string_charset_helper(yggr::wstring_view(L"aaa")) << std::endl;
		std::cout << yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符")) + yggr::utf8_string("aaa") << std::endl;

#endif // YGGR_NO_CWCHAR

		std::cout << yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) + yggr::utf8_string_view("aaa") << std::endl;
		std::cout << yggr::utf8_string_view(yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) + yggr::utf8_string("aaa") << std::endl;
	}
	...
	// operator +=
	{
...

		{
			...
			rst_str += str;
			yggr_test_assert(rst_str == yggr::utf8_string("operaotr+= utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		...
		// string_view
		{
			...
			yggr_test_assert(rst_str == yggr::utf8_string("utf8字符串 operaotr+=", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
			std::cout << rst_str << std::endl;
		}
...
#ifndef YGGR_NO_CWCHAR
		{
			...
			rst_wstr += str;
			yggr_test_assert(rst_wstr == L"operaotr+= utf8字符串");
		...
		// string_view
		{
			...
			yggr_test_assert(rst_str == L"utf8字符串 operaotr+=");
			std::cout << rst_str << std::endl;
		}
	...
	// operator ==
	{
	    ...
	    yggr_test_assert(str == yggr::charset::make_string_charset_helper("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(yggr::charset::make_string_charset_helper("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == str);
		...
		yggr_test_assert(str == yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == str);
		...
		yggr_test_assert(str == yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == str);

		yggr_test_assert(str == yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()))));
		yggr_test_assert(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == str);
		...
		yggr_test_assert(str == yggr::utf8_string(L"utf8字符串"));
		yggr_test_assert(yggr::utf8_string(L"utf8字符串") == str);

		yggr_test_assert(str == yggr::wstring_view(L"utf8字符串"));
		yggr_test_assert(yggr::wstring_view(L"utf8字符串") == str);

		yggr_test_assert(str == yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串")));
		yggr_test_assert(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串")) == str);
	...
	// operator <
	{
		...
		yggr_test_assert(str < yggr::charset::make_string_charset_helper("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(str < yggr::charset::make_string_charset_helper(yggr::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()));
        yggr_test_assert("" < str );

        yggr_test_assert(!(yggr::charset::make_string_charset_helper("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()) < str));
        yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < str));

        yggr_test_assert(str < yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()));

        yggr_test_assert(str < yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < str));

		yggr_test_assert(str < yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长")));
		yggr_test_assert(!(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长")) < str));

		yggr_test_assert(str < yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长"))));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符串长"))) < str));
		...
		yggr_test_assert(!(yggr::utf8_string(L"utf8字符串长") < str));
		yggr_test_assert(str < yggr::wstring_view(L"utf8字符串长"));
		yggr_test_assert(!(yggr::wstring_view(L"utf8字符串长") < str));

		yggr_test_assert(str < yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串长")));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串长")) < str));
	...
	// operator <=
	{
		...
		yggr_test_assert(str <= yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(!(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) <= str));

		yggr_test_assert(str <= yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) <= str));
	...
	// operator >
	{
		...
		yggr_test_assert(str > yggr::charset::make_string_charset_helper("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(str > yggr::charset::make_string_charset_helper(yggr::string("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(str > "" );

		yggr_test_assert(!(yggr::charset::make_string_charset_helper("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) > str));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::string("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > str));

		yggr_test_assert(str > yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()));

		yggr_test_assert(str > yggr::utf8_string_view(yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(!(yggr::utf8_string_view(yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) > str));

		yggr_test_assert(str > yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string("utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) > str));
		...
		yggr_test_assert(!(yggr::utf8_string(L"utf8字符") > str));
		yggr_test_assert(!(yggr::wstring_view(L"utf8字符") > str));

		yggr_test_assert(str > yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符")));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符")) > str));

		yggr_test_assert(str > yggr::utf8_string_view(yggr::utf8_string(L"utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(!(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) > str));

		yggr_test_assert(str > yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符"))));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符"))) > str));
	...
	// operator >=
	{
		...
		yggr_test_assert(str >= yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(!(yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) >= str));
		...
		yggr_test_assert(str >= yggr::utf8_string_view(yggr::utf8_string(L"utf8字符")));
		yggr_test_assert(!(yggr::utf8_string_view(yggr::utf8_string(L"utf8字符")) >= str));
