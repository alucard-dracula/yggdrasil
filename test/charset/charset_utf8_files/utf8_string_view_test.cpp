...
void test_construct(void)
{
	...
	{
		yggr::charset::utf8_string org("abcde你好", YGGR_STR_INNER_STRING_CHARSET_NAME());
	...
	//{
	//	// failed init
	//	yggr::charset::string org = "abcde你好";
	//	yggr::charset::utf8_string_view nsv(org.begin(), org.end());
	//	std::cout << nsv << std::endl;
	//	yggr_test_assert(nsv.empty());
	//}
	...
	//{
	//	// failed init
	//	yggr::charset::string_view org("abcde你好");
	//	yggr::charset::utf8_string_view nsv(org);
	//	std::cout << nsv << std::endl;
	//	yggr_test_assert(nsv.empty());
	//}
	...
	{
		yggr::charset::utf8_string org_0("abcde你好", YGGR_STR_INNER_STRING_CHARSET_NAME());
...
void test_set_and_swap(void)
{
	...
	{
		yggr::charset::utf8_string org0("abcde你好", YGGR_STR_INNER_STRING_CHARSET_NAME());
	...
	// swap
	{
		yggr::charset::utf8_string org0("abcde你好0", YGGR_STR_INNER_STRING_CHARSET_NAME());
		yggr::charset::utf8_string org1("abcde你好1", YGGR_STR_INNER_STRING_CHARSET_NAME());
...
void test_iterators(void)
{
...

	{
		...
		yggr_test_assert(*nsv.rbegin() == yggr::charset::utf8_char("好", YGGR_STR_INNER_STRING_CHARSET_NAME()));
		yggr_test_assert(*yggr::advance_copy(nsv.rbegin(), 1) == yggr::charset::utf8_char("你", YGGR_STR_INNER_STRING_CHARSET_NAME()));
		yggr_test_assert(std::distance(nsv.rbegin(), nsv.rend()) == nsv.length());
		yggr_test_assert(std::distance(
				org_riter_type(nsv.rbegin().base().org()),
				org_riter_type(nsv.rend().base().org())) == nsv.size());
		...
		yggr_test_assert(*nsv.crbegin() == yggr::charset::utf8_char("好", YGGR_STR_INNER_STRING_CHARSET_NAME()));
		yggr_test_assert(std::distance(nsv.crbegin(), nsv.crend()) == nsv.length());
		yggr_test_assert(std::distance(
				org_criter_type(nsv.crbegin().base().org()),
				org_criter_type(nsv.crend().base().org())) == nsv.size());
...
void test_element_access(void)
{
...

	{
		...
		//yggr_test_assert(nsv[nsv.length() - 1] == '好'); // don't using '你' != "你"
		yggr_test_assert(nsv[nsv.length() - 1] == yggr::charset::utf8_char("好", YGGR_STR_INNER_STRING_CHARSET_NAME()));
		yggr_test_assert(nsv[nsv.length() - 2] == yggr::charset::utf8_char("你", YGGR_STR_INNER_STRING_CHARSET_NAME()));

		yggr_test_assert(nsv.at(0) == 'a');
		yggr_test_assert(nsv.at(1) == 'b');

		yggr_test_assert(nsv.at(nsv.length() - 1) == yggr::charset::utf8_char("好", YGGR_STR_INNER_STRING_CHARSET_NAME()));
		yggr_test_assert(nsv.at(nsv.length() - 2) == yggr::charset::utf8_char("你", YGGR_STR_INNER_STRING_CHARSET_NAME()));
...
void test_operations_copy(void)
{
...

	{
		wchar_t str[1024] = {0};
		yggr::charset::utf8_string_view::size_type ret = 0;
		yggr::charset::utf8_string org( L"你好吗");
		yggr::charset::utf8_string_view nsv(org);

		ret = nsv.copy(str, nsv.npos);
		yggr_test_assert(ret == 3);
		str[ret] = 0;
		yggr_test_assert(0 == memcmp(str, L"你好吗", ret * sizeof(wchar_t)));
...
void test_operations_substr(void)
{
...

	{
		...
		yggr_test_assert((nsv.substr<yggr::string>() == org.str<yggr::string>()));
		yggr_test_assert((nsv.substr<yggr::string>(0, -1, yggr::charset::charset_name_t<yggr::string>()) == org.str<yggr::string>()));
		std::cout << nsv.substr<yggr::string>() << std::endl;
	}
	...
	{
		yggr::charset::utf8_string org("abcde你好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::charset::utf8_string_view nsv(org);
		std::cout << nsv << std::endl;

		yggr_test_assert(0 == nsv.substr(1, 5).compare("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(0 == nsv.substr(1, 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()).compare("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		std::cout <<  nsv.substr(1, 5) << std::endl;

		yggr_test_assert((0 == nsv.substr<yggr::utf8_string_view>(1, 5).compare("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert((0 == nsv.substr<yggr::utf8_string_view>(1, 5, YGGR_STR_UTF8_STRING_CHARSET_NAME()).compare("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		...
		yggr_test_assert((nsv.substr<yggr::string>(1, 5) == yggr::utf8_string("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert((nsv.substr<yggr::string>(1, 5, yggr::charset::charset_name_t<yggr::string>()) == yggr::utf8_string("bcde你", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
...
void test_operations_compare(void)
{
	...
	// compare_eq
	{
		yggr::utf8_string org("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		...
		yggr_test_assert(nsv.compare_eq("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(nsv.compare_eq("") == false);
		yggr_test_assert(nsv.compare_eq("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		yggr_test_assert(nsv.compare_eq("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		yggr_test_assert(nsv.compare_eq(
				yggr::charset::make_string_charset_helper(
					"utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == true);
		...
		yggr_test_assert(nsv.compare_eq(L"utf8字符串长") == false);
		yggr_test_assert(nsv.compare_eq(L"") == false);
		yggr_test_assert(nsv.compare_eq(L"utf8字符串") == true);
		yggr_test_assert(nsv.compare_eq(L"utf8字符串", yggr::charset::charset_name_t<wchar_t>()) == true);
		yggr_test_assert(nsv.compare_eq(
				yggr::charset::make_string_charset_helper(
					L"utf8字符串", yggr::charset::charset_name_t<wchar_t>())) == true);
#else
        yggr_test_assert(nsv.compare_eq("utf8") == false );
		...
		yggr_test_assert(nsv.compare_eq(0, nsv.length(), L"utf8字符串长长长", 0, 8) == false);
		yggr_test_assert(nsv.compare_eq(0, nsv.length(), L"utf8", 0, 0) == false);
		yggr_test_assert(nsv.compare_eq(0, nsv.length(), L"长utf8字符串长长", 1, 7) == true);

		try
		{
			nsv.compare_eq(nsv.length() + 1, -1, L"长utf8字符串长长", 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
        ...
        yggr_test_assert(nsv.compare_eq(4, 2, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == true);
		...
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					"字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == true);
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == true);

		yggr_test_assert(nsv.compare_eq(4, 2, "字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::string_view("字符长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		...
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					"字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == false);
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::string_view("字符长"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == false);

		yggr_test_assert(nsv.compare_eq(4, 3, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);
		yggr_test_assert(nsv.compare_eq(4, 3, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == false);

		yggr_test_assert(nsv.compare_eq(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == true);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == false);
		yggr_test_assert(nsv.compare_eq(4, 3, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == false);

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(nsv.compare_eq(4, 2, L"字符") == true);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::wstring_view(L"字符")) == true);

		yggr_test_assert(nsv.compare_eq(4, 2, L"字符", yggr::charset::charset_name_t<wchar_t>()) == true);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::wstring_view(L"字符"), yggr::charset::charset_name_t<yggr::wstring_view>()) == true);

		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					L"字符", yggr::charset::charset_name_t<wchar_t>())) == true);
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::wstring_view(L"字符"), yggr::charset::charset_name_t<yggr::wstring_view>())) == true);

		yggr_test_assert(nsv.compare_eq(4, 2, L"字符长") == false);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::wstring_view(L"字符长")) == false);

		yggr_test_assert(nsv.compare_eq(4, 2, L"字符长", yggr::charset::charset_name_t<wchar_t>()) == false);
		yggr_test_assert(nsv.compare_eq(4, 2, yggr::wstring_view(L"字符长"), yggr::charset::charset_name_t<wchar_t>()) == false);

		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					L"字符长", yggr::charset::charset_name_t<wchar_t>())) == false);
		yggr_test_assert(nsv.compare_eq(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::wstring_view(L"字符长"), yggr::charset::charset_name_t<wchar_t>())) == false);


		yggr_test_assert(nsv.compare_eq(4, 3, L"字符") == false);
		yggr_test_assert(nsv.compare_eq(4, 3, yggr::wstring_view(L"字符")) == false);

		yggr_test_assert(nsv.compare_eq(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) == true);

		yggr_test_assert(nsv.compare_eq(4, 2, yggr::wstring_view(L"字符长")) == false);

		yggr_test_assert(nsv.compare_eq(4, 3, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) == false);

		try
		{
			nsv.compare_eq(nsv.length(), 3, yggr::utf8_string_view(yggr::utf8_string(L"字符")));
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
	...
	// compare
	{
		...
		yggr_test_assert(nsv.compare("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare("") > 0);
		yggr_test_assert(nsv.compare("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper("", YGGR_STR_UTF8_STRING_CHARSET_NAME())) > 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);

		// std::string
		yggr_test_assert(nsv.compare(std::string("utf8")) > 0);
		yggr_test_assert(nsv.compare(std::string("utf8_string")) > 0);
		yggr_test_assert(nsv.compare(std::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare(std::string("")) > 0);
		yggr_test_assert(nsv.compare(std::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::string(""), YGGR_STR_UTF8_STRING_CHARSET_NAME())) > 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		...
		yggr_test_assert(nsv.compare(boost::container::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare(boost::container::string("")) > 0);
		yggr_test_assert(nsv.compare(boost::container::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(boost::container::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(boost::container::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);

		// yggr::string
		yggr_test_assert(nsv.compare(yggr::string("utf8")) > 0);
		yggr_test_assert(nsv.compare(yggr::string("utf8_string")) > 0);
		yggr_test_assert(nsv.compare(yggr::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare(yggr::string("")) > 0);
		yggr_test_assert(nsv.compare(yggr::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::string("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::string(""), YGGR_STR_UTF8_STRING_CHARSET_NAME())) > 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::string("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);

		// yggr::string_view
		yggr_test_assert(nsv.compare(yggr::string_view("utf8")) > 0);
		yggr_test_assert(nsv.compare(yggr::string_view("utf8_string")) > 0);
		yggr_test_assert(nsv.compare(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare(yggr::string_view("")) > 0);
		yggr_test_assert(nsv.compare(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串长"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::string_view("utf8字符串"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);

		// yggr::utf8_string
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8")) > 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8_string")) > 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME())) < 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string("")) > 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()), yggr::charset::charset_name_t<yggr::utf8_string>()) < 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string(""), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
		yggr_test_assert(nsv.compare(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()), yggr::charset::charset_name_t<yggr::utf8_string>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::utf8_string("utf8字符串长", YGGR_STR_UTF8_STRING_CHARSET_NAME()), yggr::charset::charset_name_t<yggr::utf8_string>())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::utf8_string("utf8字符串", YGGR_STR_UTF8_STRING_CHARSET_NAME()), yggr::charset::charset_name_t<yggr::utf8_string>())) == 0);

#ifndef YGGR_NO_CWCHAR
		// const char*
		yggr_test_assert(nsv.compare(L"utf8") > 0);
		yggr_test_assert(nsv.compare(L"utf8_string") > 0);
		yggr_test_assert(nsv.compare(L"utf8字符串长") < 0);
		yggr_test_assert(nsv.compare(L"") > 0);
		yggr_test_assert(nsv.compare(L"utf8字符串") == 0);
		...
		yggr_test_assert(nsv.compare(L"utf8字符串长", yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(L"", yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(L"utf8字符串", yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(L"utf8字符串长", yggr::charset::charset_name_t<wchar_t>())) < 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(L"", yggr::charset::charset_name_t<wchar_t>())) > 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(L"utf8字符串", yggr::charset::charset_name_t<wchar_t>())) == 0);

		// std::string
		yggr_test_assert(nsv.compare(std::wstring(L"utf8")) > 0);
		yggr_test_assert(nsv.compare(std::wstring(L"utf8_string")) > 0);
		yggr_test_assert(nsv.compare(std::wstring(L"utf8字符串长")) < 0);
		yggr_test_assert(nsv.compare(std::wstring(L"")) > 0);
		yggr_test_assert(nsv.compare(std::wstring(L"utf8字符串")) == 0);
		...
		yggr_test_assert(nsv.compare(std::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(std::wstring(L""), yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(std::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>())) < 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::wstring(L""), yggr::charset::charset_name_t<wchar_t>())) > 0);
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(std::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>())) == 0);
		...
		yggr_test_assert(nsv.compare(boost::container::wstring(L"utf8字符串长")) < 0);
		yggr_test_assert(nsv.compare(boost::container::wstring(L"")) > 0);
		yggr_test_assert(nsv.compare(boost::container::wstring(L"utf8字符串")) == 0);
		...
		yggr_test_assert(nsv.compare(boost::container::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(boost::container::wstring(L""), yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(boost::container::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(boost::container::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(boost::container::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>())) == 0);

		// yggr::string
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8_string")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8字符串长")) < 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L"")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8字符串")) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L""), yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::wstring(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::wstring(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>())) == 0);

		// yggr::string_view
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8_string")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8字符串长")) < 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"")) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8字符串")) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L""), yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(yggr::wstring_view(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串长"), yggr::charset::charset_name_t<wchar_t>())) < 0);
		...
		yggr_test_assert(nsv.compare(yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串"), yggr::charset::charset_name_t<wchar_t>())) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), L"utf8字符串长长长", 0, 8) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), L"utf8", 0, 0) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), L"长utf8字符串长长", 1, 7) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), L"utf8字符串长长长", 0, 8, yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), L"utf8", 0, 0, yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), L"长utf8字符串长长", 1, 7, yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(L"utf8字符串长长长", yggr::charset::charset_name_t<wchar_t>()),
				0, 8) < 0);
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(L"utf8", yggr::charset::charset_name_t<wchar_t>()),
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(L"长utf8字符串长长", yggr::charset::charset_name_t<wchar_t>()),
				1, 7) == 0);

		try
		{
			nsv.compare(nsv.length() + 1, -1, L"长utf8字符串长长", 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(nsv.length() + 1, -1, L"长utf8字符串长长", 1, 7, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length() + 1, -1,
				yggr::charset::make_string_charset_helper(
					L"长utf8字符串长长", yggr::charset::charset_name_t<wchar_t>()),
				1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"utf8字符串长长长"), 0, 8) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"utf8"), 0, 0) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"长utf8字符串长长"), 1, 7) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"utf8字符串长长长"), 0, 8, yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"utf8"), 0, 0, yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), std::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(std::wstring(L"utf8字符串长长长"), yggr::charset::charset_name_t<wchar_t>()),
				0, 8) < 0);
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(std::wstring(L"utf8"), yggr::charset::charset_name_t<wchar_t>()),
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(std::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7) == 0);

		try
		{
			nsv.compare(nsv.length() + 1, -1, std::wstring(L"长utf8字符串长长"), 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(nsv.length() + 1, -1, std::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length() + 1, -1,
				yggr::charset::make_string_charset_helper(
					std::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"utf8字符串长长长"), 0, 8) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"utf8"), 0, 0) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"长utf8字符串长长"), 1, 7) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"utf8字符串长长长"), 0, 8, yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"utf8"), 0, 0, yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), boost::container::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(boost::container::wstring(L"utf8字符串长长长"), yggr::charset::charset_name_t<wchar_t>()),
				0, 8) < 0);
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(boost::container::wstring(L"utf8"), yggr::charset::charset_name_t<wchar_t>()),
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(boost::container::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7) == 0);

		try
		{
			nsv.compare(nsv.length() + 1, -1, boost::container::wstring(L"长utf8字符串长长"), 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(nsv.length() + 1, -1, boost::container::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length() + 1, -1,
				yggr::charset::make_string_charset_helper(
					boost::container::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"utf8字符串长长长"), 0, 8) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"utf8"), 0, 0) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"长utf8字符串长长"), 1, 7) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"utf8字符串长长长"), 0, 8, yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"utf8"), 0, 0, yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring(L"utf8字符串长长长"), yggr::charset::charset_name_t<wchar_t>()),
				0, 8) < 0);
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring(L"utf8"), yggr::charset::charset_name_t<wchar_t>()),
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7) == 0);

		try
		{
			nsv.compare(nsv.length() + 1, -1, yggr::wstring(L"长utf8字符串长长"), 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(nsv.length() + 1, -1, yggr::wstring(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length() + 1, -1,
				yggr::charset::make_string_charset_helper(
					yggr::wstring(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"utf8字符串长长长"), 0, 8) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"utf8"), 0, 0) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"长utf8字符串长长"), 1, 7) == 0);
		...
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"utf8字符串长长长"), 0, 8, yggr::charset::charset_name_t<wchar_t>()) < 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"utf8"), 0, 0, yggr::charset::charset_name_t<wchar_t>()) > 0);
		yggr_test_assert(nsv.compare(0, nsv.length(), yggr::wstring_view(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>()) == 0);
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8字符串长长长"), yggr::charset::charset_name_t<wchar_t>()),
				0, 8) < 0);
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring_view(L"utf8"), yggr::charset::charset_name_t<wchar_t>()),
		...
		yggr_test_assert(nsv.compare(
				0, nsv.length(),
				yggr::charset::make_string_charset_helper(yggr::wstring_view(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7) == 0);

		try
		{
			nsv.compare(nsv.length() + 1, -1, yggr::wstring_view(L"长utf8字符串长长"), 1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(nsv.length() + 1, -1, yggr::wstring_view(L"长utf8字符串长长"), 1, 7, yggr::charset::charset_name_t<wchar_t>());
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length() + 1, -1,
				yggr::charset::make_string_charset_helper(
					yggr::wstring_view(L"长utf8字符串长长"), yggr::charset::charset_name_t<wchar_t>()),
				1, 7);
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
        ...
        yggr_test_assert(nsv.compare(4, 2, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		yggr_test_assert(nsv.compare(4, 2, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) == 0);
		...
		yggr_test_assert(nsv.compare(
				4, 2,
				yggr::charset::make_string_charset_helper("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);
		yggr_test_assert(nsv.compare(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME())) == 0);

		yggr_test_assert(nsv.compare(4, 2, "字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);
		yggr_test_assert(nsv.compare(4, 2, yggr::string_view("字符长"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) < 0);

		yggr_test_assert(nsv.compare(4, 3, "字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);
		yggr_test_assert(nsv.compare(4, 3, yggr::string_view("字符"), YGGR_STR_UTF8_STRING_CHARSET_NAME()) > 0);

		yggr_test_assert(nsv.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) == 0);

		yggr_test_assert(nsv.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string("字符长", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) < 0);

		yggr_test_assert(nsv.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string("字符", YGGR_STR_UTF8_STRING_CHARSET_NAME()))) > 0);

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(nsv.compare(4, 2, L"字符") == 0);
		yggr_test_assert(nsv.compare(4, 2, yggr::wstring_view(L"字符")) == 0);

		yggr_test_assert(nsv.compare(4, 2, L"字符", yggr::charset::charset_name_t<wchar_t>()) == 0);
		yggr_test_assert(nsv.compare(4, 2, yggr::wstring_view(L"字符"), yggr::charset::charset_name_t<yggr::wstring_view>()) == 0);

		yggr_test_assert(nsv.compare(
				4, 2,
				yggr::charset::make_string_charset_helper(L"字符", yggr::charset::charset_name_t<wchar_t>())) == 0);
		yggr_test_assert(nsv.compare(
				4, 2,
				yggr::charset::make_string_charset_helper(
					yggr::wstring_view(L"字符"), yggr::charset::charset_name_t<yggr::wstring_view>())) == 0);

		yggr_test_assert(nsv.compare(4, 2, L"字符长") < 0);
		yggr_test_assert(nsv.compare(4, 2, yggr::wstring_view(L"字符长")) < 0);

		yggr_test_assert(nsv.compare(4, 3, L"字符") > 0);
		yggr_test_assert(nsv.compare(4, 3, yggr::wstring_view(L"字符")) > 0);

		yggr_test_assert(nsv.compare(4, 2, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) == 0);

		yggr_test_assert(nsv.compare(4, 2, yggr::wstring_view(L"字符长")) < 0);

		yggr_test_assert(nsv.compare(4, 3, yggr::utf8_string_view(yggr::utf8_string(L"字符"))) > 0);

		try
		{
			nsv.compare(nsv.length(), 3, yggr::utf8_string_view(yggr::utf8_string(L"字符")));
			yggr_test_assert(false);
		}
		catch(const std::out_of_range& e)
		{
		...
		try
		{
			nsv.compare(
				nsv.length(), 3,
				yggr::utf8_string_view(yggr::utf8_string(L"字符")),
...
void test_operations_starts_ends_with(void)
{
	...
	{
		yggr::utf8_string org("你abcde好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv(org);
		std::cout << nsv << std::endl;
...
void test_operations_contains(void)
{
	...
	{
		yggr::utf8_string org_t("你abcde好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv_t(org_t);

		yggr::utf8_string org_f("字fgh符", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::utf8_string_view nsv_f(org_f);
...
void test_operations_find(void)
{
	...
	{
		yggr::charset::utf8_string org("你abcde好", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::charset::utf8_string_view nsv(org);
		std::cout << nsv << std::endl;
		...
		yggr_test_assert(0 == nsv.find(yggr::charset::make_string_charset_helper("你", YGGR_STR_UTF8_STRING_CHARSET_NAME()),
                                        0, yggr::charset::charset_base_foo::strlen("你")));
		yggr_test_assert(0 == nsv.find("", 0, 0));
		...
		yggr_test_assert(0 == nsv.find(
						yggr::charset::make_string_charset_helper(
							"你", YGGR_STR_UTF8_STRING_CHARSET_NAME()),
						0, yggr::charset::charset_base_foo::strlen("你")));
		yggr_test_assert(0 == nsv.find(yggr::charset::make_string_charset_helper("", yggr::charset::charset_name_t<char>()), 0, 0));


#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(0 == nsv.find(L"你", 0, yggr::charset::charset_base_foo::strlen(L"你")));
		yggr_test_assert(0 == nsv.find(L"", 0, 0));

		yggr_test_assert(0 == nsv.find(L"你", 0, yggr::charset::charset_base_foo::strlen(L"你"), yggr::charset::charset_name_t<wchar_t>()));
		yggr_test_assert(0 == nsv.find(L"", 0, 0, yggr::charset::charset_name_t<wchar_t>()));

		yggr_test_assert(0 == nsv.find(
						yggr::charset::make_string_charset_helper(
							L"你", yggr::charset::charset_name_t<wchar_t>()),
						0, yggr::charset::charset_base_foo::strlen(L"你")));
...
void test_operations_find_first_of(void)
{
...

	{
		...
		// inline size_type find_first_of(const this_type& right, size_type pos = 0) const YGGR_NOEXCEPT_OR_NOTHROW
		yggr_test_assert(0 == nsv.find_first_of("你ace", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		...
		yggr_test_assert(0 == nsv.find_first_of(
						yggr::charset::make_string_charset_helper(
							"你ace", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(2 == nsv.find_first_of(
						yggr::charset::make_string_charset_helper(
							"bce", yggr::charset::charset_name_t<char>())));

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(0 == nsv.find_first_of(L"你ace"));
		yggr_test_assert(2 == nsv.find_first_of(L"bce"));

		yggr_test_assert(0 == nsv.find_first_of(L"你ace", yggr::charset::charset_name_t<wchar_t>()));
		yggr_test_assert(2 == nsv.find_first_of(L"bce", yggr::charset::charset_name_t<wchar_t>()));

		yggr_test_assert(0 == nsv.find_first_of(
						yggr::charset::make_string_charset_helper(
							L"你ace", yggr::charset::charset_name_t<wchar_t>())));
		yggr_test_assert(2 == nsv.find_first_of(
						yggr::charset::make_string_charset_helper(
		...
		yggr_test_assert(2 == nsv.find_first_of("你bce", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(2 == nsv.find_first_of("你bce", 1, YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(2 == nsv.find_first_of(yggr::charset::make_string_charset_helper("你bce", YGGR_STR_UTF8_STRING_CHARSET_NAME()), 1));

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(2 == nsv.find_first_of(L"你bce", 1));
		yggr_test_assert(2 == nsv.find_first_of(L"你bce", 1, yggr::charset::charset_name_t<wchar_t>()));
		yggr_test_assert(2 == nsv.find_first_of(
						yggr::charset::make_string_charset_helper(
							L"你bce", yggr::charset::charset_name_t<wchar_t>()), 1));
#endif // YGGR_NO_CWCHAR
...
void test_operations_find_last_of(void)
{
...

	{
		...
		// inline size_type find_last_of(const this_type& right, size_type pos = 0) const YGGR_NOEXCEPT_OR_NOTHROW
		yggr_test_assert(6 == nsv.find_last_of("ace好", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(6 == nsv.find_last_of("ce好", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		...
		yggr_test_assert(6 == nsv.find_last_of(
						yggr::charset::make_string_charset_helper(
							"ace好", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(6 == nsv.find_last_of(
						yggr::charset::make_string_charset_helper(
							"ce好", YGGR_STR_UTF8_STRING_CHARSET_NAME())));

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(6 == nsv.find_last_of(L"ace好", yggr::charset::charset_name_t<wchar_t>()));
		yggr_test_assert(6 == nsv.find_last_of(L"ce好", yggr::charset::charset_name_t<wchar_t>()));

		yggr_test_assert(6 == nsv.find_last_of(
						yggr::charset::make_string_charset_helper(
							L"ace好", yggr::charset::charset_name_t<wchar_t>())));
		yggr_test_assert(6 == nsv.find_last_of(
						yggr::charset::make_string_charset_helper(
							L"ce好", yggr::charset::charset_name_t<wchar_t>())));
#endif // YGGR_NO_CWCHAR
...
void test_operations_find_first_not_of(void)
{
...

	{
		...
		// inline size_type find_first_not_of(const this_type& right, size_type pos = 0) const YGGR_NOEXCEPT_OR_NOTHROW
		yggr_test_assert(1 == nsv.find_first_not_of("你ce", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(0 == nsv.find_first_not_of("ce"));

		yggr_test_assert(1 == nsv.find_first_not_of("你ce", YGGR_STR_UTF8_STRING_CHARSET_NAME()));
		yggr_test_assert(0 == nsv.find_first_not_of("ce", yggr::charset::charset_name_t<char>()));

		yggr_test_assert(1 == nsv.find_first_not_of(yggr::charset::make_string_charset_helper("你ce", YGGR_STR_UTF8_STRING_CHARSET_NAME())));
		yggr_test_assert(0 == nsv.find_first_not_of(yggr::charset::make_string_charset_helper("ce", yggr::charset::charset_name_t<char>())));

#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(1 == nsv.find_first_not_of(L"你ce"));
		yggr_test_assert(0 == nsv.find_first_not_of(L"ce"));

		yggr_test_assert(1 == nsv.find_first_not_of(L"你ce", yggr::charset::charset_name_t<wchar_t>()));
		yggr_test_assert(0 == nsv.find_first_not_of(L"ce", yggr::charset::charset_name_t<wchar_t>()));

		yggr_test_assert(1 == nsv.find_first_not_of(yggr::charset::make_string_charset_helper(L"你ce", yggr::charset::charset_name_t<wchar_t>())));
...

	{
		...
		if(yggr::charset::charset_name_t<char>() != yggr::charset::charset_name_t<yggr::utf8_string>())
         ...
         else
         {
             ...
             yggr_test_assert(0 == nsv.find_last_not_of(
						nsv.substr(1).data(), 0, nsv.substr(1).size()));
         }
...
void test_str(void)
{
	...
	{
		yggr::charset::utf8_string org("你ab好cde吗", YGGR_STR_UTF8_STRING_CHARSET_NAME());
		yggr::charset::utf8_string_view nsv(org);
		std::cout << nsv << std::endl;
