...
{
    yggr::utf8_string tmp_a("你好abc", YGGR_STR_UTF8_STRING_CHARSET_NAME());
	boost::container::string a = tmp_a.str<boost::container::string>();
...
{
	yggr::utf8_string a("你好abc", YGGR_STR_UTF8_STRING_CHARSET_NAME());
