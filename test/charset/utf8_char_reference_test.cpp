...
void test_utf8_char_reference(void)
{
	...
	// hello world
	{
		...
		char_ref_type ch1_ref = ch1;
		char_ref_type ch2_ref = ch2;
		yggr_test_assert(ch1_ref == L"Äã");
		yggr_test_assert(ch2_ref == L"ºÃ");
	...
	// operator=
	{
		...
		char_ref_type ch_ref(ch, 0);
		ch_ref = L'ºÃ';
		yggr_test_assert(ch_ref == L"ºÃ");
		yggr_test_assert(ch == L"ºÃ");

		ch_ref = yggr::charset::make_string_charset_helper(L'Âğ');
		yggr_test_assert(ch_ref == L"Âğ");
		yggr_test_assert(ch == L"Âğ");
	}
...

	{
		char_type ch = L"Äã";
		char_ref_type ch_ref(ch, 0);
		ch_ref = std::wstring(L"ºÃ");
		yggr_test_assert(ch_ref == L"ºÃ");
		yggr_test_assert(ch == L"ºÃ");

		ch_ref = yggr::wstring(L"Âğ");
		yggr_test_assert(ch_ref == L"Âğ");
		yggr_test_assert(ch == L"Âğ");
...

	{
		...
		ch1 = ch1;
		yggr_test_assert(ch1 == L"Äã");

		ch1 = ch2;
		yggr_test_assert(ch2 == L"ºÃ");

		ch1 = yggr::charset::make_string_charset_helper(ch3_ref);
		yggr_test_assert(ch1 == L"Âğ");
	}
	...
	// swap
	{
		...
		yggr::swap(ch1_ref, ch2_ref);
		yggr_test_assert(ch1_ref == L"ºÃ");
		yggr_test_assert(ch1 == L"ºÃ");

		yggr_test_assert(ch2_ref == L"Äã");
		yggr_test_assert(ch2 == L"Äã");

		yggr::swap(ch1_ref, ch2_ref);

		yggr::swap(ch1, ch3_ref);
		yggr_test_assert(ch1 == L"Âğ");
		yggr_test_assert(ch1_ref == L"Âğ");

		yggr_test_assert(ch3 == L"Äã");
		yggr_test_assert(ch3_ref == L"Äã");
	}
	...
	// assign
	{
		// assign(char)
		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(L'Âğ'));
...

		{
			...
			ch_ref.assign(L"ºÃ", 1);

			yggr_test_assert(ch == L"ºÃ");
			yggr_test_assert(ch_ref == L"ºÃ");

			ch_ref.assign(yggr::charset::make_string_charset_helper(L"Âğ"), 1);
...

		{
			...
			ch_ref.assign(std::wstring(L"ºÃ"));

			yggr_test_assert(ch == L"ºÃ");
			yggr_test_assert(ch_ref == L"ºÃ");

			ch_ref.assign(yggr::charset::make_string_charset_helper(std::wstring(L"Âğ")));
...

		{
			...
			ch_ref.assign(boost::container::wstring(L"ºÃ"));

			yggr_test_assert(ch == L"ºÃ");
			yggr_test_assert(ch_ref == L"ºÃ");

			ch_ref.assign(yggr::charset::make_string_charset_helper(boost::container::wstring(L"Âğ")));
...

		{
			...
			ch_ref.assign(char_type(L"ºÃ"));

			yggr_test_assert(ch == L"ºÃ");
			yggr_test_assert(ch_ref == L"ºÃ");

			ch_ref.assign(yggr::charset::make_string_charset_helper(char_type(L"Âğ")));
	...
	{
		// test stand
		yggr_test_assert(L'Äã' < L'ºÃ');
		yggr_test_assert(char_type(L'Äã') < char_type(L'ºÃ'));
...
void test_utf8_char_view(void)
{
	...
	// operator type
	{
...

		{
			...
			yggr_test_assert(str == "a");
			str.clear();
			str = static_cast<boost::container::string>(ch_view); // gcc need using static_cast
			yggr_test_assert(str == "a");
			yggr_test_assert(str == ch_view);
			yggr_test_assert(ch_view == str);
		}
	...
	// hello world
	{
		...
		yggr_test_assert(ch1_view == L"Äã");
		yggr_test_assert(ch2_view == L"ºÃ");
	...
	// construct
	{
...

		{
			...
			yggr_test_assert(ch_view2 == L"Äã");
		}
