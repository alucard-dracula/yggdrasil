...
void test_construct(void)
{
	...
	
	{
...

		{
			...
			// right usage
			utf8_string_type str8(isomeric_same_utf8_string_type("abcÄãºÃ"), 4);
...

		{
			...
			utf8_string_type str8(isomeric_same_utf8_string_type("abcÄãºÃ"), 4, 1);
	...
	// (string)
	{
		{
			//const utf8_string&
			utf8_string_type str1 = isomeric_same_utf8_string_type(L"ÄãºÃÂð");
			yggr_test_assert(str1 == L"ÄãºÃÂð");

			utf8_string_type str2(isomeric_same_utf8_string_type(L"ÄãºÃÂð"));
			yggr_test_assert(str2 == L"ÄãºÃÂð");

			utf8_string_type str3(isomeric_same_utf8_string_type(L"ÄãºÃÂð"), yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"ÄãºÃÂð");

			utf8_string_type str4(isomeric_same_utf8_string_type(L"ÄãºÃÂð"), yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"ÄãºÃÂð");

			utf8_string_type str5(isomeric_same_utf8_string_type(L"ÄãºÃÂð"),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"ÄãºÃÂð");

			utf8_string_type str6(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"ÄãºÃÂð")));
			yggr_test_assert(str6 == L"ÄãºÃÂð");

			utf8_string_type str7(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"ÄãºÃÂð")),
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str7 == L"ÄãºÃÂð");
		}

		{
			// const string pos
			utf8_string_type str1(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô"), 3);
			yggr_test_assert(str1 == L"°¢´ô");

			utf8_string_type str3(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô"), 3, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"°¢´ô");

			utf8_string_type str4(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô"), 3, yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"°¢´ô");

			utf8_string_type str5(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô"), 3,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"°¢´ô");

			utf8_string_type str6(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô")), 3);
			yggr_test_assert(str6 == L"°¢´ô");

			utf8_string_type str7(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"ÄãºÃÂð°¢´ô")), 3,
									yggr::utf8_string::allocator_type());
		...
		{
			// const utf8_string pos, len
			utf8_string_type str1(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô"), 3, 1);
			yggr_test_assert(str1 == L"°¢");

			utf8_string_type str3(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô"), 3, 1, yggr::utf8_string::allocator_type());
			yggr_test_assert(str3 == L"°¢");

			utf8_string_type str4(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô"), 3, 1, yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == L"°¢");

			utf8_string_type str5(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô"), 3, 1,
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str5 == L"°¢");

			utf8_string_type str6(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô")), 3, 1);
			yggr_test_assert(str6 == L"°¢");

			utf8_string_type str7(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type("ÄãºÃÂð°¢´ô")), 3, 1,
									yggr::utf8_string::allocator_type());
	...
	// iterator
	{
		{
			// utf8_string
			isomeric_same_utf8_string_type str_arr = L"ÄãºÃÂð";
			...
			utf8_string_type str3(str_arr.begin(), str_arr.end(),
										yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str3 == "ÄãºÃÂð");

			utf8_string_type str4(str_arr.begin(), str_arr.end(),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == "ÄãºÃÂð");
		}

		{
			// utf8_string riter
			isomeric_same_utf8_string_type str_arr = L"ÄãhaoÂð";

			utf8_string_type str1(str_arr.rbegin(), str_arr.rend());
			yggr_test_assert(str1 == L"ÂðoahÄã");

			utf8_string_type str2(str_arr.rbegin(), str_arr.rend(),
									yggr::utf8_string::allocator_type());
			yggr_test_assert(str2 == L"ÂðoahÄã");

			utf8_string_type str3(str_arr.rbegin(), str_arr.rend(),
										yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str3 == "ÂðoahÄã");

			utf8_string_type str4(str_arr.rbegin(), str_arr.rend(),
									yggr::utf8_string::allocator_type(),
									yggr::charset::charset_name_t<yggr::utf8_string>());
			yggr_test_assert(str4 == "ÂðoahÄã");
		}
	}
...
void test_operator_set(void)
{
	...
	{
		isomeric_same_string_type src_str = "aÄãbºÃc";
	...
	{
		isomeric_same_utf8_string_type src_str = "aÄãbºÃc";
		isomeric_same_utf8_string_type str_chk(src_str);
		utf8_string_type str;
		str = boost::move(src_str);
		yggr_test_assert(str == str_chk);
...
void test_append(void)
{
	...
	// n, char
	{
		// n utf8_string
		{
			isomeric_same_utf8_string_type str = L"aÄãbºÃc";
			yggr_test_assert(str.length() == 5);
		...
		{
			utf8_string_type str = L"aÄãbºÃc";
			yggr_test_assert(str.length() == 5);

			str.append(3, yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type::char_type(L"¥ï")));
	...
	// string
	{
		// utf8_string
		{
			...
			str.append( isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém"));
...

		{
			...
			str.append( isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém"), 3);
...

		{
			...
			str.append( isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém"), 3, 1);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém")));
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém")), 3);
...

		{
			...
			str.append(yggr::charset::make_string_charset_helper(isomeric_same_utf8_string_type(L"¥ï¥ë©`¥Ém")), 3, 1);
	...
	{
		{
			...
			isomeric_same_utf8_string_type str = L"ÄãºÃ";
		...
		{
			isomeric_same_utf8_string_type ins_str = L" ¥ï¥ë©`¥É";
			utf8_string_type str = L"ÄãºÃ";
...
void test_modify(void)
{
	...
	str.append(isomeric_same_string_type("boostÓÎboostÏ·boost"));
	...
	isomeric_same_string_type isomeric_same_str("ÕâÊÇºº×Ö");
	str.append(isomeric_same_str.begin(), isomeric_same_str.end());
	yggr_test_assert(str.length() == 2 + 4);
	std::cout << str << std::endl;

	isomeric_same_utf8_string_type isomeric_same_utf8_str("ÕâÊÇUTF8ºº×Ö");
	...
	// assign_test
	str.assign(isomeric_same_string_type("isomeric_same_str_assign_ºº×Ö"));
	yggr_test_assert(str.length() == 27);
	std::cout << str << std::endl;

    str.assign(isomeric_same_utf8_string_type("isomeric_same_utf8_str_assign_ºº×Ö"));
	yggr_test_assert(str.length() == 32);
	std::cout << str << std::endl;


	isomeric_same_string_type isomeric_same_str2("iter_isomeric_same_str_assign_ºº×Ö");
	str.assign(isomeric_same_str2.begin(), isomeric_same_str2.end());
	yggr_test_assert(str.length() == 32);
	std::cout << str << std::endl;

	isomeric_same_utf8_string_type isomeric_same_utf8_str2("abcºº×Ö");
	...
	{
		str = "utf8×Ö·û´®";
		isomeric_same_utf8_string_type ustr("ÕâÊÇ¸ö");
	...
	{
		str = "string ×Ö·û´®";
        isomeric_same_utf8_string_type sstr("ÄãºÃÂð");
		yggr_test_assert(str.length() == 10);
...
void test_string_operations(void)
{
...

	{
        ...
        isomeric_same_utf8_string_type sstr("tf8×Ö·û´®");
	...
	{
		isomeric_same_utf8_string_type sstr(L"tf8×Ö·û´®");
	...
	// find_first_of
	{
        yggr_test_assert(str.find_first_of(isomeric_same_utf8_string_type("×Öabc")) == 4);
		yggr_test_assert(str.find_first_of(isomeric_same_utf8_string_type("abc")) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_first_of(isomeric_same_utf8_string_type("×Öabc"), 1) == 4);
		yggr_test_assert(str.find_first_of(isomeric_same_utf8_string_type("×Öabc"),5) == yggr::utf8_string::npos);
	}

	// find first_not_of
	{
        yggr_test_assert(str.find_first_not_of(isomeric_same_utf8_string_type("×Öabc")) == 0);
		yggr_test_assert(str.find_first_not_of(isomeric_same_utf8_string_type("abc")) == 0);
		yggr_test_assert(str.find_first_not_of(isomeric_same_utf8_string_type("×Öabc"), 1) == 1);
		yggr_test_assert(str.find_first_not_of(isomeric_same_utf8_string_type("×Öabc"),5) == 5);
		yggr_test_assert(str.find_first_not_of(isomeric_same_utf8_string_type("utf8×Ö·û´®"), 1) == yggr::utf8_string::npos);
	...
	// find_last_of
	{
        yggr_test_assert(str.find_last_of(isomeric_same_utf8_string_type("×Öabc")) == 4);
		yggr_test_assert(str.find_last_of(isomeric_same_utf8_string_type("abc")) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(isomeric_same_utf8_string_type("×Öabc"), 1) == yggr::utf8_string::npos);
		yggr_test_assert(str.find_last_of(isomeric_same_utf8_string_type("×Öabc"),5) == 4);
		yggr_test_assert(str.find_last_of(isomeric_same_utf8_string_type("u"), 0) == 0);
	}

	// find_last_not_of
	{
        yggr_test_assert(str.find_last_not_of(isomeric_same_utf8_string_type("×Öabc")) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(isomeric_same_utf8_string_type("abc")) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(isomeric_same_utf8_string_type("×Öabc"), 1) == 1);
		yggr_test_assert(str.find_last_not_of(isomeric_same_utf8_string_type("×Öabc"),5) == 5);
		yggr_test_assert(str.find_last_not_of(isomeric_same_utf8_string_type("utf8×Ö·û´®"), 1) == yggr::utf8_string::npos);
	...
	{
		//str = "utf8×Ö·û´®";
		yggr_test_assert(str.compare_eq(4, 2, isomeric_same_string_type("×Ö·û")) == true);
		yggr_test_assert(str.compare_eq(4, 2, isomeric_same_string_type("×Ö·û³¤")) == false);

		yggr_test_assert(str.compare_eq(4, 2, isomeric_same_utf8_string_type("×Ö·û")) == true);
		yggr_test_assert(str.compare_eq(4, 2, isomeric_same_utf8_string_type("×Ö·û³¤")) == false);
	}
	...
	// compare
	{
		...
		yggr_test_assert(str.compare(4, 2, isomeric_same_string_type("×Ö·û")) == 0);
		yggr_test_assert(str.compare(4, 2, isomeric_same_string_type("×Ö·û³¤")) < 0);
		yggr_test_assert(str.compare(4, 3, isomeric_same_string_type("×Ö·û")) > 0);

		yggr_test_assert(str.compare(4, 2, isomeric_same_utf8_string_type("×Ö·û")) == 0);
		yggr_test_assert(str.compare(4, 2, isomeric_same_utf8_string_type("×Ö·û³¤")) < 0);
		yggr_test_assert(str.compare(4, 3, isomeric_same_utf8_string_type("×Ö·û")) > 0);
	}
}
...
void non_member_foo_test(void)
{
	...
	// operator +
	{
		...
		std::cout << isomeric_same_string_type("utf8×Ö·û") + str << std::endl;

		std::cout << "utf8×Ö·û" + str + isomeric_same_string_type("aaa") << std::endl;

		std::cout << isomeric_same_utf8_string_type("utf8×Ö·û") + str << std::endl;
		const yggr::utf8_string& cref_str = str;
		std::cout << isomeric_same_utf8_string_type("utf8×Ö·û") + cref_str << std::endl;


		std::cout << isomeric_same_utf8_string_type("utf8×Ö·û") + str + isomeric_same_string_type("aaa") << std::endl;
	}
	...
	// operator ==
	{
		...
		yggr_test_assert(str == isomeric_same_string_type("utf8×Ö·û´®"));
		yggr_test_assert(isomeric_same_string_type("utf8×Ö·û´®") == str);

		yggr_test_assert(str == isomeric_same_utf8_string_type("utf8×Ö·û´®"));
		yggr_test_assert(isomeric_same_utf8_string_type("utf8×Ö·û´®") == str);
	}
