		...
		{
			{
				...
				{
					yggr_rst = yggr::regular_parse::regex_parse::format(rst, L"(?1您)(?2_)");
					yggr_test_assert(yggr_rst == L"您");

					yggr_rst = yggr::regular_parse::regex_parse::format(yggr_rst.get_allocator(), rst, L"(?1您)(?2_)");
					yggr_test_assert(yggr_rst == L"您");

					yggr_rst = yggr::regular_parse::regex_parse::format<yggr::wstring>(rst, L"(?1您)(?2_)");
					yggr_test_assert(yggr_rst == L"您");

					yggr_rst = yggr::regular_parse::regex_parse::format<yggr::wstring>(yggr_rst.get_allocator(), rst, L"(?1您)(?2_)");
					yggr_test_assert(yggr_rst == L"您");

					stl_rst = yggr::regular_parse::regex_parse::format<std::wstring>(rst, L"(?1您)(?2_)");
					yggr_test_assert(stl_rst == L"您");

					stl_rst = yggr::regular_parse::regex_parse::format<std::wstring>(stl_rst.get_allocator(), rst, L"(?1您)(?2_)");
					yggr_test_assert(stl_rst == L"您");

					ss_type ss;
					yggr::regular_parse::regex_parse::format(out_iter_type(ss), rst, L"(?1您)(?2_)");
					yggr_test_assert(ss.str() == L"您");
				}
			}
		}
