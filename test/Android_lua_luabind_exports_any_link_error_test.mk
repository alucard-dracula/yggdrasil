#
#	lua_luabind_exports_any_link_error_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua_luabind_exports_any_link_error_test
...
# source files
l_src_file := \
	lua/luabind_exports_any_link_error_test.cpp \
