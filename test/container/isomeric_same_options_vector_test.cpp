// isomeric_same_options_vector_test.cpp
...
void test_isomeric_same_construct(void)
{
	...
	typedef yggr::options_vector<int> default_vt_type;
	typedef boost::container::vector<int> boost_default_vt_type;
	typedef 
		yggr::options_vector
		<
			default_vt_type::value_type, 
			default_vt_type::allocator_type, 
			default_vt_type::options_type
		> regular_vt_type;
...
#if(BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_vector<default_vt_type, regular_vt_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_vector<default_vt_type, regular_vt_type>));
#endif // BOOST_VERSION < 106700
...
#if(BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_options_vector<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_vector<default_vt_type, regular_vt_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_vector<boost_default_vt_type, boost_regular_vt_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_vector<default_vt_type, regular_vt_type>));
#endif // BOOST_VERSION < 106700
