...
{
	int arr[5] = {1, 1, 2, 2, 3};
	typedef yggr::options_multiset<int> set_type;
	typedef yggr::options_multiset<set_type::value_type, set_type::key_compare, set_type::allocator_type> isomeric_same_set_type;
