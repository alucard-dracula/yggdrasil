...
void test_extract_insert(void)
{
	...
	test_extract_insert_tpl< std::map<int, int> >();
	test_extract_insert_tpl< std::multimap<int, int> >();
#endif // YGGR_USING_CXX17
	test_extract_insert_tpl< boost::container::map<int, int> >();
	test_extract_insert_tpl< boost::container::multimap<int, int> >();
	test_extract_insert_tpl< yggr::map<int, int> >();
	test_extract_insert_tpl< yggr::multimap<int, int> >();
...
void test_merge(void)
{
	...
	// std::map
	test_merge_tpl< std::map<int, int>, std::map<int, int> >();
	test_merge_tpl< std::map<int, int>, std::multimap<int, int> >();

	test_merge_tpl< std::map<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< std::map<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< std::map<int, int>, yggr::map<int, int> >();
	test_merge_tpl< std::map<int, int>, yggr::multimap<int, int> >();

	// std::multimap
	test_merge_tpl< std::multimap<int, int>, std::map<int, int> >();
	test_merge_tpl< std::multimap<int, int>, std::multimap<int, int> >();

	test_merge_tpl< std::multimap<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< std::multimap<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< std::multimap<int, int>, yggr::map<int, int> >();
	test_merge_tpl< std::multimap<int, int>, yggr::multimap<int, int> >();

	// boost::contianer::map
	test_merge_tpl< boost::container::map<int, int>, std::map<int, int> >();
	test_merge_tpl< boost::container::map<int, int>, std::multimap<int, int> >();

	test_merge_tpl< boost::container::map<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< boost::container::map<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< boost::container::map<int, int>, yggr::map<int, int> >();
	test_merge_tpl< boost::container::map<int, int>, yggr::multimap<int, int> >();

	// boost::container::multimap
	test_merge_tpl< boost::container::multimap<int, int>, std::map<int, int> >();
	test_merge_tpl< boost::container::multimap<int, int>, std::multimap<int, int> >();

	test_merge_tpl< boost::container::multimap<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< boost::container::multimap<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< boost::container::multimap<int, int>, yggr::map<int, int> >();
	test_merge_tpl< boost::container::multimap<int, int>, yggr::multimap<int, int> >();

	// yggr::map
	test_merge_tpl< yggr::map<int, int>, std::map<int, int> >();
	test_merge_tpl< yggr::map<int, int>, std::multimap<int, int> >();

	test_merge_tpl< yggr::map<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< yggr::map<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< yggr::map<int, int>, yggr::map<int, int> >();
	test_merge_tpl< yggr::map<int, int>, yggr::multimap<int, int> >();

#if !(BOOST_VERSION < 105600)
	test_merge_tpl2< yggr::map<int, int>, std::map<int, int> >();
	test_merge_tpl2< yggr::map<int, int>, std::multimap<int, int> >();

	test_merge_tpl2< yggr::map<int, int>, boost::container::map<int, int> >();
	test_merge_tpl2< yggr::map<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl2< yggr::map<int, int>, yggr::map<int, int> >();
	test_merge_tpl2< yggr::map<int, int>, yggr::multimap<int, int> >();

#endif // !(BOOST_VERSION < 105600)

	// yggr::multimap
	test_merge_tpl< yggr::multimap<int, int>, std::map<int, int> >();
	test_merge_tpl< yggr::multimap<int, int>, std::multimap<int, int> >();

	test_merge_tpl< yggr::multimap<int, int>, boost::container::map<int, int> >();
	test_merge_tpl< yggr::multimap<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl< yggr::multimap<int, int>, yggr::map<int, int> >();
	test_merge_tpl< yggr::multimap<int, int>, yggr::multimap<int, int> >();

#if !(BOOST_VERSION < 105600)
	test_merge_tpl2< yggr::multimap<int, int>, std::map<int, int> >();
	test_merge_tpl2< yggr::multimap<int, int>, std::multimap<int, int> >();

	test_merge_tpl2< yggr::multimap<int, int>, boost::container::map<int, int> >();
	test_merge_tpl2< yggr::multimap<int, int>, boost::container::multimap<int, int> >();

	test_merge_tpl2< yggr::multimap<int, int>, yggr::map<int, int> >();
	test_merge_tpl2< yggr::multimap<int, int>, yggr::multimap<int, int> >();
...
void test_contains_tpl2(void)
{
...

	{
		...
		bchk = map.contains(1.0);
		yggr_test_assert(bchk);

		bchk = map.contains(2.0);
		yggr_test_assert(bchk);

		bchk = map.contains(3.0);
		yggr_test_assert(bchk);

		bchk = map.contains(4.0);
		yggr_test_assert(!bchk);
	}
}
...
void test_contains(void)
{
	...
	test_contains_tpl< std::map<int, int> >();
	test_contains_tpl< std::multimap<int, int> >();

	test_contains_tpl< boost::container::map<int, int> >();
	test_contains_tpl< boost::container::multimap<int, int> >();

	test_contains_tpl< yggr::map<int, int> >();
	test_contains_tpl< yggr::multimap<int, int> >();

#if !(BOOST_VERSION < 105600)
	test_contains_tpl2< yggr::map<int, int> >();
	test_contains_tpl2< yggr::multimap<int, int> >();
#endif // !(BOOST_VERSION < 105600)
...
void test_try_emplace_tpl(void)
{
...

	{
		...
		std::pair<iter_type, bool> ret = yggr::container::try_emplace(map, 5);

		yggr_test_assert(ret.first->first == 5);
		yggr_test_assert(ret.first->second == 0);
		...
		ret = yggr::container::try_emplace(map, boost::move(key));
...
void test_try_emplace(void)
{
	...
	test_try_emplace_tpl< std::map<int, int> >();
	test_try_emplace_tpl< boost::container::map<int, int> >();
	test_try_emplace_tpl< yggr::map<int, int> >();

	test_try_emplace_tpl2< std::map<yggr::string, yggr::string> >();
	test_try_emplace_tpl2< boost::container::map<yggr::string, yggr::string> >();
	test_try_emplace_tpl2< yggr::map<yggr::string, yggr::string> >();
...
void test_insert_or_assign_tpl(void)
{
...

	{
...

		{
			...
			ret = yggr::container::insert_or_assign(map, 5, 60);
			yggr_test_assert(!ret.second);
			yggr_test_assert(map[5] == 60);

			ret = yggr::container::insert_or_assign(map, 5, 50);
			yggr_test_assert(!ret.second);
			yggr_test_assert(map[5] == 50);
		}
...
void test_insert_or_assign(void)
{
	...
	test_insert_or_assign_tpl< std::map<int, int> >();
	test_insert_or_assign_tpl< boost::container::map<int, int> >();
	test_insert_or_assign_tpl< yggr::map<int, int> >();

	//boost::container::map<int, int> map;
	//map.insert_or_assign(map.begin(), 5, 5);
...
void test_erase_if(void)
{
	...
	test_erase_if_tpl< std::map<int, int> >();
	test_erase_if_tpl< std::multimap<int, int> >();

	test_erase_if_tpl< boost::container::map<int, int> >();
	test_erase_if_tpl< boost::container::multimap<int, int> >();

	test_erase_if_tpl< yggr::map<int, int> >();
	test_erase_if_tpl< yggr::multimap<int, int> >();
