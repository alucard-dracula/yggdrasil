...
{
	int arr[5] = {1, 1, 2, 2, 3};
	typedef yggr::multiset<int> set_type;
	typedef yggr::multiset<set_type::value_type, set_type::key_compare, set_type::allocator_type> isomeric_same_set_type;
...
void test_erase_if(void)
{
	...
	{
		typedef boost::container::multiset<int> set_type;
