// isomeric_same_multimap_test.cpp
...
void test_isomeric_same_construct(void)
{
	...
	typedef yggr::multimap<int, int> default_map_type;
	...
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_map<default_map_type, regular_map_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<default_map_type, regular_map_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_map<default_map_type, regular_map_type>));
