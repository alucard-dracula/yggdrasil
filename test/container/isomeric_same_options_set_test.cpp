// isomeric_same_options_set_test.cpp
...
void test_isomeric_same_construct(void)
{
	...
	typedef yggr::options_set<int> default_set_type;
	typedef boost::container::set<int> boost_default_set_type;
	typedef
		yggr::options_set
		<
	...
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_set<default_set_type, regular_set_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<default_set_type, regular_set_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_set<default_set_type, regular_set_type>));
...
void test_isomeric_same_operator_merge(void)
{
	...
	test_merge_ss<default_set_type, boost_default_set_type>();
	test_merge_ss<default_set_type, boost_regular_set_type>();

	test_merge_ss<regular_set_type, default_set_type>();
	test_merge_ss<regular_set_type, regular_set_type>();
	test_merge_ss<regular_set_type, boost_default_set_type>();
	test_merge_ss<regular_set_type, boost_regular_set_type>();

	test_merge_ss<boost_default_set_type, default_set_type>();
	test_merge_ss<boost_default_set_type, regular_set_type>();
	test_merge_ss<boost_default_set_type, boost_default_set_type>();
	test_merge_ss<boost_default_set_type, boost_regular_set_type>();

	test_merge_ss<boost_regular_set_type, default_set_type>();
	test_merge_ss<boost_regular_set_type, regular_set_type>();
	test_merge_ss<boost_regular_set_type, boost_default_set_type>();
	test_merge_ss<boost_regular_set_type, boost_regular_set_type>();
