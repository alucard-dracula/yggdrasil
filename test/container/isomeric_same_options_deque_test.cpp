// isomeric_same_options_deque_test.cpp
...
void test_isomeric_same_construct(void)
{
	...
	typedef yggr::options_deque<int> default_dq_type;
	typedef boost::container::deque<int> boost_default_dq_type;
	typedef 
		yggr::options_deque
		<
			default_dq_type::value_type, 
			default_dq_type::allocator_type, 
			default_dq_type::options_type 
		> regular_dq_type;
	...
	BOOST_MPL_ASSERT((boost::is_same<boost_default_dq_type, boost_regular_dq_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_deque<boost_default_dq_type, boost_regular_dq_type>));
	BOOST_MPL_ASSERT_NOT((boost::is_same<default_dq_type, regular_dq_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_deque<default_dq_type, regular_dq_type>));
#else
	BOOST_MPL_ASSERT_NOT((boost::is_same<boost_default_dq_type, boost_regular_dq_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_deque<boost_default_dq_type, boost_regular_dq_type>));
	BOOST_MPL_ASSERT_NOT((boost::is_same<default_dq_type, regular_dq_type>));
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_deque<default_dq_type, regular_dq_type>));
