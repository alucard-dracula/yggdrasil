// isomeric_same_options_multimap_test.cpp
...
void test_isomeric_same_construct(void)
{
	...
	typedef yggr::options_multimap<int, int> default_map_type;
	typedef boost::container::multimap<int, int> boost_default_map_type;
	typedef
	...
	BOOST_MPL_ASSERT((yggr::is_isomeric_same_options_multimap<default_map_type, regular_map_type>));
#elif(BOOST_VERSION < 106700)
	BOOST_MPL_ASSERT((boost::is_same<default_map_type, regular_map_type>));
	BOOST_MPL_ASSERT_NOT((yggr::is_isomeric_same_options_multimap<default_map_type, regular_map_type>));
...
void test_isomeric_same_operator_merge(void)
{
	...
	test_merge_mm<default_map_type, default_map_type>();
	test_merge_mm<default_map_type, regular_map_type>();
	test_merge_mm<default_map_type, boost_default_map_type>();
	test_merge_mm<default_map_type, boost_regular_map_type>();

	test_merge_mm<regular_map_type, default_map_type>();
	test_merge_mm<regular_map_type, regular_map_type>();
	test_merge_mm<regular_map_type, boost_default_map_type>();
	test_merge_mm<regular_map_type, boost_regular_map_type>();

	test_merge_mm<boost_default_map_type, default_map_type>();
	test_merge_mm<boost_default_map_type, regular_map_type>();
	test_merge_mm<boost_default_map_type, boost_default_map_type>();
	test_merge_mm<boost_default_map_type, boost_regular_map_type>();

	test_merge_mm<boost_regular_map_type, default_map_type>();
	test_merge_mm<boost_regular_map_type, regular_map_type>();
	test_merge_mm<boost_regular_map_type, boost_default_map_type>();
	test_merge_mm<boost_regular_map_type, boost_regular_map_type>();
