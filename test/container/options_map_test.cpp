...
{
	int arr[5] = {1, 1, 2, 2, 3};
	typedef yggr::options_map<int, int> map_type;
	typedef 
		yggr::options_map
		<
			map_type::key_type, 
			map_type::mapped_type, 
			map_type::key_compare, 
			map_type::allocator_type,
			map_type::options_type
...
void test_merge(void)
{
	...
	typedef yggr::options_map<val_type, val_type> yggr_opt_map_type;
	typedef yggr::options_multimap<val_type, val_type> yggr_opt_mmap_type;

	// ss
	test_merge_ss<stl_map_type, stl_map_type>();
	test_merge_ss<stl_map_type, boost_map_type>();
	test_merge_ss<stl_map_type, yggr_map_type>();
	test_merge_ss<stl_map_type, yggr_opt_map_type>();
	...
	test_merge_ss<boost_map_type, yggr_opt_map_type>();
	...
	test_merge_ss<yggr_map_type, yggr_opt_map_type>();

	test_merge_ss<yggr_opt_map_type, stl_map_type>();
	test_merge_ss<yggr_opt_map_type, boost_map_type>();
	test_merge_ss<yggr_opt_map_type, yggr_map_type>();
	test_merge_ss<yggr_opt_map_type, yggr_opt_map_type>();
	...
	test_merge_sm<stl_map_type, yggr_opt_mmap_type>();
	...
	test_merge_sm<boost_map_type, yggr_opt_mmap_type>();
	...
	test_merge_sm<yggr_map_type, yggr_opt_mmap_type>();

	test_merge_sm<yggr_opt_map_type, stl_mmap_type>();
	test_merge_sm<yggr_opt_map_type, boost_mmap_type>();
	test_merge_sm<yggr_opt_map_type, yggr_mmap_type>();
	test_merge_sm<yggr_opt_map_type, yggr_opt_mmap_type>();
	...
	test_merge_ms<stl_mmap_type, yggr_opt_map_type>();
	...
	test_merge_ms<boost_mmap_type, yggr_opt_map_type>();
	...
	test_merge_ms<yggr_mmap_type, yggr_opt_map_type>();

	test_merge_ms<yggr_opt_mmap_type, stl_map_type>();
	test_merge_ms<yggr_opt_mmap_type, boost_map_type>();
	test_merge_ms<yggr_opt_mmap_type, yggr_map_type>();
	test_merge_ms<yggr_opt_mmap_type, yggr_opt_map_type>();
	...
	test_merge_mm<stl_mmap_type, yggr_opt_mmap_type>();
	...
	test_merge_mm<boost_mmap_type, yggr_opt_mmap_type>();
	...
	test_merge_mm<yggr_mmap_type, yggr_opt_mmap_type>();

	test_merge_mm<yggr_opt_mmap_type, stl_mmap_type>();
	test_merge_mm<yggr_opt_mmap_type, boost_mmap_type>();
	test_merge_mm<yggr_opt_mmap_type, yggr_mmap_type>();
	test_merge_mm<yggr_opt_mmap_type, yggr_opt_mmap_type>();

	// member merge foo
	// ss
	test_member_merge_ss<yggr_opt_map_type, stl_map_type>();
	test_member_merge_ss<yggr_opt_map_type, boost_map_type>();
	test_member_merge_ss<yggr_opt_map_type, yggr_map_type>();
	test_member_merge_ss<yggr_opt_map_type, yggr_opt_map_type>();

	// sm
	test_member_merge_sm<yggr_opt_map_type, stl_mmap_type>();
	test_member_merge_sm<yggr_opt_map_type, boost_mmap_type>();
	test_member_merge_sm<yggr_opt_map_type, yggr_mmap_type>();
	test_member_merge_sm<yggr_opt_map_type, yggr_opt_mmap_type>();

	// ms
	test_member_merge_ms<yggr_opt_mmap_type, stl_map_type>();
	test_member_merge_ms<yggr_opt_mmap_type, boost_map_type>();
	test_member_merge_ms<yggr_opt_mmap_type, yggr_map_type>();
	test_member_merge_ms<yggr_opt_mmap_type, yggr_opt_map_type>();

	// mm
	test_member_merge_mm<yggr_opt_mmap_type, stl_mmap_type>();
	test_member_merge_mm<yggr_opt_mmap_type, boost_mmap_type>();
	test_member_merge_mm<yggr_opt_mmap_type, yggr_mmap_type>();
	test_member_merge_mm<yggr_opt_mmap_type, yggr_opt_mmap_type>();
