...
void test_set_3(void)
{
	...
	yggr::any a1(yggr::charset::utf8_string("你好 "));
	yggr::any a2(yggr::charset::utf8_string("世界 utf8"));
...
void test_set_5(void)
{
	...
	yggr::any a1(ANY_SET(yggr::charset::utf8_string, "你好"));
	yggr::any a2(ANY_SET(std::string, "stl世界"));
	yggr::any a3(ANY_SET(boost::container::string, "boost世界"));
...
void test_plus_3(void)
{
	...
	yggr_test_assert(yggr::any_cast<yggr::charset::utf8_string>(a3)
			== yggr::charset::utf8_string("你好 ") + yggr::charset::utf8_string("世界 utf8"));
...
void test_equal_to_3(void)
{
	...
	yggr::any a1(yggr::charset::utf8_string("你好 "));
	yggr::any a2(yggr::charset::utf8_string("世界 utf8"));
	yggr::any a3(yggr::charset::utf8_string("世界 utf8"));
