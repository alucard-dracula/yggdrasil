//yggr_any_operator_mgr_basic_type_test.cpp
...
// test_negate
void test_positive1(void)
{
	std::cout << "----------test_positive1 S---------------" << std::endl;
	...
	std::cout << "----------test_positive1 E---------------" << std::endl;
}

void test_positive2(void)
{
	std::cout << "----------test_positive2 S---------------" << std::endl;
	yggr::any a1(ANY_SET(yggr::f32, 10));
	yggr::any a2 = +a1;

	std::cout << yggr::any_cast<yggr::f32>(a2) <<std::endl;

	yggr_test_assert(yggr::any_cast<yggr::f32>(a2) == 10.0f);
	std::cout << "----------test_positive2 E---------------" << std::endl;
}
...
void test_before_plus_plus_1(void)
{
...

	{
		...
		{
			yggr::any tmp = (a1 == a2);
			std::cout << tmp.type().name() << std::endl;
		}

		yggr_test_assert(yggr::any_cast<bool>(a1 == a2));
		yggr_test_assert(boost::addressof(a1) == boost::addressof(a2));
		yggr_test_assert(yggr::any_cast<yggr::s32>(a2) == yggr::any_cast<yggr::s32>(a1));
	}
...
void test_set_1(void)
{
	...
	yggr::any a3 = operator_set(a1, a2);
...
void test_set_2(void)
{
	...
	yggr::any a1(ANY_SET(std::string, "Hello "));
	yggr::any a2(ANY_SET(std::string, "World"));
...
void test_set_3(void)
{
	...
	yggr::any a1(yggr::charset::utf8_string(yggr::utf8_string_view("你好 ")));
	yggr::any a2(yggr::charset::utf8_string(yggr::utf8_string_view("世界 utf8")));
...
void test_set_4(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::f32, 20.5));
	...
	yggr::any a4(ANY_SET(std::string, "100"));
	yggr::any a5 = operator_set(a3, a4);
...
void test_set_5(void)
{
	...
	yggr::any a1(ANY_SET(yggr::charset::utf8_string, yggr::utf8_string_view("你好")));
	yggr::any a2(ANY_SET(std::string, yggr::utf8_string_view("stl世界").str<std::string>()));
	yggr::any a3(ANY_SET(boost::container::string, yggr::utf8_string_view("boost世界").str<boost::container::string>()));

	yggr::any a4 = operator_set(a1, a2);
	yggr::any a5 = operator_set(a1, a3);
...
void test_plus_4(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::f32, 20.0));
...
void test_logic_and(void)
{
	...
	yggr::any a1(ANY_SET(bool, true));
	yggr::any a2(ANY_SET(bool, false));
	yggr::any a3(ANY_SET(bool, true));

	yggr_test_assert(!yggr::any_cast<bool>(a1 && a2));
	yggr_test_assert(yggr::any_cast<bool>(a1 && a3));
	yggr_test_assert(yggr::any_cast<bool>(a1 && a1));

	yggr::any a4(ANY_SET(yggr::s32, 10));
	yggr::any a5(ANY_SET(yggr::f32, 0.0f));
	...
	yggr::any a6(ANY_SET(std::string, "abc"));
...
void test_bitwise_and(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 0x10000001));
	yggr::any a2(ANY_SET(yggr::s32, 0x00000001));
	...
	yggr::any a4(ANY_SET(std::string, "Hello"));
...
void test_bitwise_left_shift(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::s32, 1));
...
void test_equal_to_1(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::s32, 20));
	yggr::any a3(ANY_SET(yggr::s32, 20));
...
void test_equal_to_2(void)
{
	...
	yggr::any a1(ANY_SET(std::string, "Hello "));
	yggr::any a2(ANY_SET(std::string, "World"));
	yggr::any a3(ANY_SET(std::string, "World"));
...
void test_equal_to_3(void)
{
	...
	yggr::any a1(yggr::charset::utf8_string(yggr::utf8_string_view("你好 ")));
	yggr::any a2(yggr::charset::utf8_string(yggr::utf8_string_view("世界 utf8")));
	yggr::any a3(yggr::charset::utf8_string(yggr::utf8_string_view("世界 utf8")));
...
void test_equal_to_4(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::f32, 20.5));
	yggr::any a3(ANY_SET(yggr::f32, 20.5));
...
void test_equal_to_5(void)
{
	...
	yggr::any a1(ANY_SET(boost::container::string, "hello"));
	yggr::any a2(ANY_SET(yggr::utf8_string, "hello"));
...
void test_not_equal_to_5(void)
{
	...
	yggr::any a1(ANY_SET(boost::container::string, "hello"));
	yggr::any a2(ANY_SET(yggr::utf8_string, "world"));
...
void test_less_1(void)
{
	...
	yggr::any a1(ANY_SET(yggr::s32, 10));
	yggr::any a2(ANY_SET(yggr::s32, 20));
	yggr::any a3(ANY_SET(yggr::s32, 30));
...
void test_less_2(void)
{
	...
	yggr::any a1(ANY_SET(std::string, "Hello "));
	yggr::any a2(ANY_SET(std::string, "World"));
	yggr::any a3(ANY_SET(std::string, "Zete"));
...
void test_less_equal_1(void)
{
	...
	yggr::any a2(ANY_SET(yggr::s32, 20));
	yggr::any a3(ANY_SET(yggr::s32, 30));
	yggr::any a4(ANY_SET(yggr::s32, 30));
...
void test_less_equal_2(void)
{
	...
	yggr::any a2(ANY_SET(std::string, "World"));
	yggr::any a3(ANY_SET(std::string, "Zete"));
	yggr::any a4(ANY_SET(std::string, "Zete"));
