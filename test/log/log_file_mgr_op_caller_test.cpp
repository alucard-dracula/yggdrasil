//log_file_mgr_op_caller_test.cpp
...
void test_log_file_mgr_op_caller_1(void)
{
	...
	init.push_back("../test_out/log/log_file_mgr_caller11");
	init.push_back("../test_out/log/log_file_mgr_caller12");
	init.push_back("../test_out/log/log_file_mgr_caller13");
	init.push_back("../test_out/log/log_file_mgr_caller14");
	...
	caller_type caller_all;
	caller_all.call_append_any(op, a);

	caller_all.call_clear_any(op);
}

void test_log_file_mgr_op_caller_2(void)
{
	typedef yggr::log::log_op::log_file<ostream_type> o_log_file_type;
	typedef yggr::log::log_op::log_file_mgr<o_log_file_type> log_file_mgr_type;
	typedef yggr::log::log_op_def log_op_def_type;
	...
	yggr::list<std::string> init;
	init.push_back("../test_out/log/log_file_mgr_caller21");
	init.push_back("../test_out/log/log_file_mgr_caller22");
	init.push_back("../test_out/log/log_file_mgr_caller23");
	init.push_back("../test_out/log/log_file_mgr_caller24");
...
{
	test_log_file_mgr_op_caller_1();
	test_log_file_mgr_op_caller_2();
