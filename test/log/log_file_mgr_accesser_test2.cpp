//log_file_mgr_accesser_test2.cpp
...
void test_access_of_log_file_mgr(void)
{
	...
	fnames.push_back("../test_out/log/test_access_of_log_file_mgr12");
	fnames.push_back("../test_out/log/test_access_of_log_file_mgr22");

	log_acc_type acc(fnames);

	acc.register_msg(100, "../test_out/log/test_access_of_log_file_mgr12");
	acc.register_msg(101, "../test_out/log/test_access_of_log_file_mgr22");

	bool b = false;

	b = acc.unregister_msg(103);
	yggr_test_assert(!b);
	b = acc.unregister_msg(101);
	yggr_test_assert(b);
