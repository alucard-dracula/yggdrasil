#
#	encryption_tool_packet_cypher_tool_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := encryption_tool_packet_cypher_tool_test
...
# source files
l_src_file := \
	encryption_tool/packet_cypher_tool_test.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		...
		-lboost_wserialization$(USRDEF_APP_COMPILER_VERSION_TAG)-mt-sd$(tag_arch_bits)$(USRDEF_APP_BOOST_VERSION_TAG) \
	...
	l_ldflags += \
		...
		-lboost_wserialization$(USRDEF_APP_COMPILER_VERSION_TAG)-mt-s$(tag_arch_bits)$(USRDEF_APP_BOOST_VERSION_TAG) \
