#
#	exception_exception_sqldb_log_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := exception_exception_sqldb_log_test
...
# source files
l_src_file := \
	exception/exception_sqldb_log_test.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		-lyggr_database_system$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
		...
		-ldtl$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
	...
	l_ldflags += \
		-s \
		-Wl,--gc-sections \
		-lyggr_database_system$(USRDEF_APP_COMPILER_VERSION_TAG) \
		...
		-ldtl$(USRDEF_APP_COMPILER_VERSION_TAG) \
