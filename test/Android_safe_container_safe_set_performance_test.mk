#
#	safe_container_safe_set_performance_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := safe_container_safe_set_performance_test
...
# source files
l_src_file := \
	safe_container/safe_set_performance_test.cpp \
