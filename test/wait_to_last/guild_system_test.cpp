...
void test_guild(void)
{
	...
	game::guild::guild::description_init_type description_init(yggr::charset::utf8_string("��������Ƽ�"),
																	yggr::charset::utf8_string("�Ͽ����Ŀ����"));
...
public:
	...
	//bool runnable(void) const //�Ƿ���д���
	//{
	//	return _brun;
	//}

	yggr::u32 operator()(void) // ��ʱ�������� ����ֵ  true ���� false  ɾ����ʱ����
	{
...
//			}
			...
			_container_list.push_back(container); //��ս��ģ��
			std::cout << std::endl;
			std::cout << "------------------------------" <<std::endl;
	...
	bool back_battle_result(void)
	{
		...
		_container_list.using_handler(boost::bind(&this_type::handler_back_result, this, _1));
...
private:
	...
	time_type _end_tm_step_eins; //��һ״̬������ʱ��
	time_type _end_tm_step_zwei; // �ڶ�״̬��ʱ��
	time_type _group_check_tm_step;
	time_type _chk_tm_step;
	guild_mgr_type& _guild_mgr;
...
#   endif //_DEBUG
	...
	//yggr::shared_ptr<timed_get_users> user_get_ptr(new timed_get_users(aid_arr[0], yggr::time::time(1, 0), guild_mgr));
