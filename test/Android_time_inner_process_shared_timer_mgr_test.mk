#
#	time_inner_process_shared_timer_mgr_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := time_inner_process_shared_timer_mgr_test
...
# source files
l_src_file := \
	time/inner_process_shared_timer_mgr_test.cpp \
