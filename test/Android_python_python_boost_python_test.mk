#
#	python_python_boost_python_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := python_python_boost_python_test
...
# source files
l_src_file := \
	python/python_boost_python_test.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		-lyggr_script_python$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
		-lboost_python$(USRDEF_APP_PYTHON_VERSION)$(USRDEF_APP_COMPILER_VERSION_TAG)-mt-d$(tag_arch_bits)$(USRDEF_APP_BOOST_VERSION_TAG) \
	...
	l_ldflags += \
		-s \
		-Wl,--gc-sections \
		-lyggr_script_python$(USRDEF_APP_COMPILER_VERSION_TAG) \
		-lboost_python$(USRDEF_APP_PYTHON_VERSION)$(USRDEF_APP_COMPILER_VERSION_TAG)-mt$(tag_arch_bits)$(USRDEF_APP_BOOST_VERSION_TAG) \
...
l_ldflags += \
	-lpython$(USRDEF_APP_PYTHON_VERSION_FLOAT) \
	-lpython3 \
	-llog \
	$(USRDEF_APP_LDFLAGS)\
