#
#	lua_lua_script_mgr_performance_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua_lua_script_mgr_performance_test
...
# source files
l_src_file := \
	lua/lua_script_mgr_performance_test.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		...
		-llua503$(USRDEF_APP_COMPILER_VERSION_TAG)-s-d \
	...
	l_ldflags += \
		...
		-llua503$(USRDEF_APP_COMPILER_VERSION_TAG)-s \
