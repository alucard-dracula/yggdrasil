#
#	compaction_tool_zip_lzma_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := compaction_tool_zip_lzma_test
...
# source files
l_src_file := \
	compaction_tool/zip_lzma_test.cpp \
...
ifeq ($(NDK_DEBUG), 1)
	l_ldflags += \
		...
		-lyggr_compaction_tool$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
		...
		-liconv \
		-llzma$(USRDEF_APP_COMPILER_VERSION_TAG)-d \
	...
	l_ldflags += \
		...
		-lyggr_compaction_tool$(USRDEF_APP_COMPILER_VERSION_TAG) \
		...
		-liconv \
		-llzma$(USRDEF_APP_COMPILER_VERSION_TAG) \
