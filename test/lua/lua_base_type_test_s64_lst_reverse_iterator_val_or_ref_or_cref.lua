...
local function test_s64_lst_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
	...
	print("test_riterator ==",
			type(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rbeg),
			yggr.lua.typeid(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rbeg),
			yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rbeg)
	print("test_riterator ==",
			type(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rend),
			yggr.lua.typeid(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rend),
			yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) == iter_rend)
	print("test_riterator ~=",
			type(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) ~= iter_rbeg),
			yggr.lua.typeid(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) ~= iter_rbeg),
			yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg) ~= iter_rbeg)
	...
	print("\n")
	print("test_riterator ==",
			type(iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg)),
			yggr.lua.typeid(iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg)),
			iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg))
	print("test_riterator ==",
			type(iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)),
			yggr.lua.typeid(iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)),
			iter_rbeg == yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))
	print("test_riterator ~=",
			type(iter_rbeg ~= yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg)),
			yggr.lua.typeid(iter_rbeg ~= yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg)),
			iter_rbeg ~= yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg))
	...
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend))
	print("test_iterator distance",
			type(yggr.lua.distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)))
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)))
	...
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), iter_rend))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.wraped_distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.wraped_distance(iter_rbeg, yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.wraped_distance(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg), yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)))
	...
	print("test_riterator compare_eq",
			type(iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg))),
			iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rbeg)) )
	print("test_riterator compare_eq",
			type(iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rend))),
			iter_rbeg:compare_eq(yggr.lua.s64_list_const_reverse_iterator_type(iter_rend)) )
...
function calculate(iter_rbeg, iter_rend)
	print("\n")
	return test_s64_lst_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
end
