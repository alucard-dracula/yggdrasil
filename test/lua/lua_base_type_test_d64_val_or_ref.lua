...
local function test_d64_val_or_ref(param)
	print("lua_test_d64 show", type(param), yggr.lua.typeid(param), param)

	print("\n")
	print("lua_test_d64 construct", type(yggr.lua.s64(10)), yggr.lua.typeid(yggr.lua.s64(10)), yggr.lua.s64(10))
	print("lua_test_d64 construct", type(yggr.lua.u64(10)), yggr.lua.typeid(yggr.lua.u64(10)), yggr.lua.u64(10))
	print("lua_test_d64 construct", type(yggr.lua.s64(10, 10)), yggr.lua.typeid(yggr.lua.s64(10, 10)), yggr.lua.s64(10, 10))
	print("lua_test_d64 construct", type(yggr.lua.u64(10, 10)), yggr.lua.typeid(yggr.lua.u64(10, 10)), yggr.lua.u64(10, 10))
	print("lua_test_d64 construct", type(yggr.lua.s64('900')), yggr.lua.typeid(yggr.lua.s64('900')), yggr.lua.s64('900'))
	print("lua_test_d64 construct", type(yggr.lua.u64('900')), yggr.lua.typeid(yggr.lua.u64('900')), yggr.lua.u64('900'))
	print("lua_test_d64 construct", type(yggr.lua.s64(param)), yggr.lua.typeid(yggr.lua.s64(param)), yggr.lua.s64(param))
	print("lua_test_d64 construct", type(yggr.lua.u64(param)), yggr.lua.typeid(yggr.lua.u64(param)), yggr.lua.u64(param))
