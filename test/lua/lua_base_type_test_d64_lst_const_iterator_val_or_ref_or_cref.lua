...
local function test_s64_lst_const_iterator_val_or_ref_or_cref(iter_beg, iter_end)
...
function calculate(iter_beg, iter_end)
	print("\n")
	return test_s64_lst_const_iterator_val_or_ref_or_cref(iter_beg, iter_end)
end
