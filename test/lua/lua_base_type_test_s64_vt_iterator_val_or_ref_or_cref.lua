...
local function test_s64_iterator_val_or_ref_or_cref(iter_beg, iter_end)
	...
	print("\n")
	print("test_iterator <",
			type(yggr.lua.s64_vector_const_iterator_type(iter_beg) < iter_end),
			yggr.lua.typeid(yggr.lua.s64_vector_const_iterator_type(iter_beg) < iter_end),
			yggr.lua.s64_vector_const_iterator_type(iter_beg) < iter_end)
	print("test_iterator <=",
			type(yggr.lua.s64_vector_const_iterator_type(iter_beg) <= iter_end),
			yggr.lua.typeid(yggr.lua.s64_vector_const_iterator_type(iter_beg) <= iter_end),
			yggr.lua.s64_vector_const_iterator_type(iter_beg) <= iter_end)
	...
	print("test_iterator >=",
			...
			yggr.lua.s64_vector_const_iterator_type(iter_beg) >= iter_end)
	print("test_iterator ==",
			type(yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_beg),
			yggr.lua.typeid(yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_beg),
			yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_beg)
	print("test_iterator ==",
			type(yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_end),
			yggr.lua.typeid(yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_end),
			yggr.lua.s64_vector_const_iterator_type(iter_beg) == iter_end)
	...
	print("\n")
	print("test_iterator <",
			type(iter_beg < yggr.lua.s64_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg < yggr.lua.s64_vector_const_iterator_type(iter_end)),
			iter_beg < yggr.lua.s64_vector_const_iterator_type(iter_end))
	print("test_iterator <=",
			type(iter_beg <= yggr.lua.s64_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg <= yggr.lua.s64_vector_const_iterator_type(iter_end)),
			iter_beg <= yggr.lua.s64_vector_const_iterator_type(iter_end))
	...
	print("test_iterator >=",
			...
			iter_beg >= yggr.lua.s64_vector_const_iterator_type(iter_end))
	print("test_iterator ==",
			type(iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_beg)),
			yggr.lua.typeid(iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_beg)),
			iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_beg))
	print("test_iterator ==",
			type(iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_end)),
			iter_beg == yggr.lua.s64_vector_const_iterator_type(iter_end))
	...
	print("test_iterator -",
			...
			iter_end - iter_beg)
	print("test_iterator -",
			type(iter_end - yggr.lua.s64_vector_const_iterator_type(iter_beg)),
			yggr.lua.typeid(iter_end - yggr.lua.s64_vector_const_iterator_type(iter_beg)),
			iter_end - yggr.lua.s64_vector_const_iterator_type(iter_beg))
	print("test_iterator -",
			type(yggr.lua.s64_vector_const_iterator_type(iter_end) - iter_beg),
			yggr.lua.typeid(yggr.lua.s64_vector_const_iterator_type(iter_end) - iter_beg),
			yggr.lua.s64_vector_const_iterator_type(iter_end) - iter_beg)
	...
	print("test_iterator minus",
			type(iter_end:minus(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:minus(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			iter_end:minus(yggr.lua.s64_vector_const_iterator_type(iter_beg)))
	...
	print("test_iterator wraped_minus",
			type(iter_end:wraped_minus(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:wraped_minus(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			iter_end:wraped_minus(yggr.lua.s64_vector_const_iterator_type(iter_beg)))
	...
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end))
	print("test_iterator distance",
			type(yggr.lua.distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end)))
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end)))
	...
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), iter_end))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.wraped_distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.wraped_distance(iter_beg, yggr.lua.s64_vector_const_iterator_type(iter_end)))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.wraped_distance(yggr.lua.s64_vector_const_iterator_type(iter_beg), yggr.lua.s64_vector_const_iterator_type(iter_end)))
	...
	print("test_iterator compare_eq",
			type(iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare_eq",
			type(iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			iter_beg:compare_eq(yggr.lua.s64_vector_const_iterator_type(iter_end)) )
	...
	print("test_iterator compare",
			type(iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare",
			type(iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			iter_beg:compare(yggr.lua.s64_vector_const_iterator_type(iter_end)) )
	print("test_iterator compare",
			type(iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg))),
			iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare",
			type(iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_end))),
			iter_end:compare(yggr.lua.s64_vector_const_iterator_type(iter_end)) )
...
function calculate(iter_beg, iter_end)
	print("\n")
	return test_s64_iterator_val_or_ref_or_cref(iter_beg, iter_end)
end
