...
local function test_u64_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
	...
	print("test_riterator <",
			type(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) < iter_rend),
			yggr.lua.typeid(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) < iter_rend),
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) < iter_rend)
	print("test_riterator <=",
			type(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) <= iter_rend),
			yggr.lua.typeid(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) <= iter_rend),
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) <= iter_rend)
	...
	print("test_riterator >=",
			...
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) >= iter_rend)
	print("test_riterator ==",
			type(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rbeg),
			yggr.lua.typeid(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rbeg),
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rbeg)
	print("test_riterator ==",
			type(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rend),
			yggr.lua.typeid(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rend),
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg) == iter_rend)
	...
	print("\n")
	print("test_riterator <",
			type(iter_rbeg < yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			yggr.lua.typeid(iter_rbeg < yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			iter_rbeg < yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))
	print("test_riterator <=",
			type(iter_rbeg <= yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			yggr.lua.typeid(iter_rbeg <= yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			iter_rbeg <= yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))
	...
	print("test_riterator >=",
			...
			iter_rbeg >= yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))
	print("test_riterator ==",
			type(iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)),
			yggr.lua.typeid(iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)),
			iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))
	print("test_riterator ==",
			type(iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			yggr.lua.typeid(iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)),
			iter_rbeg == yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))
	...
	print("test_riterator -",
			...
			iter_rend - iter_rbeg)
	print("test_riterator -",
			type(iter_rend - yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)),
			yggr.lua.typeid(iter_rend - yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)),
			iter_rend - yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))
	print("test_riterator -",
			type(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend) - iter_rbeg),
			yggr.lua.typeid(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend) - iter_rbeg),
			yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend) - iter_rbeg)
	...
	print("test_riterator minus",
			type(iter_rend:minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rend:minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			iter_rend:minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)))
	...
	print("test_riterator wraped_minus",
			type(iter_rend:wraped_minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rend:wraped_minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			iter_rend:wraped_minus(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)))
	...
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend))
	print("test_iterator distance",
			type(yggr.lua.distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)))
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)))
	...
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend)),
			yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), iter_rend))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.wraped_distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.wraped_distance(iter_rbeg, yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.wraped_distance(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg), yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)))
	...
	print("test_riterator compare_eq",
			type(iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)) )
	print("test_riterator compare_eq",
			type(iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			iter_rbeg:compare_eq(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)) )
	...
	print("\n")
	print("test_riterator compare",
			type(iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)) )
	print("test_riterator compare",
			type(iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			iter_rbeg:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)) )
	print("test_riterator compare",
			type(iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			yggr.lua.typeid(iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg))),
			iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rbeg)) )
	print("test_riterator compare",
			type(iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			yggr.lua.typeid(iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend))),
			iter_rend:compare(yggr.lua.u64_vector_const_reverse_iterator_type(iter_rend)) )
...
function calculate(iter_rbeg, iter_rend)
	print("\n")
	return test_u64_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
end
