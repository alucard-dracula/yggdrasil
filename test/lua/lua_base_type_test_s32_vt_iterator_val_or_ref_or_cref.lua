...
local function test_s32_iterator_val_or_ref_or_cref(iter_beg, iter_end)
	...
	print("\n")
	print("test_iterator <",
			type(yggr.lua.s32_vector_const_iterator_type(iter_beg) < iter_end),
			yggr.lua.typeid(yggr.lua.s32_vector_const_iterator_type(iter_beg) < iter_end),
			yggr.lua.s32_vector_const_iterator_type(iter_beg) < iter_end)
	print("test_iterator <=",
			type(yggr.lua.s32_vector_const_iterator_type(iter_beg) <= iter_end),
			yggr.lua.typeid(yggr.lua.s32_vector_const_iterator_type(iter_beg) <= iter_end),
			yggr.lua.s32_vector_const_iterator_type(iter_beg) <= iter_end)
	...
	print("test_iterator >=",
			...
			yggr.lua.s32_vector_const_iterator_type(iter_beg) >= iter_end)
	print("test_iterator ==",
			type(yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_beg),
			yggr.lua.typeid(yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_beg),
			yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_beg)
	print("test_iterator ==",
			type(yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_end),
			yggr.lua.typeid(yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_end),
			yggr.lua.s32_vector_const_iterator_type(iter_beg) == iter_end)
	...
	print("\n")
	print("test_iterator <",
			type(iter_beg < yggr.lua.s32_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg < yggr.lua.s32_vector_const_iterator_type(iter_end)),
			iter_beg < yggr.lua.s32_vector_const_iterator_type(iter_end))
	print("test_iterator <=",
			type(iter_beg <= yggr.lua.s32_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg <= yggr.lua.s32_vector_const_iterator_type(iter_end)),
			iter_beg <= yggr.lua.s32_vector_const_iterator_type(iter_end))
	...
	print("test_iterator >=",
			...
			iter_beg >= yggr.lua.s32_vector_const_iterator_type(iter_end))
	print("test_iterator ==",
			type(iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_beg)),
			yggr.lua.typeid(iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_beg)),
			iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_beg))
	print("test_iterator ==",
			type(iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_end)),
			yggr.lua.typeid(iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_end)),
			iter_beg == yggr.lua.s32_vector_const_iterator_type(iter_end))
	...
	print("test_iterator -",
			...
			iter_end - iter_beg)
	print("test_iterator -",
			type(iter_end - yggr.lua.s32_vector_const_iterator_type(iter_beg)),
			yggr.lua.typeid(iter_end - yggr.lua.s32_vector_const_iterator_type(iter_beg)),
			iter_end - yggr.lua.s32_vector_const_iterator_type(iter_beg))
	print("test_iterator -",
			type(yggr.lua.s32_vector_const_iterator_type(iter_end) - iter_beg),
			yggr.lua.typeid(yggr.lua.s32_vector_const_iterator_type(iter_end) - iter_beg),
			yggr.lua.s32_vector_const_iterator_type(iter_end) - iter_beg)
	...
	print("\n")
	print("test_iterator set_value",
			type(iter_beg:set_value(10)), yggr.lua.typeid(iter_beg:set_value(10)),
			iter_beg:set_value(10), iter_beg:set_value(10):get_value())
	print("test_iterator set_value",
			type(iter_beg:set_value(1)), yggr.lua.typeid(iter_beg:set_value(1)),
			iter_beg:set_value(1), iter_beg:set_value(1):get_value())

	print("test_iterator set_value",
			type(iter_beg:set_value(1, 20)), yggr.lua.typeid(iter_beg:set_value(1, 20)),
			iter_beg:set_value(1, 20), iter_beg:set_value(1, 20):get_value(1))
	print("test_iterator set_value",
			type(iter_beg:set_value(1, 2)), yggr.lua.typeid(iter_beg:set_value(1, 2)),
			iter_beg:set_value(1, 2), iter_beg:set_value(1, 2):get_value(1))

	print("test_iterator set_value",
			type(iter_beg:set_value(yggr.lua.s64(1), 20)), yggr.lua.typeid(iter_beg:set_value(yggr.lua.s64(1), 20)),
			iter_beg:set_value(yggr.lua.s64(1), 20), iter_beg:set_value(yggr.lua.s64(1), 20):get_value(1))
	print("test_iterator set_value",
			type(iter_beg:set_value(yggr.lua.s64(1), 2)), yggr.lua.typeid(iter_beg:set_value(yggr.lua.s64(1), 2)),
			iter_beg:set_value(yggr.lua.s64(1), 2), iter_beg:set_value(yggr.lua.s64(1), 2):get_value(1))

	print("test_iterator set_value",
			type(iter_beg:set_value(yggr.lua.u64(1), 20)), yggr.lua.typeid(iter_beg:set_value(yggr.lua.u64(1), 20)),
			iter_beg:set_value(yggr.lua.u64(1), 20), iter_beg:set_value(yggr.lua.u64(1), 20):get_value(1))
	print("test_iterator set_value",
			type(iter_beg:set_value(yggr.lua.u64(1), 2)), yggr.lua.typeid(iter_beg:set_value(yggr.lua.u64(1), 2)),
			iter_beg:set_value(yggr.lua.u64(1), 2), iter_beg:set_value(yggr.lua.u64(1), 2):get_value(1))
	...
	print("test_iterator minus",
			type(iter_end:minus(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:minus(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			iter_end:minus(yggr.lua.s32_vector_const_iterator_type(iter_beg)))
	...
	print("test_iterator wraped_minus",
			type(iter_end:wraped_minus(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:wraped_minus(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			iter_end:wraped_minus(yggr.lua.s32_vector_const_iterator_type(iter_beg)))
	...
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end))
	print("test_iterator distance",
			type(yggr.lua.distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end)))
	print("test_iterator distance",
			type(yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end)))
	...
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end)),
			yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), iter_end))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.wraped_distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.wraped_distance(iter_beg, yggr.lua.s32_vector_const_iterator_type(iter_end)))
	print("test_iterator wraped_distance",
			type(yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.wraped_distance(yggr.lua.s32_vector_const_iterator_type(iter_beg), yggr.lua.s32_vector_const_iterator_type(iter_end)))
	...
	print("test_iterator compare_eq",
			type(iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare_eq",
			type(iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			iter_beg:compare_eq(yggr.lua.s32_vector_const_iterator_type(iter_end)) )
	...
	print("test_iterator compare",
			type(iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare",
			type(iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			iter_beg:compare(yggr.lua.s32_vector_const_iterator_type(iter_end)) )
	print("test_iterator compare",
			type(iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			yggr.lua.typeid(iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg))),
			iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_beg)) )
	print("test_iterator compare",
			type(iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			yggr.lua.typeid(iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_end))),
			iter_end:compare(yggr.lua.s32_vector_const_iterator_type(iter_end)) )
	...
	while tmp_iter_beg ~= tmp_iter_end do
		print("test_iterator sort_aesc", tmp_iter_beg:get_value())
		tmp_iter_beg:next()
	end
	...
	while tmp_iter_beg ~= tmp_iter_end do
		print("test_iterator sort_desc", tmp_iter_beg:get_value())
		tmp_iter_beg:next()
	end
	...
	while tmp_iter_beg ~= tmp_iter_end do
		print("test_iterator reverse", tmp_iter_beg:get_value())
		tmp_iter_beg:next()
	end
	...
	while tmp_iter_beg ~= tmp_iter_end do
		print("test_iterator shuffle", tmp_iter_beg:get_value())
		tmp_iter_beg:next()
	end
	...
	print("\n")
	local new_end = yggr.lua.remove(iter_beg, iter_end, 3)
	print("test_iterator remove", type(new_end), yggr.lua.typeid(new_end), new_end)
	tmp_iter_beg = iter_beg:copy()
	tmp_iter_end = iter_end:copy()
	while tmp_iter_beg ~= tmp_iter_end do
		print("test_iterator remove", tmp_iter_beg:get_value())
		tmp_iter_beg:next()
	end
...
function calculate(iter_beg, iter_end)
	print("\n")
	return test_s32_iterator_val_or_ref_or_cref(iter_beg, iter_end)
end
