...
local function test_u32_vt_val_or_ref(param)
	print("test_vector show", type(param), yggr.lua.typeid(param), param)

	print("\n")
	print("test_vector construct", type(yggr.lua.u32_vector_type()), yggr.lua.typeid(yggr.lua.u32_vector_type()), yggr.lua.u32_vector_type())
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(yggr.lua.u32_allocator_type()))

	print("test_vector construct",
			type(yggr.lua.u32_vector_type(5, 10)),
			yggr.lua.typeid(yggr.lua.u32_vector_type(5, 10)),
			yggr.lua.u32_vector_type(5, 10))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.s64(5), 10)),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.s64(5), 10)),
			yggr.lua.u32_vector_type(yggr.lua.s64(5), 10))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.u64(5), 10)),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.u64(5), 10)),
			yggr.lua.u32_vector_type(yggr.lua.u64(5), 10))

	print("test_vector construct",
			type(yggr.lua.u32_vector_type(5, 10, yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(5, 10, yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(5, 10, yggr.lua.u32_allocator_type()))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.s64(5), 10, yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.s64(5), 10, yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(yggr.lua.s64(5), 10, yggr.lua.u32_allocator_type()))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.u64(5), 10, yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.u64(5), 10, yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(yggr.lua.u64(5), 10, yggr.lua.u32_allocator_type()))

	print("test_vector construct",
			type(yggr.lua.u32_vector_type(5)),
			yggr.lua.typeid(yggr.lua.u32_vector_type(5)),
			yggr.lua.u32_vector_type(5))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.s64(5))),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.s64(5))),
			yggr.lua.u32_vector_type(yggr.lua.s64(5)))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.u64(5))),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.u64(5))),
			yggr.lua.u32_vector_type(yggr.lua.u64(5)))

	print("test_vector construct",
			type(yggr.lua.u32_vector_type(5, yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(5, yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(5, yggr.lua.u32_allocator_type()))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.s64(5), yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.s64(5), yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(yggr.lua.s64(5), yggr.lua.u32_allocator_type()))
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(yggr.lua.u64(5), yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(yggr.lua.u64(5), yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(yggr.lua.u64(5), yggr.lua.u32_allocator_type()))
	...
	print("test_vector construct",
			type(yggr.lua.u32_vector_type(param)),
			yggr.lua.typeid(yggr.lua.u32_vector_type(param)),
			yggr.lua.u32_vector_type(param))

	print("test_vector construct",
			type(yggr.lua.u32_vector_type(param, yggr.lua.u32_allocator_type())),
			yggr.lua.typeid(yggr.lua.u32_vector_type(param, yggr.lua.u32_allocator_type())),
			yggr.lua.u32_vector_type(param, yggr.lua.u32_allocator_type()))
	...
	local tmp_swap_r = yggr.lua.u32_vector_type()
	...
	print("\n")
	local tmp_assign = yggr.lua.u32_vector_type()
	...
	print("test_vector empty",
			type(yggr.lua.u32_vector_type():empty()),
			yggr.lua.typeid(yggr.lua.u32_vector_type():empty()),
			yggr.lua.u32_vector_type():empty())
	...
	print("test_vector g_empty",
			type(yggr.lua.empty(yggr.lua.u32_vector_type())),
			yggr.lua.typeid(yggr.lua.empty(yggr.lua.u32_vector_type())),
			yggr.lua.empty(yggr.lua.u32_vector_type()))
...
function calculate(param)
	print("\n")
	return test_u32_vt_val_or_ref(param)
end
