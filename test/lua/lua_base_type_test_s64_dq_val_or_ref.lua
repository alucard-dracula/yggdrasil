...
local function test_s64_dq_val_or_ref(param)
	print("test_deque show", type(param), yggr.lua.typeid(param), param)


	print("\n")
	print("test_deque construct", type(yggr.lua.s64_deque_type()), yggr.lua.typeid(yggr.lua.s64_deque_type()), yggr.lua.s64_deque_type())
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(yggr.lua.s64_allocator_type()))

	print("test_deque construct",
			type(yggr.lua.s64_deque_type(5, 10)),
			yggr.lua.typeid(yggr.lua.s64_deque_type(5, 10)),
			yggr.lua.s64_deque_type(5, 10))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.s64(5), 10)),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.s64(5), 10)),
			yggr.lua.s64_deque_type(yggr.lua.s64(5), 10))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.u64(5), 10)),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.u64(5), 10)),
			yggr.lua.s64_deque_type(yggr.lua.u64(5), 10))

	print("test_deque construct",
			type(yggr.lua.s64_deque_type(5, 10, yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(5, 10, yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(5, 10, yggr.lua.s64_allocator_type()))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.s64(5), 10, yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.s64(5), 10, yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(yggr.lua.s64(5), 10, yggr.lua.s64_allocator_type()))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.u64(5), 10, yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.u64(5), 10, yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(yggr.lua.u64(5), 10, yggr.lua.s64_allocator_type()))

	print("test_deque construct",
			type(yggr.lua.s64_deque_type(5)),
			yggr.lua.typeid(yggr.lua.s64_deque_type(5)),
			yggr.lua.s64_deque_type(5))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.s64(5))),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.s64(5))),
			yggr.lua.s64_deque_type(yggr.lua.s64(5)))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.u64(5))),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.u64(5))),
			yggr.lua.s64_deque_type(yggr.lua.u64(5)))

	print("test_deque construct",
			type(yggr.lua.s64_deque_type(5, yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(5, yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(5, yggr.lua.s64_allocator_type()))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.s64(5), yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.s64(5), yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(yggr.lua.s64(5), yggr.lua.s64_allocator_type()))
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(yggr.lua.u64(5), yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(yggr.lua.u64(5), yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(yggr.lua.u64(5), yggr.lua.s64_allocator_type()))
	...
	print("test_deque construct",
			type(yggr.lua.s64_deque_type(param)),
			yggr.lua.typeid(yggr.lua.s64_deque_type(param)),
			yggr.lua.s64_deque_type(param))

	print("test_deque construct",
			type(yggr.lua.s64_deque_type(param, yggr.lua.s64_allocator_type())),
			yggr.lua.typeid(yggr.lua.s64_deque_type(param, yggr.lua.s64_allocator_type())),
			yggr.lua.s64_deque_type(param, yggr.lua.s64_allocator_type()))
	...
	local tmp_swap_r = yggr.lua.s64_deque_type()
	...
	print("\n")
	local tmp_assign = yggr.lua.s64_deque_type()
	...
	print("test_deque g_empty",
			type(yggr.lua.empty(yggr.lua.s64_deque_type())),
			yggr.lua.typeid(yggr.lua.empty(yggr.lua.s64_deque_type())),
			yggr.lua.empty(yggr.lua.s64_deque_type()))
...
function calculate(param)
	print("\n")
	return test_s64_dq_val_or_ref(param)
end
