...
local function test_s32_vt_allocator_val_or_ref_or_cref(param)
	...
	print("test_allocator ==",
			type(param == yggr.lua.s32_allocator_type()),
			yggr.lua.typeid(param == yggr.lua.s32_allocator_type()),
			param == yggr.lua.s32_allocator_type())
...
function calculate(param)
	print("\n")
	return test_s32_vt_allocator_val_or_ref_or_cref(param)
end
