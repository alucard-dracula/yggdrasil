...
local function test_d32_const_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
	print("test_iterator show", type(iter_rbeg), yggr.lua.typeid(iter_rbeg), iter_rbeg)
	print("test_iterator show", type(iter_rend), yggr.lua.typeid(iter_rend), iter_rend)

	print("\n")
	print("test_iterator <", type(iter_rbeg < iter_rend), yggr.lua.typeid(iter_rbeg < iter_rend), iter_rbeg < iter_rend)
	print("test_iterator <=", type(iter_rbeg <= iter_rend), yggr.lua.typeid(iter_rbeg <= iter_rend), iter_rbeg <= iter_rend)
	print("test_iterator >", type(iter_rbeg > iter_rend), yggr.lua.typeid(iter_rbeg > iter_rend), iter_rbeg > iter_rend)
	print("test_iterator >=", type(iter_rbeg >= iter_rend), yggr.lua.typeid(iter_rbeg >= iter_rend), iter_rbeg >= iter_rend)
	print("test_iterator ==", type(iter_rbeg == iter_rbeg), yggr.lua.typeid(iter_rbeg == iter_rbeg), iter_rbeg == iter_rbeg)
	print("test_iterator ==", type(iter_rbeg == iter_rend), yggr.lua.typeid(iter_rbeg == iter_rend), iter_rbeg == iter_rend)
	print("test_iterator ~=", type(iter_rbeg ~= iter_rbeg), yggr.lua.typeid(iter_rbeg ~= iter_rbeg), iter_rbeg ~= iter_rbeg)
	print("test_iterator ~=", type(iter_rbeg ~= iter_rend), yggr.lua.typeid(iter_rbeg ~= iter_rend), iter_rbeg ~= iter_rend)

	print("\n")
	print("test_iterator +", type(iter_rbeg + 1), yggr.lua.typeid(iter_rbeg + 1), iter_rbeg + 1, (iter_rbeg + 1):get_value())
	print("test_iterator +", type(1 + iter_rbeg), yggr.lua.typeid(1 + iter_rbeg), 1 + iter_rbeg, (1 + iter_rbeg):get_value())
	print("test_iterator +", type(1 + iter_rbeg + 1), yggr.lua.typeid(1 + iter_rbeg + 1), 1 + iter_rbeg + 1, (1 + iter_rbeg + 1):get_value())
	...
	print("\n")
	print("test_iterator -", type(iter_rend - 1), yggr.lua.typeid(iter_rend - 1), iter_rend - 1, (iter_rend - 1):get_value())
	print("test_iterator -",
	...
	print("\n")
	print("test_iterator get_value", type(iter_rbeg:get_value()), yggr.lua.typeid(iter_rbeg:get_value()), iter_rbeg:get_value())
	print("test_iterator get_value", type(iter_rbeg:get_value(1)), yggr.lua.typeid(iter_rbeg:get_value(1)), iter_rbeg:get_value(1))
	...
	print("\n")
	print("test_iterator plus", type(iter_rbeg:plus(1)), yggr.lua.typeid(iter_rbeg:plus(1)), iter_rbeg:plus(1), (iter_rbeg:plus(1)):get_value())
	...
	print("\n")
	print("test_iterator minus", type(iter_rend:minus(1)), yggr.lua.typeid(iter_rend:minus(1)), iter_rend:minus(1), (iter_rend:minus(1)):get_value())
...
function calculate(iter_rbeg, iter_rend)
	print("\n")
	return test_d32_const_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
end
