...
local function test_d64_const_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
...
function calculate(iter_rbeg, iter_rend)
	print("\n")
	return test_d64_const_reverse_iterator_val_or_ref_or_cref(iter_rbeg, iter_rend)
end
