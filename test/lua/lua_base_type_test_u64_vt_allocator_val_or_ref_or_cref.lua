...
local function test_u64_allocator_val_or_ref_or_cref(param)
	...
	print("test_allocator ==",
			type(param == yggr.lua.u64_allocator_type()),
			yggr.lua.typeid(param == yggr.lua.u64_allocator_type()),
			param == yggr.lua.u64_allocator_type())
...
function calculate(param)
	print("\n")
	return test_u64_allocator_val_or_ref_or_cref(param)
end
