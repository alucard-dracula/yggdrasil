...
void utf8_string_filter_search(void) // support chs
{
#ifdef BOOST_HAS_ICU
	try
	{
		char init_str[] = "abcd efg";
		yggr::utf8_string true_str_re = "e f b,";
		...
		// true
		{
			regex_type re = yggr::fuzzy::filter_string::make_u32regex(true_str_re);
		...
		// false
		{
			regex_type re = yggr::fuzzy::filter_string::make_u32regex(false_str_re);
	...
	try
	{
		...
		yggr::utf8_string true_str_re = L" 好 你 ";
	...
	std::cout << "utf8_string_filter_match succeed" << std::endl;
}

int main(int argc, char* argv[])
{
	utf8_string_filter_search();
