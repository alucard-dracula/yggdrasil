...
typedef yggr::math::vector3d<int> vec_i_type;
...
int main(int argc, char* argv[])
{
	...
	typedef yggr::math::vector3d<double> vec_d_type;
	...
	//[] test-----------------------------------------------------------------------------------
	{
		...
		yggr_test_assert(vec1 == vec_type(40, 50, 60, 1));
	...
	{
		vec_type vec1(10, 20, 30);
		vec_type vec2(30, 20, 10);

		vec1 = vec1 + vec2;
		yggr_test_assert(vec1 == vec_type(40, 40, 40, 2));
	...
	//- test-----------------------------------------------------------------------------------
	{
		...
		vec1 = vec1 - vec2;
		yggr_test_assert(vec1 == vec_type(-20, 0, 20, 0));
	...
	//* test-----------------------------------------------------------------------------------
	{
		...
		vec1 = vec1 * vec2;
		yggr_test_assert(vec1 == vec_type(300, 400, 300, 1));
...

	{
		...
		yggr_test_assert(vec2 == vec1 * 100);
...

	{
		...
		vec1 *= 100;
		yggr_test_assert(vec1 == vec_type(1000, 2000, 3000, 100));
	...
	// / test-----------------------------------------------------------------------------------
	{
		...
		vec1 = vec1 / vec2;
		yggr_test_assert(vec1 == vec_type(10.0f / 30, 1, 3, 1));
...

	{
		...
		yggr_test_assert(vec1 == vec_type(10.0f / 100, 20.0f / 100, 30.0f / 100, 1.0f / 100));
	...
	// % test-----------------------------------------------------------------------------------
	{
		...
		vec1 = vec1 % vec2;
		yggr_test_assert(vec1 == vec_type(10, 0, 0, 0));
...

	{
		...
		vec1 = vec1 % 100;
		yggr_test_assert(vec1 == vec_type(10, 20, 30, 1));
	...
	{
		vec_type vec1(10.5, 20.4, 30);
		
		vec1.round();

		yggr_test_assert(vec1 == vec_type(11, 20, 30, 1));
...

	{
		...
		vec1.ceil();
		yggr_test_assert(vec1 == vec_type(11, 21, 30, 1));
	...
	// -val test-----------------------------------------------------------------------------------
	{
		...
		vec1 = -vec1;
		yggr_test_assert(vec1 == vec_type(-10.5, -20.4, -30, -1));
	...
	// cast_test-----------------------------------------------------------------------------------
	{
		...
		std::cout << vec2.x << ", " << vec2.y << ", " << vec1.z << ", " << vec2.w << std::endl;

		vec_d_type vec3 = vec1.type_cast<vec_d_type::value_type, boost::array>();
		std::cout << vec3.x << ", " << vec3.y << ", " << vec1.z << ", " << vec3.w << std::endl;
	}
	...
	// dot_test
	{
		vec_type vec1(10, 20, 30, 0);
		vec_type vec2(30, 20, 10, 0);
	...
	{
		vec_type vec1(1, 0, 0, 0);
		vec_d_type vec2(0, 1, 0, 0);
		...
		std::cout << vec1.cross(vec2) << std::endl;
		std::cout << "------------ cross_test_3_end------------------------------" << std::endl;
	}

	{
		vec_type vec1(10, 20, 30);
		vec_type vec2(10, 20, 30);

		vec_type vec3(100, 200, 300);
		vec_type vec4(100, 200, 300);
