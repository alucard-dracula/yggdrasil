#
#	lua_lua_script_mgr_test_same_id_and_out definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua_lua_script_mgr_test_same_id_and_out
...
# source files
l_src_file := \
	lua/lua_script_mgr_test_same_id_and_out.cpp \
