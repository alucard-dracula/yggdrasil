#
#	any_val_any_operator_mgr_performance_test definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := any_val_any_operator_mgr_performance_test
...
# source files
l_src_file := \
	any_val/any_operator_mgr_performance_test.cpp \
