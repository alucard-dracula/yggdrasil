// mongo_accesser_test_of_connection_sharding.cpp

// copy from mongo_accesser_test_of_connection and modify address only
...
void test_rename_1_1(yggr::nsql_database_system::c_mongo_connection& conn)
{
	...
	{
		{
			...
			yggr_test_assert(!bright); // mongodb sharding not support different db's rename 
...

		{
			bool bright =
				yggr::nsql_database_system::mongo_accesser::s_collection_rename(
					conn, db_name.c_str(), coln_name.c_str(),
					db_name.c_str(), new_coln_name.c_str(),
					true, 0, &err);
...

	{
...

		{
			bool bright =
				yggr::nsql_database_system::mongo_accesser::s_collection_rename(
					conn, db_name.c_str(), new_coln_name.c_str(),
					db_name.c_str(), coln_name.c_str(),
					true, 0, err);
...
void test_collection_watch(yggr::nsql_database_system::c_mongo_connection& conn)
{
	...
	bool b_is_replic_sets = true; // high version mongodb sharding need replic_set
...
#	if MONGODB_USING_AUTH()
	yggr::nsql_database_system::c_mongo_connection::init_type client_init(
				"mongodb://xy:123456abc@" + host_addr + ":12398/?tls=true", //"mongodb://xy:123456abc@127.0.0.1:12398/?tls=true",	// str_uri
...
#	else
	yggr::nsql_database_system::c_mongo_connection::init_type client_init(
				"mongodb://" + host_addr + ":12298/?tls=true", //"mongodb://127.0.0.1:12298/?tls=true",	// str_uri
				"./nsql_database_system/cert/client.pem",		// pem_file
				"",										// pem_pwd
				"./nsql_database_system/cert/ca.pem",	// ca_file
				"./nsql_database_system/cert",				// ca_dir
...
#	if MONGODB_USING_AUTH()
	yggr::nsql_database_system::c_mongo_connection::init_type client_init(
				"mongodb://xy:123456abc@" + host_addr + ":12198/?tls=false" //"mongodb://xy:123456abc@127.0.0.1:12198/?tls=false"	// str_uri
			);
#	else
	yggr::nsql_database_system::c_mongo_connection::init_type client_init(
				"mongodb://" + host_addr + ":12098/?tls=false" //"mongodb://127.0.0.1:12098/?tls=false"	// str_uri
			);
#	endif // MONGODB_USING_AUTH
...
#	if MONGODB_USING_AUTH()
	yggr::nsql_database_system::c_mongo_connection::init_type client_init(
				"mongodb://xy:123456abc@" +  + ":12398/?tls=true", //"mongodb://xy:123456abc@127.0.0.1:12398/?tls=true",	// str_uri
				"./nsql_database_system/cert/client.pem",		// pem_file
				"",										// pem_pwd
				"./nsql_database_system/cert/ca.pem",	// ca_file
				"./nsql_database_system/cert",				// ca_dir
