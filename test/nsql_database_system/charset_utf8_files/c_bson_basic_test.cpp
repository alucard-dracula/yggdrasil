...
void test_construct(void)
{
	...
	{
		bson_type bs_chk(L"{\"钥匙\" : 1}");
		bson_type bs(std::wstring(L"{\"钥匙\" : 1}"));
	...
	{
		bson_type bs_chk(L"{\"钥匙\" : 1}");
		bson_type bs(boost::container::wstring(L"{\"钥匙\" : 1}"));
	...
	{
		bson_type bs_chk(L"{\"钥匙\" : 1}");
		bson_type bs(yggr::wstring(L"{\"钥匙\" : 1}"));
	...
	{
		bson_type bs_chk(L"{\"钥匙\" : 1}");
		bson_type bs(yggr::utf8_string(L"{\"钥匙\" : 1}"));
	...
	{
		bson_type bs_chk(L"{\"钥匙\" : 1}");
		bson_type bs(yggr::wstring_view(L"{\"钥匙\" : 1}"));

		yggr_test_assert(bs == bs_chk);
	}

	{
		yggr::utf8_string str_js(L"{\"钥匙\" : 1}");
		bson_type bs_chk(L"{\"钥匙\" : 1}");
...
void test_operator_set(void)
{
...

	{
		...
		bs = (boost::container::wstring(L"{\"钥匙\" : 1}"));
...

	{
		...
		bs = yggr::charset::make_string_charset_helper(yggr::wstring_view(L"{\"钥匙\" : 1}"));
