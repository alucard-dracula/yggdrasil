...
void test_construct_of_sequenced(void)
{
	// managed_shared_memory
	{
		...
		seg_cont_type seg_cont("test_managed_shared_memory_safe_multi_index_container_sequenced",
								yggr::segment::segment_op::create_only(), 
								65536,
								boost::bind(
									&delete_segment<seg_type>, 
									"test_managed_shared_memory_safe_multi_index_container_sequenced") );
	...
	// test_mamaged_mapped_file
	{
		...
		seg_cont_type seg_cont("../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_sequenced",
								yggr::segment::segment_op::create_only(), 
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_sequenced"));
...
template<typename Container, typename SegCont>
void test_observers_of_sequenced_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_observers_of_sequenced_detail end-------------------------" << std::endl;
}
...
void test_observers_of_sequenced(void)
{
	// managed_shared_memory
	{
		...
		test_observers_of_sequenced_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_capacity_of_sequenced_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_capacity_of_sequenced_detail end-------------------------" << std::endl;
}
...
void test_capacity_of_sequenced(void)
{
	// managed_shared_memory
	{
		...
		test_capacity_of_sequenced_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_modifiers_of_sequenced_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;

	typedef typename mi_cont_type::base_type unsafe_midx_type;
	typedef typename boost::multi_index::nth_index<unsafe_midx_type, 0>::type unsafe_sequenced_type;
	typedef typename unsafe_sequenced_type::iterator unsafe_sequenced_iterator_type;
	typedef unsafe_sequenced_iterator_type (unsafe_sequenced_type::* begin_end_foo_unsafe_sequenced_type)(void);
	...
	struct iter_range_t
	{
		typedef typename safe_index0_type::iterator safe_index0_iter_type;
		typedef typename safe_index0_type::base_type safe_index0_base_type; 

		static 
		std::pair<safe_index0_iter_type, safe_index0_iter_type>
			iter_range(safe_index0_base_type& base)
		{
			return std::make_pair(base.begin(), base.end());
		}
		...
		static 
		std::pair<safe_index0_iter_type, safe_index0_iter_type>
			iter_range_1(safe_index0_base_type& base)
		{
			yggr_test_assert(base.size() > 1);
			safe_index0_iter_type iter = base.begin();
			return std::make_pair(++iter, base.end());
		}

		static 
		safe_index0_iter_type iter_pos_1(safe_index0_base_type& base)
		{
			yggr_test_assert(base.size() > 1);
			safe_index0_iter_type iter = base.begin();
			return ++iter;
	...
	// erase
	yggr_test_assert(cont.erase(boost::bind(static_cast<begin_end_foo_unsafe_sequenced_type>(&unsafe_sequenced_type::begin), _1)));
	yggr_test_assert(cont.erase(boost::bind(static_cast<begin_end_foo_unsafe_sequenced_type>(&unsafe_sequenced_type::begin), _1), 
						boost::bind(static_cast<begin_end_foo_unsafe_sequenced_type>(&unsafe_sequenced_type::end), _1)));
	...
	struct view_foo_t
	{
		...
		{
			for(safe_index0_iter_type i = base.template get<0>().begin(), isize = base.template get<0>().end();
				i != isize; ++i)
			{
	...
	std::cout << "---------------test_modifiers_of_sequenced_detail end-------------------------" << std::endl;
}
...
void test_modifiers_of_sequenced(void)
{
	// managed_shared_memory
	{
		...
		test_modifiers_of_sequenced_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_safe_other_of_sequenced_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_safe_other_of_sequenced_detail end-----------------" << std::endl;
}
...
void test_safe_other_of_sequenced(void)
{
	// managed_shared_memory
	{
		...
		test_safe_other_of_sequenced_detail<mi_cont_type>(seg_cont);
