...
template<typename Container, typename SegCont>
void test_observers_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_observers_of_ordered_detail end-------------------------" << std::endl;
}
...
void test_observers_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		seg_cont_type seg_cont("test_managed_shared_memory_safe_multi_index_container_ordered",
								yggr::segment::segment_op::create_only(), 
								65536,
								boost::bind(
									&delete_segment<seg_type>, 
									"test_managed_shared_memory_safe_multi_index_container_ordered") );

		yggr_test_assert(!seg_cont.empty());

		test_observers_of_ordered_detail<mi_cont_type>(seg_cont);
	...
	// test_mamaged_mapped_file
	{
		...
		seg_cont_type seg_cont("../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_ordered",
								yggr::segment::segment_op::create_only(), 
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_ordered"));
...
template<typename Container, typename SegCont>
void test_capacity_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_capacity_of_ordered_detail end-------------------------" << std::endl;
}
...
void test_capacity_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		test_capacity_of_ordered_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_modifiers_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	typedef typename mi_cont_type::base_type unsafe_midx_type;
	typedef typename boost::multi_index::nth_index<unsafe_midx_type, 0>::type unsafe_ordered_unique_type;
	typedef typename unsafe_ordered_unique_type::iterator unsafe_ordered_unique_iterator_type;
	typedef unsafe_ordered_unique_iterator_type (unsafe_ordered_unique_type::* begin_end_foo_unsafe_ordered_unique_type)(void);

	typedef typename boost::multi_index::nth_index<unsafe_midx_type, 1>::type unsafe_ordered_non_unique_type;
	typedef typename unsafe_ordered_non_unique_type::iterator unsafe_ordered_non_unique_iterator_type;
	typedef unsafe_ordered_non_unique_iterator_type (unsafe_ordered_non_unique_type::* begin_end_foo_unsafe_ordered_non_unique_type)(void);
...
// initializer_list
	...
	// replace
	yggr_test_assert(cont.template get<0>().replace(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 0), A(0, 100, "0")));
	yggr_test_assert(cont.template get<0>().replace(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 0), A(100, 100, "0")));
	yggr_test_assert(cont.template get<A::tag_prm1>().replace(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 100), A(0, 100, "0")));
	yggr_test_assert(!cont.template get<A::tag_prm1>().replace(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 0), A(1, 100, "0")));
	yggr_test_assert(!cont.template get<A::tag_prm1>().replace(
				boost::bind(static_cast<begin_end_foo_unsafe_ordered_unique_type>(&unsafe_ordered_unique_type::end), _1),
				A(1, 100, "0")));
	...
	yggr_test_assert(cont.template get<0>().modify(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 2), 
									boost::bind(&modifier<A, A>, _1, A(1, 100, "100"))));

	yggr_test_assert(cont.template get<0>().modify(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 1),
	...
	yggr_test_assert(cont.template get<0>().modify_key(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 1), 
									boost::bind(&modifier<int, int>, _1, 200)));

	yggr_test_assert(cont.template get<0>().modify_key(boost::bind(&unsafe_ordered_unique_type::template find<int>, _1, 200), 
									boost::bind(&modifier<int, int>, _1, 200),
	...
	yggr_test_assert(!cont.erase(boost::bind(static_cast<begin_end_foo_unsafe_ordered_unique_type>(&unsafe_ordered_unique_type::end), _1)));
	yggr_test_assert(cont.erase(boost::bind(static_cast<begin_end_foo_unsafe_ordered_unique_type>(&unsafe_ordered_unique_type::begin), _1)));
	yggr_test_assert(cont.template get<1>().erase(
			boost::bind(static_cast<begin_end_foo_unsafe_ordered_non_unique_type>(&unsafe_ordered_non_unique_type::begin), _1), 
			boost::bind(static_cast<begin_end_foo_unsafe_ordered_non_unique_type>(&unsafe_ordered_non_unique_type::end), _1)));
	...
	std::cout << "---------------test_modifiers_of_ordered_detail end-------------------------" << std::endl;
}
...
void test_modifiers_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		test_modifiers_of_ordered_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_lookup_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	typedef typename mi_cont_type::base_type unsafe_midx_type;
	...
	std::cout << "---------------test_lookup_of_ordered_detail end-------------------------" << std::endl;
...
void test_lookup_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		test_lookup_of_ordered_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_set_operations_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_set_operations_of_ordered_detail end-------------------" << std::endl;
}
...
void test_set_operations_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		test_set_operations_of_ordered_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_safe_other_of_ordered_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_safe_other_of_ordered_detail end-----------------" << std::endl;
}
...
void test_safe_other_of_ordered(void)
{
	// managed_shared_memory
	{
		...
		test_safe_other_of_ordered_detail<mi_cont_type>(seg_cont);
