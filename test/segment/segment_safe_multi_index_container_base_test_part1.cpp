...
void test_construct_of_hash(void)
{
	// managed_shared_memory
	{
		...
		seg_cont_type seg_cont("test_managed_shared_memory_safe_multi_index_container_hash",
								yggr::segment::segment_op::create_only(),
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"test_managed_shared_memory_safe_multi_index_container_hash") );
	...
	// test_mamaged_mapped_file
	{
		...
		seg_cont_type seg_cont("../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_hash",
								yggr::segment::segment_op::create_only(),
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"../test_out/segment/test_mamaged_mapped_file_safe_multi_index_container_hash"));
...
template<typename Container, typename SegCont>
void test_observers_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	cont.template get<1>().hash_function();

	cont.template get<A::tag_prm1>().hash_function();
	cont.template get<A::tag_prm2>().hash_function();

	cont.template get<0>().key_eq();
	cont.template get<1>().key_eq();

	cont.template get<A::tag_prm1>().key_eq();
	cont.template get<A::tag_prm2>().key_eq();

	std::cout << "---------------test_observers_of_hash_detail end-------------------------" << std::endl;
}
...
void test_observers_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_observers_of_hash_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_capacity_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	yggr_test_assert(cont.template get<1>().empty() == cont.template get<A::tag_prm1>().empty());
	...
	yggr_test_assert(cont.template get<0>().size() == cont.template get<A::tag_prm2>().size());

	yggr_test_assert(cont.template get<1>().size() == cont.template get<A::tag_prm1>().size());
	yggr_test_assert(cont.template get<1>().size() == cont.template get<A::tag_prm2>().size());

	yggr_test_assert(cont.template get<0>().max_size() == cont.template get<A::tag_prm1>().max_size());
	yggr_test_assert(cont.template get<0>().max_size() == cont.template get<A::tag_prm2>().max_size());

	yggr_test_assert(cont.template get<1>().max_size() == cont.template get<A::tag_prm1>().max_size());
	yggr_test_assert(cont.template get<1>().max_size() == cont.template get<A::tag_prm2>().max_size());

	std::cout << "---------------test_capacity_of_hash_detail end-------------------------" << std::endl;
}
...
void test_capacity_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_capacity_of_hash_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_modifiers_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;

	typedef base_cont_type unsafe_midx_type;
	typedef typename boost::multi_index::nth_index<unsafe_midx_type, 0>::type unsafe_hash_unique_type;
...
// initializer_list
	...
	// replace
	yggr_test_assert(cont.template get<0>().replace(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 0), A(0, 100, "0")));
	yggr_test_assert(cont.template get<0>().replace(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 0), A(100, 100, "0")));
	yggr_test_assert(cont.template get<A::tag_prm1>().replace(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 100), A(0, 100, "0")));
	yggr_test_assert(!cont.template get<A::tag_prm1>().replace(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 0), A(1, 100, "0")));
	yggr_test_assert(!cont.template get<A::tag_prm1>().replace(boost::bind(&unsafe_hash_unique_type::end, _1), A(1, 100, "0")));

	yggr_test_assert(cont.size() == 15);

	yggr_test_assert(cont.template get<1>().find_and_replace(100, A(100, 100, "0")));
	yggr_test_assert(cont.template get<A::tag_prm2>().find_and_replace(100, cont.template get<A::tag_prm2>().hash_function(),
															cont.template get<A::tag_prm2>().key_eq(), A(0, 1, "0")));
	yggr_test_assert(cont.template get<A::tag_prm2>().find_and_replace(1, A(100, 1, "0")));
	yggr_test_assert(!cont.template get<A::tag_prm2>().find_and_replace(1, cont.template get<A::tag_prm2>().hash_function(),
															cont.template get<A::tag_prm2>().key_eq(), A(2, 1, "0")));
	...
	A tmp1;
	yggr_test_assert(cont.template get<0>().modify(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 2),
									boost::bind(&modifier<A, A>, _1, A(2, 100, "100"))));

	yggr_test_assert(cont.template get<0>().modify(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 1),
	...
	yggr_test_assert(!cont.template get<A::tag_prm1>().find_and_modify(2000, cont.template get<A::tag_prm1>().hash_function(), cont.template get<A::tag_prm1>().key_eq(),
													boost::bind(&modifier<A, A>, _1, A(1, 100, "100"), boost::ref(tmp1))));
	...
	yggr_test_assert(!cont.template get<A::tag_prm1>().find_and_modify(2, cont.template get<A::tag_prm1>().hash_function(), cont.template get<A::tag_prm1>().key_eq(),
													boost::bind(&modifier<A, A>, _1, A(1, 100, "100"), boost::ref(tmp1)),
													boost::bind(&rollback<A>, _1, boost::cref(tmp1))));
	yggr_test_assert(cont.size() == 15);
	...
	// modify key
	int tmp2;
	yggr_test_assert(cont.template get<0>().modify_key(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 2),
									boost::bind(&modifier<int, int>, _1, 200)));

	yggr_test_assert(cont.template get<0>().modify_key(boost::bind(&unsafe_hash_unique_type::template find<int>, _1, 200),
									boost::bind(&modifier<int, int>, _1, 200),
	...
	yggr_test_assert(!cont.template get<A::tag_prm1>().find_and_modify_key(2000, cont.template get<A::tag_prm1>().hash_function(), cont.template get<A::tag_prm1>().key_eq(),
														boost::bind(&modifier<int, int>, _1, 3, boost::ref(tmp2))));
	...
	yggr_test_assert(!cont.template get<A::tag_prm1>().find_and_modify_key(200, cont.template get<A::tag_prm1>().hash_function(), cont.template get<A::tag_prm1>().key_eq(),
														boost::bind(&modifier<int, int>, _1, 3, boost::ref(tmp2)),
														boost::bind(&rollback<int>, _1, boost::cref(tmp2))));
	yggr_test_assert(cont.size() == 15);
	...
	cont.template get<A::tag_prm1>().swap(base_cont);
	yggr_test_assert(cont.size() == 15);
	yggr_test_assert(base_cont.size() == 5);

	yggr_test_assert(cont.erase(boost::bind(&unsafe_hash_unique_type::begin, _1)));
	yggr_test_assert(cont.size() == 14);
	yggr_test_assert(cont.erase(boost::bind(&unsafe_hash_unique_type::begin, _1),
						boost::bind(&unsafe_hash_unique_type::end, _1)));
	...
	std::cout << "---------------test_modifiers_of_hash_detail end-------------------------" << std::endl;
}
...
template<typename Container, typename SegCont>
void test_lookup_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	yggr_test_assert(cont.template get<1>().find(1, cont.hash_function(), cont.key_eq()));
	yggr_test_assert(!cont.template get<1>().find(100, cont.hash_function(), cont.key_eq()));
...

	{
		...
		bool bret = cont.template get<1>().get_value(1, cont.hash_function(), cont.key_eq(), a);
		yggr_test_assert(bret);
		yggr_test_assert(a == arr[0]);

		yggr_test_assert(!cont.template get<1>().get_value(100, cont.hash_function(), cont.key_eq(), a));
	}

	std::cout << "---------------test_lookup_of_hash_detail end-------------------------" << std::endl;
}
...
void test_lookup_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_lookup_of_hash_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_set_operations_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	yggr_test_assert(1 == cont.template get<A::tag_prm1>().count(1, cont.template get<0>().hash_function(), std::equal_to<int>()));

	yggr_test_assert(1 == cont.template get<0>().count(2, cont.template get<0>().hash_function(), std::equal_to<int>()));

	yggr_test_assert(0 == cont.template get<0>().count(100, cont.template get<0>().hash_function(), std::equal_to<int>()));

	yggr_test_assert(1 == cont.template get<A::tag_prm2>().count(2, cont.template get<1>().hash_function(), std::equal_to<int>()));

	yggr_test_assert(2 == cont.template get<1>().count(3, cont.template get<1>().hash_function(), std::equal_to<int>()));

	yggr_test_assert(0 == cont.template get<1>().count(100, cont.template get<1>().hash_function(), std::equal_to<int>()));


	std::cout << "---------------test_set_operations_of_hash_detail end-------------------" << std::endl;
}
...
void test_set_operations_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_set_operations_of_hash_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_bucket_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	yggr_test_assert(cont.template get<0>().bucket_count() == base_cont.template get<0>().bucket_count());
	yggr_test_assert(cont.template get<0>().max_bucket_count() == base_cont.template get<0>().max_bucket_count());
	yggr_test_assert(cont.template get<0>().bucket_size(0) == base_cont.template get<0>().bucket_size(0));
	yggr_test_assert(cont.template get<1>().bucket_size(1) == base_cont.template get<1>().bucket_size(1));

	yggr_test_assert(cont.template get<0>().bucket(0) == base_cont.template get<0>().bucket(0));
	yggr_test_assert(cont.template get<1>().bucket(1) == base_cont.template get<1>().bucket(1));

	std::cout << "---------------test_bucket_of_hash_detail end-------------------" << std::endl;
}
...
void test_bucket_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_bucket_of_hash_detail<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_hash_policy_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type base_cont_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	yggr_test_assert(cont.template get<0>().load_factor() == base_cont.template get<0>().load_factor());
	yggr_test_assert(cont.template get<1>().load_factor() == base_cont.template get<1>().load_factor());

	yggr_test_assert(cont.template get<0>().max_load_factor() == base_cont.template get<0>().max_load_factor());
	yggr_test_assert(cont.template get<1>().max_load_factor() == base_cont.template get<1>().max_load_factor());

	cont.template get<0>().max_load_factor(cont.template get<0>().max_load_factor());

	cont.template get<1>().max_load_factor(base_cont.template get<1>().max_load_factor());

	yggr_test_assert(cont.template get<0>().max_load_factor() == base_cont.template get<0>().max_load_factor());
	yggr_test_assert(cont.template get<1>().max_load_factor() == base_cont.template get<1>().max_load_factor());

	cont.template get<0>().rehash(100);
	base_cont.template get<0>().rehash(100);

	yggr_test_assert(cont.template get<0>().max_load_factor() == base_cont.template get<0>().max_load_factor());

	std::cout << "---------------test_hash_policy_of_hash_detail end-------------------" << std::endl;
}
...
void test_hash_policy_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_hash_policy_of_hash_detail<mi_cont_type>(seg_cont);
...
void test_comparer_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_compare_of_equal_to_and_not_equal_to<mi_cont_type>(seg_cont);
...
template<typename Container, typename SegCont>
void test_safe_other_of_hash_detail(SegCont& seg_cont)
{
	typedef Container mi_cont_type;
	typedef typename mi_cont_type::base_type unsafe_midx_type;
	typedef typename mi_cont_type::allocator_type alloc_type;
	...
	std::cout << "---------------test_safe_other_of_hash_detail end-----------------" << std::endl;
}
...
void test_safe_other_of_hash(void)
{
	// managed_shared_memory
	{
		...
		test_safe_other_of_hash_detail<mi_cont_type>(seg_cont);
