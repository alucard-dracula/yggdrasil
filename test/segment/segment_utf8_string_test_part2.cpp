...
void test_swap(SegCont& seg_cont)
{
...

	{
		...
		typedef yggr::charset::string_charset_helper<utf8_string_type&, const yggr::string&> now_charset_helper_type;
...
void test_append(SegCont& seg_cont)
{
	...
	// n, char
	{
		// n char
		{
			utf8_string_type str("aÄãbºÃc", alloc);
...
void test_modify(SegCont& seg_cont)
{
	...
	utf8_string_type utf8_str("ÕâÊÇUTF8ºº×Ö", alloc);
	...
	{
#	ifndef YGGR_NO_CWCHAR
		typename utf8_string_type::iterator iter = str.insert(str.begin() + 3, 2, L'´ó');
#	else
		typename utf8_string_type::iterator iter = str.insert(str.begin() + 3, 2, "´ó");
#	endif // YGGR_NO_CWCHAR
		yggr_test_assert(iter - str.begin() == 3);
		std::cout << yggr::utf8_char(iter, iter + 1) << std::endl;
	}
	...
	{
		str = "utf8×Ö·û´®";
		utf8_string_type ustr("ÕâÊÇ¸ö", alloc);
...

	{
		str = "string ×Ö·û´®";
#ifndef YGGR_NO_CWCHAR
		utf8_string_type sstr(L"ÄãºÃÂð", alloc);
#else
        utf8_string_type sstr("ÄãºÃÂð", alloc);
#endif // YGGR_NO_CWCHAR
		yggr_test_assert(str.length() == 10);
		str.replace(str.begin(), str.begin() + 6, sstr.begin(), sstr.end());
		yggr_test_assert(str.length() == 7);
...
void test_string_operations(SegCont& seg_cont)
{
...
#ifndef YGGR_NO_CWCHAR
	utf8_string_type str(L"utf8×Ö·û´®", alloc);
#else
    utf8_string_type str("utf8×Ö·û´®", alloc);
#endif // YGGR_NO_CWCHAR
	...
	// find
	{
		...
		yggr_test_assert(str.find(L'×Ö', 5) == utf8_string_type::npos);
		yggr_test_assert(str.find(yggr::utf8_char(L'×Ö')) == 4);
		yggr_test_assert(str.find(yggr::utf8_char(L'×Ö'), 5) == utf8_string_type::npos);
#else
        yggr_test_assert(str.find("×Ö") == 4);
		yggr_test_assert(str.find("×Ö", 5) == utf8_string_type::npos);
		yggr_test_assert(str.find(yggr::utf8_char("×Ö")) == 4);
		yggr_test_assert(str.find(yggr::utf8_char("×Ö"), 5) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.find(L"×Ö·û´®", 5) == utf8_string_type::npos);
#else
        yggr::string sstr("×Ö·û´®");
        yggr_test_assert(str.find(sstr) == 4);
		yggr_test_assert(str.find("×Ö·û´®") == 4);
		yggr_test_assert(str.find(sstr, 5) == utf8_string_type::npos);
		yggr_test_assert(str.find("×Ö·û´®", 5) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}

	{
#ifndef YGGR_NO_CWCHAR
		utf8_string_type sstr(L"tf8×Ö·û´®", alloc);
#else
        utf8_string_type sstr("tf8×Ö·û´®", alloc);
#endif // YGGR_NO_CWCHAR
	...
	// rfind
	{
		...
		yggr_test_assert(str.rfind(L'×Ö', 3) == utf8_string_type::npos);
		yggr_test_assert(str.rfind(yggr::utf8_char(L'×Ö')) == 4);
		yggr_test_assert(str.rfind(yggr::utf8_char(L'×Ö'), 3) == utf8_string_type::npos);
#else
        yggr_test_assert(str.rfind("×Ö") == 4);
		yggr_test_assert(str.rfind("×Ö", 3) == utf8_string_type::npos);
		yggr_test_assert(str.rfind(yggr::utf8_char("×Ö")) == 4);
		yggr_test_assert(str.rfind(yggr::utf8_char("×Ö"), 3) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.rfind(L"×Ö·û´®", 3) == utf8_string_type::npos);
#else
        yggr::string sstr("×Ö·û´®");
		yggr_test_assert(str.rfind(sstr) == 4);
		yggr_test_assert(str.rfind("×Ö·û´®") == 4);
		yggr_test_assert(str.rfind(sstr, 3) == utf8_string_type::npos);
		yggr_test_assert(str.rfind("×Ö·û´®", 3) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}
	...
	// find_first_of
	{
		...
		yggr_test_assert(str.find_first_of(L'×Ö', 5) == utf8_string_type::npos);
		...
		yggr_test_assert(str.find_first_of(L"×Öabc",5) == utf8_string_type::npos);
#else
        yggr_test_assert(str.find_first_of("×Ö") == 4);
		yggr_test_assert(str.find_first_of("×Ö", 1) == 4);
		yggr_test_assert(str.find_first_of("×Ö", 5) == utf8_string_type::npos);
		yggr_test_assert(str.find_first_of('a') == utf8_string_type::npos);
		yggr_test_assert(str.find_first_of("×Öabc") == 4);
		yggr_test_assert(str.find_first_of("abc") == utf8_string_type::npos);
		yggr_test_assert(str.find_first_of("×Öabc") == 4);
		...
		yggr_test_assert(str.find_first_of("×Öabc",5) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}

	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_first_of(utf8_string_type(L"×Öabc", alloc)) == 4);
		yggr_test_assert(str.find_first_of(utf8_string_type(L"abc", alloc)) == utf8_string_type::npos);
		yggr_test_assert(str.find_first_of(utf8_string_type(L"×Öabc", alloc), 1) == 4);
		yggr_test_assert(str.find_first_of(utf8_string_type(L"×Öabc", alloc),5) == utf8_string_type::npos);
#else
        yggr_test_assert(str.find_first_of(utf8_string_type("×Öabc", alloc)) == 4);
		yggr_test_assert(str.find_first_of(utf8_string_type("abc", alloc)) == utf8_string_type::npos);
		yggr_test_assert(str.find_first_of(utf8_string_type("×Öabc", alloc), 1) == 4);
		yggr_test_assert(str.find_first_of(utf8_string_type("×Öabc", alloc),5) == utf8_string_type::npos);
#endif // YGGR_NO_CWCHAR
	}
...

	{
		...
		yggr_test_assert(str.find_first_not_of(L"utf8×Ö·û´®", 1) == utf8_string_type::npos);
		...
		yggr_test_assert(str.find_first_not_of("utf8×Ö·û´®", 1) == utf8_string_type::npos);
...
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_first_not_of(utf8_string_type(L"×Öabc", alloc)) == 0);
		yggr_test_assert(str.find_first_not_of(utf8_string_type(L"abc", alloc)) == 0);
		yggr_test_assert(str.find_first_not_of(utf8_string_type(L"×Öabc", alloc), 1) == 1);
		yggr_test_assert(str.find_first_not_of(utf8_string_type(L"×Öabc", alloc),5) == 5);
		yggr_test_assert(str.find_first_not_of(utf8_string_type(L"utf8×Ö·û´®", alloc), 1) == utf8_string_type::npos);
...
#else
        yggr_test_assert(str.find_first_not_of(utf8_string_type("×Öabc", alloc)) == 0);
		yggr_test_assert(str.find_first_not_of(utf8_string_type("abc", alloc)) == 0);
		yggr_test_assert(str.find_first_not_of(utf8_string_type("×Öabc", alloc), 1) == 1);
		yggr_test_assert(str.find_first_not_of(utf8_string_type("×Öabc", alloc),5) == 5);
		yggr_test_assert(str.find_first_not_of(utf8_string_type("utf8×Ö·û´®", alloc), 1) == utf8_string_type::npos);
	...
	// find_last_of
	{
		...
		yggr_test_assert(str.find_last_of(L'×Ö', 1) == utf8_string_type::npos);
		...
		yggr_test_assert(str.find_last_of(L"×Öabc", 1) == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of(L"×Öabc",5) == 4);
		yggr_test_assert(str.find_last_of('u', 0) == 0);
		yggr_test_assert(str.find_last_of("u", 0) == 0);
#else
        yggr_test_assert(str.find_last_of("×Ö") == 4);
		yggr_test_assert(str.find_last_of("×Ö", 1) == utf8_string_type::npos);
		...
		yggr_test_assert(str.find_last_of("×Öabc") == 4);
		yggr_test_assert(str.find_last_of("abc") == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of("×Öabc", 1) == utf8_string_type::npos);
	...
	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_last_of(utf8_string_type(L"×Öabc", alloc)) == 4);
		yggr_test_assert(str.find_last_of(utf8_string_type(L"abc", alloc)) == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of(utf8_string_type(L"×Öabc", alloc), 1) == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of(utf8_string_type(L"×Öabc", alloc),5) == 4);
#else
        yggr_test_assert(str.find_last_of(utf8_string_type("×Öabc", alloc)) == 4);
		yggr_test_assert(str.find_last_of(utf8_string_type("abc", alloc)) == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of(utf8_string_type("×Öabc", alloc), 1) == utf8_string_type::npos);
		yggr_test_assert(str.find_last_of(utf8_string_type("×Öabc", alloc),5) == 4);
#endif // YGGR_NO_CWCHAR
	...
	// find_last_not_of
	{
		...
		yggr_test_assert(str.find_last_not_of(L"utf8×Ö·û´®", 1) == utf8_string_type::npos);
		...
		yggr_test_assert(str.find_last_not_of("utf8×Ö·û´®", 1) == utf8_string_type::npos);
	...
	{
#ifndef YGGR_NO_CWCHAR
		yggr_test_assert(str.find_last_not_of(utf8_string_type(L"×Öabc", alloc)) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type(L"abc", alloc)) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type(L"×Öabc", alloc), 1) == 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type(L"×Öabc", alloc),5) == 5);
		yggr_test_assert(str.find_last_not_of(utf8_string_type(L"utf8×Ö·û´®", alloc), 1) == utf8_string_type::npos);
...
#else
        yggr_test_assert(str.find_last_not_of(utf8_string_type("×Öabc", alloc)) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type("abc", alloc)) == str.length() - 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type("×Öabc", alloc), 1) == 1);
		yggr_test_assert(str.find_last_not_of(utf8_string_type("×Öabc", alloc),5) == 5);
		yggr_test_assert(str.find_last_not_of(utf8_string_type("utf8×Ö·û´®", alloc), 1) == utf8_string_type::npos);
	...
	// compare_eq
	{
		...
		yggr_test_assert(str.compare_eq(4, 2, utf8_string_type("×Ö·û", alloc)) == true);
		yggr_test_assert(str.compare_eq(4, 2, utf8_string_type(L"×Ö·û", alloc)) == true);

		yggr_test_assert(str.compare_eq(4, 2, utf8_string_type("×Ö·û³¤", alloc)) == false);
		yggr_test_assert(str.compare_eq(4, 2, yggr::wstring(L"×Ö·û³¤")) == false);

		yggr_test_assert(str.compare_eq(4, 3, utf8_string_type("×Ö·û", alloc)) == false);
		yggr_test_assert(str.compare_eq(4, 3, utf8_string_type(L"×Ö·û", alloc)) == false);
#else
        yggr_test_assert(str.compare_eq(4, 2, "×Ö·û") == true);
		yggr_test_assert(str.compare_eq(4, 2, yggr::string("×Ö·û")) == true);
	...
	// compare
	{
		...
		yggr_test_assert(str.compare(4, 2, utf8_string_type("×Ö·û", alloc)) == 0);
		yggr_test_assert(str.compare(4, 2, utf8_string_type(L"×Ö·û", alloc)) == 0);

		yggr_test_assert(str.compare(4, 2, utf8_string_type("×Ö·û³¤", alloc)) < 0);
		yggr_test_assert(str.compare(4, 2, yggr::wstring(L"×Ö·û³¤")) < 0);

		yggr_test_assert(str.compare(4, 3, utf8_string_type("×Ö·û", alloc)) > 0);
		yggr_test_assert(str.compare(4, 3, utf8_string_type(L"×Ö·û", alloc)) > 0);
#else
        yggr_test_assert(str.compare(4, 2, "×Ö·û") == 0);
		yggr_test_assert(str.compare(4, 2, yggr::string("×Ö·û")) == 0);
...
void non_member_foo_test(SegCont& seg_cont)
{
	...
	// operator +
	{
		...
		std::cout << utf8_string_type("utf8×Ö·û", alloc) + str << std::endl;
		const utf8_string_type& cref_str = str;
		std::cout << utf8_string_type("utf8×Ö·û", alloc) + cref_str << std::endl;


		std::cout << utf8_string_type("utf8×Ö·û", alloc) + str + yggr::string("aaa") << std::endl;
		std::cout << utf8_string_type(L"utf8×Ö·û", alloc) + str + yggr::wstring(L"bbb") << std::endl;
#else
        utf8_string_type str("utf8×Ö·û´®", alloc);
		std::cout << "utf8×Ö·û" + str + "aaa" << std::endl;
	...
	// operator ==
	{
		...
		yggr_test_assert(str == utf8_string_type("utf8×Ö·û´®", alloc));
		yggr_test_assert(utf8_string_type("utf8×Ö·û´®", alloc) == str);
		yggr_test_assert(str == utf8_string_type(L"utf8×Ö·û´®", alloc));
		yggr_test_assert(utf8_string_type(L"utf8×Ö·û´®", alloc) == str);
#else
        utf8_string_type str("utf8×Ö·û´®", alloc);
		yggr_test_assert(str == "utf8×Ö·û´®");
		yggr_test_assert("utf8×Ö·û´®" == str);
...
//
	...
	// swap
	{
		utf8_string_type str1_chk("utf8×Ö·û´®1", alloc);
		utf8_string_type str2_chk("utf8×Ö·û´®2", alloc);
	...
	{
		utf8_string_type str1_chk("utf8×Ö·û´®111", alloc);
		utf8_string_type str2_chk("utf8×Ö·û´®222", alloc);
...
void test_std_replace(SegCont& seg_cont)
{
	...
	{
		utf8_string_type str(L"ÄãºÃ,ÊÀ½ç", alloc);
...
int main(int argc, char* argv[])
{
	...
	// test_mamaged_mapped_file
	{
		...
		seg_cont_type seg_cont("../test_out/segment/test_mamaged_mapped_file_utf8_string",
								yggr::segment::segment_op::create_only(), 
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"../test_out/segment/test_mamaged_mapped_file_utf8_string"));
