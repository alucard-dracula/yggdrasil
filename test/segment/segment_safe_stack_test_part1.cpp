...
int main(int argc, char* argv[])
{
	// managed_shared_memory
	{
		...
		seg_cont_type seg_cont("test_managed_shared_memory_safe_stack",
								yggr::segment::segment_op::create_only(),
								65536,
								boost::bind(
									&delete_segment<seg_type>,
									"test_managed_shared_memory_safe_stack") );
		// yggr
		{
			typedef
		...
		// !!! stl container may not be support boost::interprocess::allocator!!!
