...
#ifndef __STATIC_DATA_CENTER_UDP_SVR_CALCULATOR_HPP__
#define __STATIC_DATA_CENTER_UDP_SVR_CALCULATOR_HPP__
...
public:
	...
	void unregister_cal_object(Action_Table& at)
	{
		...
		at.template unregister_calculator<proxy_register_back_msg_type>();
		at.template unregister_calculator<proxy_mode_change_back_msg_type>();
		at.template unregister_calculator<proxy_unregister_back_msg_type>();
	}
