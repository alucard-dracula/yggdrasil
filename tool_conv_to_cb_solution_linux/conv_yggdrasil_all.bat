...
sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir2%<\/root_dir_>/g" tool_conv_to_cb_solution_cfg.xml
tool_conv_to_cb_solution_linux.exe tool_conv_to_cb_solution_cfg.xml
...
sed -i "s/<root_dir_>.*<\/root_dir_>/<root_dir_>%dir11_!%<\/root_dir_>/g" tool_conv_to_cb_solution_cfg.xml
tool_conv_to_cb_solution_linux.exe tool_conv_to_cb_solution_cfg.xml
