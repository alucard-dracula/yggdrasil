...
#ifndef __VCPROJ_TAGS_DEF_HPP__
#define __VCPROJ_TAGS_DEF_HPP__
...
struct vcproj_app_tags
{
public:
	inline static const ptree_string_type& s_tag_exe(void)
	{
		static const ptree_string_type s_app_tag = "Application";
		return s_app_tag;
	}

	inline static const ptree_string_type& s_tag_dll(void)
	{
		static const ptree_string_type s_app_tag = "DynamicLibrary";
		return s_app_tag;
	}

	inline static const ptree_string_type& s_tag_static_lib(void)
	{
		static const ptree_string_type s_app_tag = "StaticLibrary";
		return s_app_tag;
	}

	inline static const ptree_string_type& s_tag_utility(void)
	{
		static const ptree_string_type s_app_tag = "Utility";
		return s_app_tag;
	}

	inline static const ptree_string_type& s_tag_makefile(void)
	{
		static const ptree_string_type s_app_tag = "Makefile";
		return s_app_tag;
	}
...
struct vcproj_cpp_lang_std
{
public:
	inline static const ptree_string_type& s_cpp03(void)
	{
		static const ptree_string_type s_cpp_ver;
		return s_cpp_ver;
	}

	inline static const ptree_string_type& s_cpp11(void)
	{
		static const ptree_string_type s_cpp_ver = "stdcpp11";
		return s_cpp_ver;
	}

	inline static const ptree_string_type& s_cpp14(void)
	{
		static const ptree_string_type s_cpp_ver = "stdcpp14";
		return s_cpp_ver;
	}

	inline static const ptree_string_type& s_cpp17(void)
	{
		static const ptree_string_type s_cpp_ver = "stdcpp17";
		return s_cpp_ver;
	}

	inline static const ptree_string_type& s_cpp20(void)
	{
		static const ptree_string_type s_cpp_ver = "stdcpp20";
		return s_cpp_ver;
	}
};
