// tool_conv_to_cb_solution_config.hpp

#ifndef __TOOL_CONV_TO_CB_SOLUTION_CONFIG_HPP__
#define __TOOL_CONV_TO_CB_SOLUTION_CONFIG_HPP__
...
#endif // __TOOL_CONV_TO_CB_SOLUTION_CONFIG_HPP__
