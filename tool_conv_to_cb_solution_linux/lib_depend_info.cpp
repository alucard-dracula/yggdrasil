...
lib_depend_info::lib_depend_info(lib_depend_info_cfg_sample)
{
	...
	// marks_depend
	{
		...
		_marks_dep["any_val"].insert("boost_thread");
		...
		_marks_dep["nsql_database_system"].insert("cmath");
		...
		_marks_dep["nsql_database_system"].insert("icudt");
		...
		_marks_dep["nsql_database_system"].insert("resolv");

		_marks_dep["mongoc"].insert("mongoc");
		_marks_dep["mongoc"].insert("resolv");
		...
		_marks_dep["mongocrypt"].insert("cmath");
		_marks_dep["mongocrypt"].insert("sasl");
		_marks_dep["mongocrypt"].insert("crypto");
		_marks_dep["mongocrypt"].insert("ssl");
		...
		_marks_dep["regular_parse"].insert("icudt");
		...
		_marks_dep["yggr_handler_center"].insert("boost_thread");
		
		_marks_dep["yggr_log"].insert("boost_thread");
		
		//_marks_dep["yggr_segment"].insert("ws2_32");
		//_marks_dep["yggr_archive"].insert("ws2_32");

		//_marks_dep["boost_asio.hpp"].insert("ws2_32");
		_marks_dep["mongoc_mongoc.h"].insert("resolv");
		...
		_marks_dep["lua"].insert("readline");

		_marks_dep["lua514"].insert("cmath");
		_marks_dep["lua521"].insert("cmath");
		_marks_dep["lua534"].insert("cmath");
		_marks_dep["lua546"].insert("cmath");
		_marks_dep["luac"].insert("cmath");
		

		_marks_dep["bid_test"].insert("bid");
		_marks_dep["bid_test"].insert("cmath");

		_marks_dep["intel_dfp_obj_test"].insert("intel_dfp_obj");
		_marks_dep["intel_dfp_obj_test"].insert("cmath");
		...
		_marks_dep["pyd_export"].insert("python_sp");
		...
		_marks_dep["script_python"].insert("python_sp");
		...
		_marks_dep["boost_python"].insert("python_sp");
		...
		_marks_dep["ibm_icu"].insert("icudata");
	...
	// %(python_main_version)
	{
		...
		_marks_name["lzma"] = "-llzma$(#COMPILER_VERSION_TAG)%(debug)";
		...
		_marks_name["readline"] = "-lreadline";
		...
		_marks_name["zlib"] = "-lz";
		_marks_name["zlibstatic"] = "-lz";
		_marks_name["dtl"] = "-ldtl$(#COMPILER_VERSION_TAG)%(debug)";

		_marks_name["crypto"] = "-lcrypto";
		_marks_name["ssl"] = "-lssl";
		_marks_name["sasl"] = "-lsasl2";

		_marks_name["icuuc"] = "-licuuc";
		_marks_name["icudt"] = "-licudata";
		_marks_name["icuin"] = "-licui18n";

		_marks_name["python"] = "-lpython%(python_main_version)";
		_marks_name["python_sp"] = "-lpython$(#PYTHON_VERSION_FLOAT)";

		_marks_name["lua"] = "-llua%(lua_version)$(#COMPILER_VERSION_TAG)%(debug)";
		...
		_marks_name["lua504"] = "-llua504$(#COMPILER_VERSION_TAG)%(debug)";
		_marks_name["lua503"] = "-llua503$(#COMPILER_VERSION_TAG)%(debug)";
		_marks_name["lua502"] = "-llua502$(#COMPILER_VERSION_TAG)%(debug)";
		_marks_name["lua501"] = "-llua501$(#COMPILER_VERSION_TAG)%(debug)";
		_marks_name["luajit501"] = "-lluajit501$(#COMPILER_VERSION_TAG)%(debug)";
